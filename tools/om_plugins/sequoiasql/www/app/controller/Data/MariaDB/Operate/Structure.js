...
(function(){
   ...
   //控制器
   sacApp.controllerProvider.register( 'Data.MariaDB.Structure.Ctrl', function( $scope, $location, $compile, SdbFunction, SdbRest, SdbSwap, SdbSignal ){
      ...
      if( clusterName == null || moduleType != 'sequoiasql-mariadb' || $scope.ModuleName == null || SdbSwap.tbName == null || SdbSwap.dbName == null )
      {
   ...
   //表格 控制器
   sacApp.controllerProvider.register( 'Data.MariaDB.Structure.Table.Ctrl', function( $scope, SdbSwap, SdbSignal ){
      //表格
      $scope.GridTable = {
         'title': {
            'index'            : '#',
