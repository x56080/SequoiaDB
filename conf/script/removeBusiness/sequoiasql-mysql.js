...
*******************************************************************************/
/*
@description: remove sequoiasql-mysql business
@modify list:
...
1. Generate plan
   @parameter
      ...
      var BUS_JSON = {"TaskID":206,"Type":3,"TypeDesc":"REMOVE_BUSINESS","TaskName":"REMOVE_BUSINESS","CreateTime":{"$timestamp":"2017-10-09-19.54.16.000000"},"EndTime":{"$timestamp":"2017-10-09-19.54.16.000000"},"Status":0,"StatusDesc":"INIT","AgentHost":"ubuntu-jw-01","AgentService":"11790","Info":{"ClusterName":"myCluster1","BusinessType":"sequoiasql-mysql","BusinessName":"myModule1","DeployMod":"","Config":[{"dbpath":"/opt/sequoiasql-mysql/database/5432","port":"5432","shared_buffers":"128MB","log_timezone":"PRC","datestyle":"iso, ymd","timezone":"PRC","lc_messages":"zh_CN.UTF-8","lc_monetary":"zh_CN","lc_numeric":"zh_CN","lc_time":"zh_CN","default_text_search_config":"pg_catalog.simple","InstallPath":"/opt/sequoiasql-mysql/","ClusterName":"myCluster1","HostName":"ubuntu-jw-02","IP":"192.168.3.232","Passwd":"123","SshPort":"22","User":"root"}]},"errno":0,"detail":"","Progress":0,"ResultInfo":[{"HostName":"ubuntu-jw-02","Status":0,"StatusDesc":"INIT","errno":0,"detail":"","Flow":[]}]}
   @return
      RET_JSON: the format is: {"Plan":[[{"TaskID":206,"Info":{"ClusterName":"myCluster1","BusinessType":"sequoiasql-mysql","BusinessName":"myModule1","Config":{"dbpath":"/opt/sequoiasql-mysql/database/5432","port":"5432","shared_buffers":"128MB","log_timezone":"PRC","datestyle":"iso, ymd","timezone":"PRC","lc_messages":"zh_CN.UTF-8","lc_monetary":"zh_CN","lc_numeric":"zh_CN","lc_time":"zh_CN","default_text_search_config":"pg_catalog.simple","InstallPath":"/opt/sequoiasql-mysql/","ClusterName":"myCluster1","HostName":"ubuntu-jw-02","IP":"192.168.3.232","Passwd":"123","SshPort":"22","User":"root","AgentService":"11790"}},"ResultInfo":{"HostName":"ubuntu-jw-02","Status":0,"StatusDesc":"INIT","errno":0,"detail":"","Flow":[],"Progress":90}}]]}
...
function GeneratePlan( PD_LOGGER )
{
   ...
   for( var index in planInfo[FIELD_CONFIG] )
   {
      ...
      installConfig[FIELD_INFO][FIELD_AUTH_PASSWD] = authPasswd ;
...
function _checkData( PD_LOGGER, resultInfo, port, user, passwd, cmd, installPath )
{
   var dbList = null ;
   var tableList = null ;
   ...
   try
   {
      ...
      dbList = _execSql( PD_LOGGER, port, user, passwd, cmd, installPath, 'select * from information_schema.SCHEMATA' ) ;
   }
   catch( e )
   {
   ...
   for( var index in dbList )
   {
      ...
      if( dbInfo['SCHEMA_NAME'] == 'information_schema' ||
          dbInfo['SCHEMA_NAME'] == 'performance_schema' ||
          dbInfo['SCHEMA_NAME'] == 'sys' ||
          dbInfo['SCHEMA_NAME'] == 'mysql' )
      {
         continue ;
      }
...
function RemoveBusiness( PD_LOGGER )
{
   ...
   var authUser      = taskInfo[FIELD_AUTH_USER] ;
   var authPasswd    = taskInfo[FIELD_AUTH_PASSWD] ;
