...
public class RegionUtils extends S3TestBase {
    ...
    public static void putRegion(Region region, String accessKeyId) throws Exception {
        ...
        try {
            resp = rest.setApi("/region/?Action=CreateRegion&RegionName=" + region.getName())
                    ...
                    .setRequestBody(region).setRequestMethod(HttpMethod.POST).setResponseType(String.class).exec();
    ...
    public static void checkRegionWithLocation(String regionName, String metaLocation, String metaHisLocation,
    ...
    public static void checkRegionWithShardingType(String regionName, String clShardingType, String csShardingType)
            throws Exception {
        GetRegionResult result = RegionUtils.getRegion(regionName);
        Region regionInfo = result.getRegion();
