...
/**
 * @Description: 并发更新不同分隔符 testlink-case: seqDB-18181
 *
 * @author wangkexin
 * @Date 2019.05.08
 * @version 1.00
...
public class UpdateDelimiter18181 extends S3TestBase {
    ...
    private String[] objectNames = { "dir1/dir2/test18181_1?%aa.txt",
            "dir1/dir2/%test18181_2?bb.txt", "dir1/dir2?test%18181_3.txt",
            "test18181_4.txt" };
    ...
    public void testGetObjectList() throws Exception {
        ...
        ThreadUpdateDelimiter18181 updateDelimiterThread1 = new ThreadUpdateDelimiter18181(
                delimiter1 );
        ThreadUpdateDelimiter18181 updateDelimiterThread2 = new ThreadUpdateDelimiter18181(
                delimiter2 );
        ...
        if ( updateDelimiterThread1.getRetCode() == 0
                && updateDelimiterThread2.getRetCode() == 409 ) {
            checkResult( delimiter1 );
        } else if ( updateDelimiterThread1.getRetCode() == 409
