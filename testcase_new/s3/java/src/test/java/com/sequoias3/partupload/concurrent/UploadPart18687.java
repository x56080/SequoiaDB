...
/**
 * @Description seqDB-18687: upload multiple parts concurrently,the partNums discontinuity,the
 *              length of the parts is the same and there is partNum of 1.
 * @author wuyan
 * @Date 2019.07.29
 * @version 1.00
 */
@Test(groups = "partlistinuseoff") public class UploadPart18687
        extends S3TestBase {
    private boolean runSuccess = false;
    private String keyName = "/aa/object18687";
    ...
    public void uploadParts() throws Exception {
        ...
        int[] partNumbers = { 1, 3, 5, 10, 50, 60, 500, 1000, 9999, 10000 };
