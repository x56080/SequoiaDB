...
public class ListMultipartUploads18746 extends S3TestBase {
    private int runSuccessNum = 0;
    private int expRunSuccessNum = 3;
    private AmazonS3 s3Client;
    private String bucketName = "bucket18746";
    ...
    @Test
    private void test_ltTotalRecs() throws Exception {
    ...
    @Test
    private void test_gtTotalRecs() throws Exception {
        ListMultipartUploadsRequest request = new ListMultipartUploadsRequest(
    ...
    @Test
    private void test_etTotalRecs() throws Exception {
        ListMultipartUploadsRequest request = new ListMultipartUploadsRequest(
