 ...
 * @Date 2019.07.30
 */
@Test(groups = "partlistinuseoff") public class UploadPart18691
        extends S3TestBase {
    ...
    private long[] partSize = new long[] { 200 * 1024, 100 * 1024, 150 * 1024,
            10 * 1024, 200 * 1024 };
    ...
    private void testUpload() throws Exception {
        ...
        for ( int i = 2; i < 7; i++ ) {
            es.addWorker(
                    new ThreadUploadPart18691( filepositon, partSize[ index ],
                            i ) );
    ...
    class ThreadUploadPart18691 {
        ...
        public ThreadUploadPart18691( long filepositon, long partSize,
                int partNumber ) {
