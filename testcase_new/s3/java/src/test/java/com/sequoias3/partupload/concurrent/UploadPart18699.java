...
/**
 * test content: 开启检测开关，上传多个分段不存在partNum为1、连续分段号且分段长度一致
 * testlink-case:seqDB-18699
 *
 * @author wangkexin
 * @Date 2019.7.30
 * @version 1.00
 */
public class UploadPart18699 extends S3TestBase {
    private boolean runSuccess = false;
    private String bucketName = "bucket18699";
    private String keyName = "key18699";
    ...
    class ThreadUploadPart18699 {
        private AmazonS3 s3Client = CommLib.buildS3Client();
        private long filepositon;
        private int partNumber;

        public ThreadUploadPart18699( long filepositon, int partNumber ) {
