...
/**
 * @Description seqDB-18695: upload multiple parts concurrently,there are conitnuous and
 *              discontiguous partNumber,the length of the parts is different and there is no
 *              partNum of 1.
 * @author wuyan
 * @Date 2019.07.29
 * @version 1.00
 */
@Test(groups = "partlistinuseoff") public class UploadPart18695
        extends S3TestBase {
    ...
    public void uploadParts() throws Exception {
        ...
        int[] partSizes = { 1024 * 100, 1024 * 200, 1024 * 150, 1024 * 10,
                1024 * 20, 1024 * 100 };
        int[] offSets = { 0, 1024 * 100, 1024 * 300, 1024 * 450, 1024 * 460,
                1024 * 480 };
        for ( int i = 0; i < partNumbers.length; i++ ) {
            ...
            threadExec.addWorker(
                    new PartUpload( partNumber, partSize, offSet, file,
                            uploadId ) );
        }
        threadExec.run();
