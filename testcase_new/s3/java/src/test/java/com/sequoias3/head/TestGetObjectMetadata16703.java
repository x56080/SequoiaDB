...
/**
 * test content: 指定ifMatch和ifUnModifiedSince条件查询对象，不匹配ifMatch testlink-case:
 * seqDB-16703
 *
 * @author wangkexin
 * @Date 2018.12.11
...
public class TestGetObjectMetadata16703 extends S3TestBase {
    private static CloseableHttpClient client;
    private boolean runSuccess = false;
    private String bucketName = "bucket16703";
    private String userName = "user16703";
    private String roleName = "normal";
    private String keyName = "key16703";
    private String content = "content16703";
