...
public class UploadPart18711 extends S3TestBase {
    ...
    public void uploadParts() throws Exception {
        ...
        List<PartETag> partEtags1 = PartUploadUtils.partUpload(s3Client, bucketName, keyName, uploadId1, file1,
                partSize1);
        ...
        List<PartETag> partEtags2 = PartUploadUtils.partUpload(s3Client, bucketName, keyName, uploadId2, file2,
                partSize2);
        PartUploadUtils.listPartsAndCheckPartNumbers(s3Client, bucketName, keyName, partEtags2, uploadId2);
    ...
    private void checkObjectContent(String bucketName, String keyName) throws Exception {
        ...
        String updateMd5 = ObjectUtils.getMd5OfObject(s3Client, localPath, bucketName, keyName, historyVersionId);
