...
public class UpdateRegion17304 extends S3TestBase {
    ...
    private void test() throws Exception {
        ...
        Assert.assertEquals( count1, 1, "csName1 = " + csName1 + ",clName1 = "
                + clName + ",objectName = " + objectName1 );
        Assert.assertEquals( count2, 1, "csName2 = " + csName2 + ",clName1 = "
                + clName + ",objectName = " + objectName2 );
