...
/**
 * test content: 指定ifUnModifiedSince条件查询对象 testlink-case: seqDB-16694
 *
 * @author wangkexin
 * @Date 2018.12.17
 * @version 1.00
...
public class TestGetObjectMetadata16694 extends S3TestBase {
    private static CloseableHttpClient client;
    private boolean runSuccess = false;
    private String bucketName = "bucket16694";
    private String userName = "user16694";
    private String roleName = "normal";
    private String keyName = "key16694";
    private String content = "content16694";
