...
/**
 * @Description: 开启版本控制，设置分隔符新增对象 testlink-case: seqDB-18098
 *
 * @author wangkexin
 * @Date 2019.04.13
 * @version 1.00
 */
public class CreateObject18098 extends S3TestBase {
    private boolean runSuccess = false;
    private String bucketName = "bucket18098";
    private String keyName = "/aa%abb%atest18098_1.png";
    private String keyName2 = "/aa%abb%atest18098_2.png";
