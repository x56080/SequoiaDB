...
/**
 * @Description: seqDB-18163 :To get a listVersions within a bucket.specify
 *               prefix and delimiter. the number of matching objects in the
 *               currentVersion less than 100,and matching objects in the
 *               history version less than 900
 * @author wuyan
 * @Date:2019.4.30
 * @version:1.0
 */

public class ListVersions18163 extends S3TestBase {
    private boolean runSuccess = false;
    private String bucketName = "bucket18163";
