...
/**
 * @Description seqDB-19341:指定ifNoneMatch和ifModifiedSince条件匹配源对象复制
 * @Author huangxiaoni
 * @Date 2019.09.17
 */
public class CopyObject19341 extends S3TestBase {
    private boolean runSuccess = false;
    private AmazonS3 s3Client = null;
    private String srcBucketName = "bucket19341a";
    private String dstBucketName = "bucket19341b";
    private String keyName = "obj19341";
    ...
    private void test() throws Exception {
        ...
        request.withModifiedSinceConstraint( srcObjHisLastModDate );
