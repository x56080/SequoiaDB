...
function test() {
  ...
  var location1 = "dc_actLoc_at_2_1";
  var location2 = "dc_actLoc_at_2_2";
  ...
  var result1 = dc.setActiveLocation(location1) ;
  if ( result1.toObj().SucceedNum != 1 ) {
    throw "Succeed num is not 1, result: " + result1.toJson() ;
  }
  ...
  var result2 = dc.setActiveLocation(location2);
  if ( result2.toObj().SucceedNum != 1 ) {
    throw "Succeed num is not 1, result: " + result2.toJson() ;
  }
  ...
  result2 = dc.setActiveLocation(location2);
  if ( result2.toObj().IgnoredNum != 1 ) {
    throw "Ignored num is not 1, result: " + result2.toJson() ;
  }
