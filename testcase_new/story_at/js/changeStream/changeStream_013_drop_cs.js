...
function test( testPara )
{
   ...
   // insert and drop collection space
   dbCL.insert( document ) ;
   db.dropCS( testConf.csName ) ;

   // check result
   checkChangeStreamInsertResult( cur, testConf.csName, testConf.clName, document ) ;
   checkChangeStreamErrorResult( cur, true, SDB_DMS_CS_NOTEXIST, "Collection space [" + testConf.csName + "] has been dropped" ) ;
