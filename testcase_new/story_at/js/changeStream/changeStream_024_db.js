 ...
 * 环境准备：正常集群环境即可
 * 测试场景：
 *    change stream resume from different nodes
 **************************************************************************************************/

var selectedGroup = selectGroupWithSecondary( db ) ;
testConf.clOpt = { Group: selectedGroup, ReplSize: -1 } ;
testConf.clName = COMMCLNAME + "_change_stream_024" ;

var newCSName = COMMCSNAME + "_change_stream_024_new" ;
