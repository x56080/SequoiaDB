...
function test(){
  ...
  db.analyze( { "Collection": COMMCSNAME + "." + mainCLName } );
  // 3.2.1 连接子表1查询统计信息
  checkCollectionStat( subCL1, subCLName1, 1, false, false, 10, 200, 100300, 105, 3610800 ) ;

  // 3.2.2 连接子表2查询统计信息
  checkCollectionStat( subCL2, subCLName2, 1, false, false, 10, 0, 0, 0, 0 ) ;

  // 3.2.3 连接主表查询统计信息
  checkCollectionStat( mainCL, mainCLName, 1, false, false, 10, 200, 100300, 105, 3610800 ) ;
  ...
  subCL1.truncate() ;
  checkCollectionStat( subCL1, subCLName1, 1, true, false, 10, 200, 200, 1, 80000 ) ;
  checkCollectionStat( mainCL, mainCLName, 1, true, false, 10, 600, 100200, 106, 3680000 ) ;
