 ...
 * @Version 1.00
 */
public class CreateClSlaver2164 implements StandTestInterface {
    ...
    /**
     * seqDB-2164 :: 版本: 1 :: 创建CL时catalog备节点断网（不指定Domain）_rlb.netSplit.metaOpr.CL.002
     * <p>
     * 1、创建CS，在该CS下创建CL（执行脚本构造循环执行创建多个CL操作）
     * 2、创建CL时catalog备节点所在主机网络中断（构造网络中断故障，如ifdown网卡）
     * 3、查看CL创建结果
     * 4、恢复网络故障（如ifup启动网卡）
