...
/**
* FileName: CreateCLAndKillPrimaryCatalog2280.java
* test content:when create cl(designated domain), kill -9  the catalog group master node             
* testlink case:seqDB-2280
* @author wuyan
    * @Date    2017.4.24
* @version 1.00
*/
        ...
        if ( CL_NUM == count ) {
        	try {
                ...
                if (e.getErrorCode() != -22) {
                	Assert.fail("the error not -22: "+e.getErrorCode()+e.getMessage());
                }
            } 
