...
public class DiskFullSubcl2326 extends SdbTestBase {
    private String mainClName = "testcaseCL2326";
    ...
    private int bound = 0;
    private NodeWrapper master = null;
    ...
    public void test() throws Exception {
        ...
        DiskFull df = new DiskFull(master.hostName(), SdbTestBase.reservedDir);
        df.init();
        df.make();
        ...
        public void exec() throws Exception {
            ...
            try {
                for (String name : subClNames) {
                    mainCL.attachCollection(csName + "." + name, (BSONObject) JSON.parse(
