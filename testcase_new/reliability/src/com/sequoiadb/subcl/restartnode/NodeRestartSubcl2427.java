...
/**
 * @FileName:SEQDB-2427 detachCL过程中catalog备节点正常重启
 * @author huangqiaohui
 * @version 1.00
 *
 */

public class NodeRestartSubcl2427 extends SdbTestBase {
    private String mainClName = "testcaseCL2427";
    ...
    public void test() {
        try {
            ...
            System.out.println("Restar Node:" + cataSlave.hostName() + ":" + cataSlave.svcName());
            // 建立并行任务
            FaultMakeTask faultTask = NodeRestart.getFaultMakeTask(cataSlave, 1, 10);
