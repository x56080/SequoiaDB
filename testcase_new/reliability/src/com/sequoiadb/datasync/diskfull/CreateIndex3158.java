...
/**
 * @FileName seqDB-3158: 创建索引过程中主节点磁盘满，该主节点为同步的源节点
 * @Author linsuqiang
 * @Date 2017-03-29
 * @Version 1.00
 */
...
/*
 * 1.创建CS，CL 
 * 2.指定所有选项（enforced/isUnique）批量创建索引 
 * 3.过程中构造磁盘满(dd购造) 
 * 4.继续创建 
 * 5.过程中故障恢复 
 * 6.验证结果
...
public class CreateIndex3158 extends SdbTestBase {
    private GroupMgr groupMgr = null;
    private boolean runSuccess = false;
    private String clName = "cl_3158";
