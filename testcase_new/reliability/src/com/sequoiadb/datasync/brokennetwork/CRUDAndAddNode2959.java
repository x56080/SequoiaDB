...
public class CRUDAndAddNode2959 extends SdbTestBase {
    ...
    public void setUp() {
        ...
        try {
            ...
            if (cataPriHost.equals(randomHost) && !cataGroup.changePrimary()) {
    ...
    public void test() {
        ...
        try {
            ...
            if (dataPriHost.equals(randomHost) && !dataGroup.changePrimary()) {
                throw new SkipException(dataGroup.getGroupName() + " reelect fail");
            }

            FaultMakeTask faultTask = BrokenNetwork.getFaultMakeTask(randomHost, 1, 10);
