...
/**
* @FileName WriteLobAndKillPrimaryNode3217.java
* test content:when write and remove Lob, kill -9  the data group master node, 
*              and the fault node is  synchronous source node.          
* testlink case:seqDB-3217
* @author wuyan
    * @Date    2017.5.3
* @version 1.00
*/
...
public class WriteLobAndKillPrimaryNode3217 extends SdbTestBase {
    ...
    public void test() {        
        try {
            ...
            Assert.assertEquals(groupMgr.checkBusinessWithLSN(120), true, "checkBusinessWithLSN() occurs timeout");
