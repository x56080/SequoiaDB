...
/**
 * @FileName seqDB-3214: 创建索引过程中主节点节点异常重启，该主节点为同步的源节点
 *           seqDB-9336: 创建索引过程中主节点异常重启，选出新主节点，该故障节点为同步的目的节点 
 * @Author linsuqiang
 * @Date 2017-03-29
 * @Version 1.00
 */
 ...
 * 5.过程中故障恢复，验证索引信息 
 * 
 * 注：ReplSize = 2,断主节点时，该节点有可能是同步的源节点，也有可能不是。若是，覆盖3214，若不是，覆盖9336
 */
