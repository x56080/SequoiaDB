...
/**
 * @FileName seqDB-3212: 创建CL过程中主节点节点异常重启，该主节点为同步的源节点
 *           seqDB-9334: 创建cs/cl过程中主节点异常重启，选出新主节点，该故障节点为同步的目的节点 
 * @Author linsuqiang
 * @Date 2017-03-29
 * @Version 1.00
 */
 ...
 * 6.随机选择CL插入数据
 * 
 * 注：ReplSize = 2,断主节点时，该节点有可能是同步的源节点，也有可能不是。若是，覆盖3212，若不是，覆盖9334
 */
