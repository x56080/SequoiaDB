...
/**
 * @FileName:SEQDB-2590 对range分区组进行百分比切分，切分时cata备节点断网
 * 
 * @author huangqiaohui
 * @version 1.00
 *
...
public class NetSplit2590 extends SdbTestBase {
    private String clName = "testcaseCL2590";
    ...
    public void setUp() {
        ...
        try {
            ...
            // 调整断网主机上的主节点
            brokenNetHost = groupMgr.getGroupByName(Utils.CATA_RG_NAME).getSlave().hostName();
