...
public class NetSplit2589 extends SdbTestBase {
    ...
    public void setUp() {
        ...
        try {
            ...
            // 调整断网主机上的主节点
            brokenNetHost = groupMgr.getGroupByName(Utils.CATA_RG_NAME).getMaster().hostName();
    ...
    public void test() {
        ...
        try {
            // 建立并行任务
            FaultMakeTask faultTask = BrokenNetwork.getFaultMakeTask(brokenNetHost, 3, 15, 25);
