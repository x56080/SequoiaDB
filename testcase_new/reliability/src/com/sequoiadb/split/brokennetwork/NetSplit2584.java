...
/**
 * @FileName:SEQDB-2584 对range分区组进行范围切分，切分时cata备节点断网
 * @author huangqiaohui
 * @version 1.00
 *
 */

public class NetSplit2584 extends SdbTestBase {
    private String clName = "testcaseCL2584";
    ...
    class Split extends OperateTask {
        ...
        public void exec() throws Exception {
            ...
            try {
                ...
                cl.split(srcGroupName, destGroupName, (BSONObject) JSON.parse("{sk:2500}"), // 切分
