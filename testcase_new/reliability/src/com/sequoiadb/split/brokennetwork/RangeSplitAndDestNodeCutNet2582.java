...
/**
* FileName: RangeSplitAndDestNodeCutNet2582.java
* test content:when the range cl split by range ,the dest group master node
*              breaks the net
* testlink case:seqDB-2582
* @author wuyan
    * @Date    2017.4.13
* @version 1.00
*/
...
public class RangeSplitAndDestNodeCutNet2582 extends SdbTestBase {
    ...
    public void setUp() {        
        try {
            ...
            Utils.reelect(brokenNetHost, destGroupName, Utils.CATA_RG_NAME);
				Utils.reelect(brokenNetHost, srcGroupName);
	...
	public void createCL(){	
		...
		try
		{
			...
			Assert.fail("create cl fail "+e.getErrorType()+":"+e.getMessage());
		}
	}
	...
	public static void bulkInsert(DBCollection cl,long startNo,long endNo){
		 try{
			 ...
			 Assert.fail("bulkinsert fail "+e.getErrorCode()+e.getMessage());
		 }		
	 }    
