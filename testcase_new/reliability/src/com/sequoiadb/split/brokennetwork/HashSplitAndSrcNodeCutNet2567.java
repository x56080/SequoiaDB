...
/**
* FileName: HashSplitAndSrcNodeCutNet2567.java
* test content:when the hash cl split by range ,the source group master node
*              breaks the net
* testlink case:seqDB-2567
* @author wuyan
    * @Date    2017.4.11
* @version 1.00
*/
...
public class HashSplitAndSrcNodeCutNet2567 extends SdbTestBase {
    ...
    public void test() {
        ...
        try {
            ...
            //insert 500 records after split,the incremental value of 0,the "no" value is 2000-2500
    ...
    class Split extends OperateTask {
        ...
        public void exec() throws Exception {
            ...
            try {
                ...
                cl2.split(srcGroupName, destGroupName, (BSONObject) JSON.parse("{Partition:2048}"), // 切分
