...
public class KillNodeSplit2771 extends SdbTestBase {
    ...
    public void test() {
        try {
            ...
            System.out.println(
                    "KillNode:" + cataMasterNode.hostName() + ":" + cataMasterNode.svcName());

            // 建立并行任务
            FaultMakeTask faultTask = KillNode.getFaultMakeTask(cataMasterNode.hostName(),
                    cataMasterNode.svcName(), 0);
