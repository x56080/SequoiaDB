...
/**
 * @FileName:SEQDB-2758 对hash分区组进行范围切分，切分时目标主节点异常重启
 * @author huangqiaohui
 * @version 1.00
 *
 */

public class KillNodeSplit2758 extends SdbTestBase {
    private String clName = "testcaseCL2758";
    ...
    public void test() {
        try {
            ...
            String destSvcName = destGroup.getMaster().svcName();
            System.out.println("KillNode:" + destPriHost + ":" + destSvcName);

            // 建立并行任务
            FaultMakeTask faultTask = KillNode.getFaultMakeTask(destPriHost, destSvcName, 1);
