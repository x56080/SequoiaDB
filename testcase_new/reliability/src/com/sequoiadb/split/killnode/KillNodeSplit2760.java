...
/**
 * @FileName:SEQDB-2760 对hash分区组进行百分比切分，切分时源主节点异常重启
 * @author huangqiaohui
 * @version 1.00
 *
 */

public class KillNodeSplit2760 extends SdbTestBase {
    private String clName = "testcaseCL2760";
    ...
    public void setUp() {
        try {
            ...
            DBCollection cl = commCS.createCollection(clName,
                    (BSONObject) JSON
                            .parse("{ShardingKey:{'sk':1},Partition:4096,ReplSize:-1,ShardingType:'hash',Group:'"
                                    + srcGroupName + "'}"));
            // 准备切分的数据
    ...
    public void test() {
        try {
            ...
            // 建立并行任务
            FaultMakeTask faultTask = KillNode.getFaultMakeTask(srcPriHost, srcSvcName, 1);
