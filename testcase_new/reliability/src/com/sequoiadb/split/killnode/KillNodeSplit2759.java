...
/**
 * @FileName:SEQDB-2759 对hash分区组进行范围切分，切分时目标备节点异常重启
 * @author huangqiaohui
 * @version 1.00
 *
 */

public class KillNodeSplit2759 extends SdbTestBase {
    private String clName = "testcaseCL2759";
    ...
    public void test() {
        try {
            ...
            System.out.println("KillNode:" + destSlave.hostName() + ":" + destSlave.svcName());
