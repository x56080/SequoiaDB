...
/**
 * @FileName:SEQDB-2763 对hash分区组进行百分比切分，切分时cata主节点异常重启
 * @author huangqiaohui
 * @version 1.00
 *
 */

public class KillNodeSplit2763 extends SdbTestBase {
    private String clName = "testcaseCL2763";
    ...
    public void test() {
        try {
            ...
            String cataSvcName = cataGroup.getMaster().svcName();
            System.out.println("KillNode:" + cataPriHost + ":" + cataSvcName);

            // 建立并行任务
            FaultMakeTask faultTask = KillNode.getFaultMakeTask(cataPriHost, cataSvcName, 1);
