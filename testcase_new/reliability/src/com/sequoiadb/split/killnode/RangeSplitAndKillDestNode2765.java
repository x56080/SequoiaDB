...
/**
* FileName: RangeSplitAndKillDestNode2765.java
* test content:when the range cl split by range , kill -9 the dest group master node*              
* testlink case:seqDB-2765
* @author wuyan
    * @Date    2017.4.19
* @version 1.00
*/
    ...
    class Split extends OperateTask {
        ...
        public void exec() throws Exception {
            ...
            try {
                ...
                dbcl.split(srcGroupName, destGroupName, (BSONObject) JSON.parse("{no:500}"), 
