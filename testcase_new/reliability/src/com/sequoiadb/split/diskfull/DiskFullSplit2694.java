...
/**
 * @FileName:SEQDB-2694 对hash分区组进行百分比切分，切分时cata组主节点所在服务器磁盘耗尽
 * @author huangqiaohui
 * @version 1.00
 *
 */

public class DiskFullSplit2694 extends SdbTestBase {
    private String clName = "testcaseCL2694";
    private String csName = "testcaseCL2694_cs";
    ...
    private boolean splitCompleteFlag = true;
    ...
    public void setUp() {
        try {
            ...
            // 调整主机
            NodeWrapper cataMaster = groupMgr.getGroupByName(Utils.CATA_RG_NAME).getMaster();
