...
/**
 * @FileName:SEQDB-2737 range分区组进行范围切分，切分时cata组备节点正常重启
 * @author huangqiaohui
 * @version 1.00
 *
 */

public class RestartNode2737 extends SdbTestBase {
    private String clName = "testcaseCL2737";
    ...
    public void test() {
        try {
            ...
            System.out.println("restart Node:" + cataSlave.hostName() + ":" + cataSlave.svcName());

            // 建立并行任务
            FaultMakeTask faultTask = NodeRestart.getFaultMakeTask(cataSlave, 1, 10, 10);
