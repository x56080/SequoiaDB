...
/**
* FileName: RangeSplitAndRestartDestNode2740.java
* test content:when the range cl split by persent , restart the dest group master node*              
* testlink case:seqDB-2740
* @author wuyan
    * @Date    2017.4.19
* @version 1.00
*/
