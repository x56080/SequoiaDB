...
/**
 * @Description seqDB-20521:事务操作过程中，数据节点主节点异常重启
 * @author zhaoyu
 * @date 2020-1-31
 *
 */
@Test(groups = "rr")
public class Transaction20521 extends SdbTestBase {
    private String csName = "cs20521";
    private String clName = "transCL_20521";
    ...
    public void test() throws ReliabilityException, InterruptedException {
        ...
        // 建立并行任务
        FaultMakeTask faultTask = KillNode.getFaultMakeTask( dataMaster,
