...
/**
 * @Description seqDB-31338:集合设置ReplSize为3，主位置多数派优先，插入数据过程中PrimaryLocation中备节点全部异常
 * @Author liuli
 * @Date 2023.05.04
 * @UpdateAuthor liuli
...
public class Location31338 extends SdbTestBase {

    private Sequoiadb sdb = null;
    private GroupMgr groupMgr;
    private DBCollection dbcl = null;
    private String csName = "cs_31338";
    private String clName = "cl_31338";
    private String primaryLocation = "guangzhou.nansha_31338";
    private String sameCityLocation = "guangzhou.panyu_31338";
    private String offsiteLocation = "shenzhan.nanshan_31338";
