...
/**
 * @FileName seqDB-3196: 删除索引过程中备节点节点异常重启，该备节点为同步的源节点 seqDB-3205:
...
/*
 * 1.创建CS，CL 2.指定所有选项批量创建索引 3.批量删除创建的索引 4.过程中构造 bin/sdbstop -p port &&
 * bin/sdbstart -c conf/local/port 5.继续删除 6.过程中恢复 7.验证结果 注：ReplSize =
 * 2,随机断一个备节点时，该节点有可能是同步的源节点，也有可能是同步的目的节点。
 */

public class DropIndex3196 extends SdbTestBase {
    private GroupMgr groupMgr = null;
    private boolean runSuccess = false;
    private String clNameBase = "cl_3196";
