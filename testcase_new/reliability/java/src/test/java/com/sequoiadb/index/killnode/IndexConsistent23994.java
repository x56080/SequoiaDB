...
/**
 * @Description seqDB-23994 :: 复制索引过程中catalog主节点异常
 * @author wuyan
 * @Date 2021.7.27
 * @version 1.10
 */

public class IndexConsistent23994 extends SdbTestBase {
    private boolean runSuccess = false;
    private DBCollection dbcl;
    private GroupMgr groupMgr;
    private Sequoiadb sdb;
    private String mainclName = "index_maincl_23994";
    private String subclName1 = "index_subcl_23994a";
    private String subclName2 = "index_subcl_23994b";
    private String indexName = "index23994";
    ...
    private void test() throws Exception {
        ...
        NodeWrapper slaveNode = cataGroup.getSlave();
