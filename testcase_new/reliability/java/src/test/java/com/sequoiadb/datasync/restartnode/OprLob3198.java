...
/**
 * @FileName seqDB-3198: LOB写入过程中备节点节点正常重启，该备节点为同步的源节点 seqDB-3207:
 *           LOB写入过程中备节点节点正常重启，该备节点为同步的目的节点
 * @Author linsuqiang
 * @Date 2017-03-20
 * @Version 1.00
 */
...
/*
 * 1.创建CS，CL 2.循环增删LOB 3.过程中构造 bin/sdbstop -p port && bin/sdbstart -c
 * conf/local/port 4.继续写入 5.过程中恢复 注：ReplSize =
 * 2,随机断一个备节点时，该节点有可能是同步的源节点，也有可能是同步的目的节点。
 */

public class OprLob3198 extends SdbTestBase {
    private GroupMgr groupMgr = null;
    private boolean runSuccess = false;
    private String clName = "cl_3198";
