...
/**
 * @FileName seqDB-3197: 文档写入过程中备节点节点正常重启，该备节点为同步的源节点 seqDB-3206:
 *           文档写入过程中备节点节点正常重启，该备节点为同步的目的节点
 * @Author linsuqiang
 * @Date 2017-03-27
 * @Version 1.00
 */
 ...
 * conf/local/port 4.继续写入 5.过程中恢复 6.验证结果 注：和单独测插入或删除不同，这个用例就是为了覆盖综合的场景
 * 所以特地涉足增删改查和lob操作，没有固定的预期结果， 只要节点间数据一致即可。 ReplSize =
 * 2,随机断一个备节点时，该节点有可能是同步的源节点，也有可能是同步的目的节点。
 */

public class CRUD3197 extends SdbTestBase {
    private GroupMgr groupMgr = null;
    private boolean runSuccess = false;
    private String clName = "cl_3197";
