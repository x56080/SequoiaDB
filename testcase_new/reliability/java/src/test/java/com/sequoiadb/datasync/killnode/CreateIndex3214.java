...
/**
 * @FileName seqDB-3214: 创建索引过程中主节点节点异常重启，该主节点为同步的源节点 seqDB-9336:
 *           创建索引过程中主节点异常重启，选出新主节点，该故障节点为同步的目的节点
 * @Author linsuqiang
 * @Date 2017-03-29
 * @Version 1.00
 */
...
/*
 * 1.创建CS，CL 2.指定所有选项（isUnique/enforced）批量创建索引 3.过程中构造节点异常重启(kill -9)
 * 4.选主成功后，继续创建部分索引 5.过程中故障恢复，验证索引信息 注：ReplSize =
 * 2,断主节点时，该节点有可能是同步的源节点，也有可能不是。若是，覆盖3214，若不是，覆盖9336
 */

public class CreateIndex3214 extends SdbTestBase {
    private GroupMgr groupMgr = null;
    private boolean runSuccess = false;
    private String clName = "cl_3214";
