...
/**
 * @Description seqDB-23408:使用数据源的集合空间执行数据操作过程中数据源节点异常
 * @author liuli
 * @Date 2021.06.02
 * @version 1.10
 */

public class DataSource23408 extends SdbTestBase {
    private Sequoiadb sdb = null;
    private Sequoiadb srcdb = null;
    private GroupMgr groupMgr = null;
    private GroupMgr srcGroupMgr = null;
    private String dataSrcName = "datasource23408";
    ...
    private String srcCSName = "cssrc_23408";
    private String csName = "cs_23408";
    private String clName = "cl_23408";
    ...
    private void checkResult() {
        ...
        // 再次插入1000条记录，范围从30000~31000
        insertDatas( dbcl, 30000, 31000 );
        long expCount = 1000;
        String cond = "{$and:[{no:{$gte:" + 30000 + "}},{no:{$lt:" + 31000
                + "}}]}";
