...
/**
 * @FileName:SEQDB-2692 对hash分区组进行百分比切分，切分时源组备节点所在服务器磁盘耗尽
 * @author huangqiaohui
 * @version 1.00
 *
 */

public class DiskFullSplit2692 extends SdbTestBase {
    private String clName = "testcaseCL2692";
    private String csName = "testcaseCL2692_cs";
