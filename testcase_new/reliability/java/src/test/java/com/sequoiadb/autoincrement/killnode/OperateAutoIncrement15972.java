...
/**
 * @FileName seqDB-15972: 新增/修改/删除自增字段时catalog整组异常重启 预置条件：集合中已存在多个自增字段
 *           操作步骤：1.并发执行如下操作：a.新增自增字段 b.修改自增字段属性 c.删除自增字段d.插入记录，同时catalog整组异常重启
 *           2.待集群正常后，再次插入记录 预期结果：1.自增字段操作失败
...
public class OperateAutoIncrement15972 extends SdbTestBase {
    private String clName = "cl_15972";
