...
/**
 * @Description seqDB-23991 :: 复制索引过程中部分子表所在数据主节点异常
 * @author wuyan
 * @Date 2021.4.23
 * @version 1.10
 */

public class IndexConsistent23991 extends SdbTestBase {
    ...
    private String mainclName = "index_maincl_23991";
    private String subclName1 = "index_subcl_23991a";
    private String subclName2 = "index_subcl_23991b";
    private String indexName = "index23991";
    ...
    private void test() throws Exception {
        ...
        IndexUtils.checkIndexTask( sdb, "Create index", SdbTestBase.csName,
                subclName2, indexName, succResultCode );
