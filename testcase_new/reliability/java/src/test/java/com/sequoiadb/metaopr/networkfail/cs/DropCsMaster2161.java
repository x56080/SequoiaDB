...
/**
 * @Description seqDB-2161:删除CS时catalog主节点断网_rlb.netSplit.metaOpr.CS.003
 * @Author laojingtang
 * @Date 2017.04.28
 * @UpdatreAuthor liuli
 ...
 * @version 1.10
 */
public class DropCsMaster2161 extends SdbTestBase {
    private Sequoiadb sdb = null;
    private GroupMgr groupMgr = null;
    private int num = 100;
    private List< String > csNames = new ArrayList<>();
    private String csName = "cs_2161";
     ...
     * 3、删除CS时catalog主节点所在主机网络中断（构造网络中断故障，如ifdown网卡） 3、查看CS信息和catalog主节点状态
    ...
    public void test() throws ReliabilityException, InterruptedException {
        ...
        // 删除所有CS后进行校验
        for ( int i = 0; i < csNames.size(); i++ ) {
            Utils.dropCollectionSpace( csNames.get( i ) );
        }
