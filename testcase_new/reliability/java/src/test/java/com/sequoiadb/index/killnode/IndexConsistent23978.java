...
/**
 * @Description seqDB-23978:创建索引过程中数据备节点异常
 * @author wuyan
 * @Date 2021.4.23
 * @version 1.10
 */

public class IndexConsistent23978 extends SdbTestBase {
    private boolean runSuccess = false;
    private DBCollection dbcl;
    private String groupName;
    private GroupMgr groupMgr;
    private Sequoiadb sdb;
    private String clName = "index_cl_23978";
    private String indexName = "index23978";
