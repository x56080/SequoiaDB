...
/**
 * @Description seqDB-22924:使用数据源的集合执行数据操作过程中网络异常
 * @author wuyan
 * @Date 2020.12.3
 * @version 1.10
 */

public class DataSource22924 extends SdbTestBase {
    private Sequoiadb sdb = null;
    private Sequoiadb srcdb = null;
    private GroupMgr groupMgr = null;
    private GroupMgr srcGroupMgr = null;
    private String dataSrcName = "datasource22924";
    ...
    private String srcCSName = "cssrc_22924";
    private String csName = "cs_22924";
    private String clName = "cl_22924";
