...
/**
 * @FileName:SEQDB-2695 对range分区组进行百分比切分，切分时源组主节点所在服务器磁盘耗尽
 * @author huangqiaohui
 * @version 1.00
 *
 */

public class DiskFullSplit2699 extends SdbTestBase {
    private String clName = "testcaseCL2699";
    private String csName = "testcaseCL2699_cs";
