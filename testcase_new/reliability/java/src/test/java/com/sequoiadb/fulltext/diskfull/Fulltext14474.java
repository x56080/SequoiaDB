...
/**
 * @FileName seqDB-14474：创建全文索引时备节点磁盘满
 * @Author zhaoyu
 * @Date 2019-08-05
 */

public class Fulltext14474 extends SdbTestBase {

    private Sequoiadb sdb = null;
    private CollectionSpace cs = null;
    private String csName = "cs14474";
    private String clName = "cl14474";
    private String indexName = "index14474";
    ...
    public void test() throws Exception {
        ...
        FaultMakeTask faultMakeTask = DiskFull
                .getFaultMakeTask( slave.hostName(), slave.dbPath(), 0, 10 );
