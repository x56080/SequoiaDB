...
/**
 * @FileName seqDB-3194: 删除CL过程中备节点节点正常重启，该备节点为同步的源节点 seqDB-3203:
 *           删除CL过程中备节点节点正常重启，该备节点为同步的目的节点
 * @Author linsuqiang
 * @Date 2017-03-27
 * @Version 1.00
 */
 ...
 * 3.继续删除 4.过程中恢复 5.验证结果 注：ReplSize = 2,随机断一个备节点时，该节点有可能是同步的源节点，也有可能是同步的目的节点。
 */

public class DropCL3194 extends SdbTestBase {
    private GroupMgr groupMgr = null;
    private boolean runSuccess = false;
    private String clNameBase = "cl_3194";
