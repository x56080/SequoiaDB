...
/**
 * @FileName seqDB-3200: LOB写入加新建节点过程中主节点节点正常重启，该主节点为同步的源节点 seqDB-3209:
 *           LOB写入加新建节点过程中主节点节点正常重启，该主节点为同步的目的节点
 * @Author linsuqiang
 * @Date 2017-03-20
 * @Version 1.00
 */
...
/*
 * 1.创建CS，CL，在CL上创建多个唯一索引 2.循环执行增删改操作 3.往副本组中新增节点 4.过程中购造 bin/sdbstop -p port &&
 * bin/sdbstart -c conf/local/port 5.继续写入 6.过程中恢复 7.验证结果 注：ReplSize =
 * 2,随机断一个备节点时，该节点有可能是同步的源节点，也有可能是同步的目的节点。
 */

public class OprLobAndAddNode3200 extends SdbTestBase {
    private GroupMgr groupMgr = null;
    private boolean runSuccess = false;
    private String clName = "cl_3200";
