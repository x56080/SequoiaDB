...
/**
 * @FileName seqDB-3171: 文档写入加新建节点过程中备节点磁盘满，该备节点为同步的源节点 seqDB-3180:
 *           文档写入加新建节点过程中备节点磁盘满，该备节点为同步的目的节点
 * @Author linsuqiang
 * @Date 2017-03-27
 * @Version 1.00
 */
...
/*
 * 1.创建CS，CL 2.循环执行增删改操作 3.往副本组中新增节点 4.过程中购造磁盘满(dd购造) 5.继续写入 6.过程中故障恢复 7.验证结果
 * 注：和单独测插入或删除不同，这个用例就是为了覆盖综合的场景 所以特地涉足增删改查和lob操作，没有固定的预期结果， 只要节点间数据一致即可。
 * ReplSize = 2,随机断一个备节点时，该节点有可能是同步的源节点，也有可能是同步的目的节点。
 */

public class CRUDAndAddNode3171 extends SdbTestBase {
    private GroupMgr groupMgr = null;
    private boolean runSuccess = false;
    private String clName = "cl_3171";
