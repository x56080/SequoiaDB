...
/**
 * @FileName seqDB-3170: LOB写入过程中备节点磁盘满，该备节点为同步的源节点 seqDB-3179:
 *           LOB写入过程中备节点磁盘满，该备节点为同步的目的节点
 * @Author linsuqiang
 * @Date 2017-03-20
 * @Version 1.00
 */
...
/*
 * 1.创建CS，CL 2.循环增删LOB 3.过程中构造磁盘满(dd购造) 4.继续写入 5.过程中故障恢复 6.验证结果 注： ReplSize =
 * 2，故障节点有可能是同步的源节点，也可能是同步的目的节点
 */

public class OprLob3170 extends SdbTestBase {
    private GroupMgr groupMgr = null;
    private boolean runSuccess = false;
    private String clName = "cl_3170";
