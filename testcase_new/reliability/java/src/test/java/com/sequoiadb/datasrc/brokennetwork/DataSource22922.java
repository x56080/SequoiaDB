...
/**
 * @Description seqDB-22922:创建使用数据源的集合空间/集合过程中网络异常
 * @author wuyan
 * @Date 2021.1.3
 * @version 1.10
 */

public class DataSource22922 extends SdbTestBase {
    private Sequoiadb sdb = null;
    private Sequoiadb srcdb = null;
    private GroupMgr groupMgr = null;
    private GroupMgr srcGroupMgr = null;
    private String dataSrcName = "datasource22922";
    private int num = 20;
    ...
    private String srcCSName = "cssrc_22922";
    private String srcCLName = "clsrc_22922";
    private String csName = "cs_22922";
    private String clName = "cl_22922";
    ...
    public void test() throws Exception {
        ...
        for ( int i = 0; i < num; i++ ) {
            ...
            csNames.add( subCSName );
            clNames.add( subCLName );
        }
    ...
    public void tearDown() {
        try {
            ...
            sdb.dropCollectionSpace( csName );
            for ( int i = 0; i < createSuccessCSNames.size(); i++ ) {
                sdb.dropCollectionSpace( createSuccessCSNames.get( i ) );
            }
