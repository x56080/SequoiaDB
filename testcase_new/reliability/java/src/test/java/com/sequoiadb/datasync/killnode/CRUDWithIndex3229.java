...
/**
 * @FileName seqDB-3229: 创建多个唯一索引后，写入文档过程中备节点节点异常重启，该备节点为同步的源节点 seqDB-3238:
 *           创建多个唯一索引后，写入文档过程中备节点节点异常重启，该备节点为同步的目的节点
 * @Author linsuqiang
 * @Date 2017-03-28
 * @Version 1.00
 */
...
public class CRUDWithIndex3229 extends SdbTestBase {
    private GroupMgr groupMgr = null;
    private boolean runSuccess = false;
    private String clName = "cl_3229";
