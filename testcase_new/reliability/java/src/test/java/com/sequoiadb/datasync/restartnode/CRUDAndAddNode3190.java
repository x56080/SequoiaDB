...
/**
 * @FileName seqDB-3190: 文档写入加新建节点过程中主节点节点正常重启，该主节点为同步的源节点
 * @Author linsuqiang
 * @Date 2017-03-27
 * @Version 1.00
 */
...
/*
 * 1.创建CS，CL 2.循环执行增删改操作 3.往副本组中新增节点 4.过程中购造 bin/sdbstop -p port && bin/sdbstart
 * -c conf/local/port 5.选主成功后，继续写入 6.过程中恢复 7.验证结果 注：和单独测插入或删除不同，这个用例就是为了覆盖综合的场景
 * 所以特地涉足增删改查和lob操作，没有固定的预期结果， 只要节点间数据一致即可。
 */

public class CRUDAndAddNode3190 extends SdbTestBase {
    private GroupMgr groupMgr = null;
    private boolean runSuccess = false;
    private String clName = "cl_3190";
