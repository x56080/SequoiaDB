...
/**
 * @FileName seqDB-3187: 删除索引过程中主节点节点正常重启，该主节点为同步的源节点
 * @Author linsuqiang
 * @Date 2017-03-29
 * @Version 1.00
 */
...
/*
 * 1.创建CS，CL 2.批量创建索引 3.批量删除创建的索引 4.过程中构造 bin/sdbstop -p port && bin/sdbstart -c
 * conf/local/port 5.选主成功后，继续删除 6.过程中恢复 7.验证结果
 */

public class DropIndex3187 extends SdbTestBase {
    private GroupMgr groupMgr = null;
    private boolean runSuccess = false;
    private String clNameBase = "cl_3187";
