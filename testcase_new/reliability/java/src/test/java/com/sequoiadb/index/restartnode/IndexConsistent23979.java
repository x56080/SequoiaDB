...
/**
 * @Description seqDB-23979 ::创建索引过程中数据主节点正常重启
 * @author wuyan
 * @Date 2021.4.23
 * @version 1.10
 */

public class IndexConsistent23979 extends SdbTestBase {
    private boolean runSuccess = false;
    private DBCollection dbcl;
    private String groupName;
    private GroupMgr groupMgr;
    private Sequoiadb sdb;
    private String clName = "index_cl_23979";
    private String indexName = "index23979";
    private int recsNum = 200000;
    ...
    private void test() throws Exception {
        ...
        FaultMakeTask faultTask = NodeRestart.getFaultMakeTask( priNode, 5, 10,
                10 );
        ...
        public void exec() throws Exception {
            {
                ...
                try ( Sequoiadb db = new Sequoiadb( SdbTestBase.coordUrl, "",
                    ...
                    if ( e.getErrorType() != SDBError.SDB_CLS_MUTEX_TASK_EXIST
                            .getErrorType()
                            && e.getErrorType() != SDBError.SDB_APP_INTERRUPT
                                    .getErrorType() ) {
                        throw e;
                    }
                }
