...
/**
 * @Description seqDB-22214:
 *              只有1个副本状态正常，其他副本状态为NOSPC或者DEADSYNC，在replSize=1的集合中插入记录
 * @Author Zhao Xiaoni
 * @Date 2020-6-4
 * @UpdatreAuthor liuli
 * @UpdateDate 2020-12-19
 */
public class FaultTolerance22214 extends SdbTestBase {
    private Sequoiadb sdb = null;
    private String csName = "cs_22214";
    private String clName = "cl_22214";
    ...
    public Object[][] configs() {
        return new Object[][] { { "NOSPC|DEADSYNC", 1, 10 },
                { "NOSPC|DEADSYNC", 2, 10 }, { "NOSPC|DEADSYNC", 3, 10 } };
    }
    ...
    public void test( String ftmask, int ftlevel, int ftfusingtimeout )
        ...
        mgr.addTask( new putLob( slaveNode1, slaveNode2, "NOSPC|DEADSYNC" ) );
        mgr.execute();
        Assert.assertTrue( mgr.isAllSuccess(), mgr.getErrorMsg() );
        FaultToleranceUtils.checkNodeStatus( slaveNode1, "NOSPC|DEADSYNC" );
        FaultToleranceUtils.checkNodeStatus( slaveNode2, "NOSPC|DEADSYNC" );

        FaultToleranceUtils.putLob( csName, clName, 10,
