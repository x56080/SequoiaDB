...
/**
 * @FileName seqDB-3226: LOB写入过程中备节点节点异常重启，该备节点为同步的源节点 seqDB-3235:
 *           LOB写入过程中备节点节点异常重启，该备节点为同步的目的节点
 * @Author linsuqiang
 * @Date 2017-03-20
 * @Version 1.00
 */
...
public class OprLob3226 extends SdbTestBase {
    private GroupMgr groupMgr = null;
    private boolean runSuccess = false;
    private String clName = "cl_3226";
