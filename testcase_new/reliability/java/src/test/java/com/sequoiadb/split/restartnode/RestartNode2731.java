...
/**
 * @FileName:SEQDB-2731 对hash分区组进行百分比切分，切分时目标主节点正常重启
 * @author huangqiaohui
 * @version 1.00
 *
 */

public class RestartNode2731 extends SdbTestBase {
    private String clName = "testcaseCL2731";
    ...
    public void test() {
        try {
            ...
            System.out.println( "restart Node:" + destMaster.hostName() + ":"
                    + destMaster.svcName() );
