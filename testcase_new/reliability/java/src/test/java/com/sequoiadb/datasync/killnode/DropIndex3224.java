...
/**
 * @FileName seqDB-3224: 删除索引过程中备节点节点异常重启，该备节点为同步的源节点 seqDB-3233:
 *           删除索引过程中备节点节点异常重启，该备节点为同步的目的节点
 * @Author linsuqiang
 * @Date 2017-03-29
 * @Version 1.00
 */
...
/*
 * 1.创建CS，CL 2.批量创建索引 3.批量删除创建的索引 4.过程中构造节点异常重启(kill -9) 5.选主成功后，继续删除 6.过程中故障恢复
 * ，验证索引信息 注：ReplSize = 2,随机断一个备节点时，该节点有可能是同步的源节点，也有可能是同步的目的节点。
 */

public class DropIndex3224 extends SdbTestBase {
    private GroupMgr groupMgr = null;
    private boolean runSuccess = false;
    private String clNameBase = "cl_3224";
