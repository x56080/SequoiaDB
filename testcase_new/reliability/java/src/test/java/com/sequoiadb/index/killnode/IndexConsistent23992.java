...
/**
 * @Description seqDB-23992 :: 复制索引过程中子表所在数据备节点异常
 * @author wuyan
 * @Date 2021.7.23
 * @version 1.10
 */

public class IndexConsistent23992 extends SdbTestBase {
    ...
    private String mainclName = "index_maincl_23992";
    private String subclName1 = "index_subcl_23992a";
    private String subclName2 = "index_subcl_23992b";
    private String indexName = "index23992";
    ...
    private void test() throws Exception {
        GroupWrapper dataGroup1 = groupMgr.getGroupByName( groupName1 );
        NodeWrapper slaveNode1 = dataGroup1.getSlave();
        FaultMakeTask faultTask1 = KillNode.getFaultMakeTask(
                slaveNode1.hostName(), slaveNode1.svcName(), 1 );
        GroupWrapper dataGroup2 = groupMgr.getGroupByName( groupName2 );
        NodeWrapper slaveNode2 = dataGroup2.getSlave();
        FaultMakeTask faultTask2 = KillNode.getFaultMakeTask(
                slaveNode2.hostName(), slaveNode2.svcName(), 1 );

        TaskMgr mgr = new TaskMgr( faultTask1 );
