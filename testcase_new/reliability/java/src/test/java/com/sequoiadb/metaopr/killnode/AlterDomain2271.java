...
/**
 * @FileName seqDB-2271: 更新domain时catalog备节点异常重启
 * @Author linsuqiang
 * @Date 2017-03-31
 * @Version 1.00
 */
 ...
 * （如group3） 3、更新域属性过程中catalog备节点异常重启（如执行kill -9杀掉节点进程，构造节点异常重启）
 * 3、查看domain更新结果和catalog备节点状态 4、节点启动成功后（查看节点进程存在）
 * 5、再次执行更新domain操作，并指定该domain创建CS/CL 6、向CL插入数据，查看数据是否正确落到该域对应的组内
 * 7、查看catalog主备节点上该domain信息是否正确
 */

public class AlterDomain2271 extends SdbTestBase {
    private GroupMgr groupMgr = null;
    private boolean runSuccess = false;
    private String domNameBase = "domain_2271";
    ...
    private void checkGroupsByCreateCL( Sequoiadb db ) {
        ...
        String clName = "cl_2271";
        cs.createCollection( "cl_2271" );
