...
/**
 * @FileName seqDB-2945: 删除索引过程中备节点断网，该主节点为同步的源节点 seqDB-2954:
 *           删除索引过程中备节点断网，该备节点为同步的目的节点
 * @Author linsuqiang
 * @Date 2017-03-29
 * @Version 1.00
 */
 ...
 * (例如：ifup)，验证索引信息 注：ReplSize = 2,随机断一个备节点时，该节点有可能是同步的源节点，也有可能是同步的目的节点。
 */

public class DropIndex2945 extends SdbTestBase {
    private GroupMgr groupMgr = null;
    private boolean runSuccess = false;
    private String clNameBase = "cl_2945";
