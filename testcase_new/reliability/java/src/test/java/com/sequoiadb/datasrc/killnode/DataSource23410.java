...
/**
 * @Description seqDB-23410:使用数据源的集合执行lob操作过程中数据源节点异常
 * @author liuli
 * @Date 2021.06.02
 * @version 1.10
 */

public class DataSource23410 extends SdbTestBase {
    private Sequoiadb sdb = null;
    private Sequoiadb srcdb = null;
    private GroupMgr groupMgr = null;
    private GroupMgr srcGroupMgr = null;
    private String dataSrcName = "datasource23410";

    private String srcCSName = "cssrc_23410";
    private String csName = "cs_23410";
    private String clName = "cl_23410";
