...
public class CompleteMultipartUploadAndS3ReStart18787 extends S3TestBase {
    ...
    public class CompleteMultipartUpload extends OperateTask {
        ...
        private CompleteMultipartUpload(String uploadId, List<PartETag> partEtags) {
    ...
    private List<PartETag> uploadParts(String uploadId) {
        int[] partSizes = { 1024 * 1024 * 6, 1024 * 1024 * 5, 1024 * 1024 * 6, 1024 * 1024 * 10, 1024 * 1024 * 20,
                1024 * 1024 * 6, 1024 * 1024 * 8, 1024 * 1024 * 20, 1024 * 1024 * 50, 1024 * 1024 * 7 };
        int partNumbers = 10;
        int filePosition = 0;
