...
public class UpdateObjectWithReStartS3N18208 extends S3TestBase {
    ...
    private void checkResult() throws Exception {
        ...
        Assert.assertEquals(vsList.getCommonPrefixes(),expCommonPrefixes,
                "act = " + vsList.getCommonPrefixes() + ",exp = " + expCommonPrefixes);
        Assert.assertEquals(vsList.getVersionSummaries().size(),0);

        String currVersionId = String.valueOf(new Random().nextInt(versionNums)+1);
    ...
    private void chectGetResult(S3Object object,String filePath)throws  Exception{
