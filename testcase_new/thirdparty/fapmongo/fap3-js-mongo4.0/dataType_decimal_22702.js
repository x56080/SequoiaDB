...
function main ()
{
   ...
   // seqDB-33158: numberNumberDecimal parameter test
   var docs = [
      { "_id": 3, "b": NumberDecimal( "-1.59507354245143932673458186E-1000" ) },
      { "_id": 4, "b": NumberDecimal( "1005950733333335424514393267458186E-1033" ) },
      { "_id": 5, "b": NumberDecimal( "-1005950733333335424514393267458186E-1033" ) },
   ...
   // seqDB-33160: 查询decimal数据
   cl.remove( {} );
   cl.insert( {"_id":1,"b":NumberDecimal("1.2345E+50")} );
   cl.insert( {"_id":2,"b":NumberDecimal("2.2345E+50")} );
   cl.insert( {"_id":3,"b":NumberDecimal("3.2345E+50")} );
   cl.insert( {"_id":4,"b":NumberDecimal("4.2345E+50")} );
   cl.insert( {"_id":5,"b":NumberDecimal("5.2345E+50")} );
