...
/**
 * @Descreption seqDB-32621 :: 版本: 1 :: 全量同步指定多个数据库，其中部分数据库不存在
 * @Author wangxingming
 * @CreateDate 2023/8/2
 ...
 * @Version 1.0
 */
public class SequoiaShake32621 {
    ...
    public void test() throws Exception {
        ...
        // 修改conf文件
        ssh.exec(
                "sed -i 's/filter.namespace.white =.*/filter.namespace.white = mgocs_1;mgocs_2;xxx;yyy;#$%/g' "
