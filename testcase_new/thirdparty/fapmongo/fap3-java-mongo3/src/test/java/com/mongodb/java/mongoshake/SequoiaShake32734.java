...
/**
 * @Descreption seqDB-32734 :: 版本: 1 ::
 *              设置full_sync.reader.write_document_parallel执行同步
 * @Author wangxingming
 ...
 * @Version 1.0
 */
public class SequoiaShake32734 {
    ...
    public void test() throws Exception {
        ...
        // 将数据迁移至目标端
        ssh.exec(
                "sed -i 's/full_sync.reader.write_document_parallel =.*/full_sync.reader.write_document_parallel = "
        ...
        System.out.println(
                "full_sync.reader.write_document_parallel = 1 数据迁移花费时间: "
        ...
        ssh.exec(
                "sed -i 's/full_sync.reader.write_document_parallel =.*/full_sync.reader.write_document_parallel = "
                        + "8/g' " + CommLib.toolPath + CommLib.confFileFull );
        Instant startTime2 = Instant.now();
        CommLib.genSequoiaShake( CommLib.confFileFull, ssh );
        Instant endTime2 = Instant.now();
        Duration duration2 = Duration.between( startTime2, endTime2 );
        System.out.println(
                "full_sync.reader.write_document_parallel = 8 数据迁移花费时间: "
