...
/**
 * @Descreption seqDB-32648 :: 版本: 1 :: 全量同步完成后更新数据
 * @Author wangxingming
 * @CreateDate 2023/8/4
 ...
 * @Version 1.0
 */
public class SequoiaShake32648 {
    ...
    public void test() throws Exception {
        ...
        mongoClient.getDatabase( cs ).getCollection( cl ).findOneAndUpdate(
                new Document( "int32", 20 ),
                new Document( "$set", new Document( "int32", 100 ) ) );
