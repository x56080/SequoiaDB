...
/**
 * @Descreption seqDB-33664:创建节点指定--bindip
 * @Author wangxingming
 * @CreateDate
 * @UpdateUser
 ...
 * @Version
 */
public class CTL_33664 extends CTLTestBase {
    ...
    public void test() throws Exception {
        // 创建节点
        ssh.exec(
                ctlPath + " initdb --port " + port + " --dbpath " + dataBasePath
                        + port + " --bindip \"0.0.0.0;" + remoteHost + "\"" );
        ...
        Assert.assertTrue( stdout.contains( "bindIp: 0.0.0.0;" + remoteHost ) );
    }
