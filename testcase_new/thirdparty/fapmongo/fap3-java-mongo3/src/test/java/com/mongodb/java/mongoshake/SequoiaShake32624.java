...
/**
 * @Descreption seqDB-32624 :: 版本: 1 :: 全量同步指定多个集合数据，其中部分集合不存在
 * @Author wangxingming
 * @CreateDate 2023/8/3
 ...
 * @Version 1.0
 */
public class SequoiaShake32624 {
    ...
    public void test() throws Exception {
        ...
        ssh.exec(
                "sed -i 's/filter.namespace.white =.*/filter.namespace.white = "
                        + "mgocs_1.mgocl_1;mgocs_1.mgocl_2;mgocs_1.mgocl_3;mgocs_1.mgocl_4/g' "
        ...
        CommLib.checkDataResult( "all", "config,mgocs_2,sequoiashake", ssh );
