...
/**
 * @Descreption seqDB-32665:工具收集index稀疏索引信息
 * @Author chenzejia
 * @CreateDate
 * @UpdateUser
 ...
 * @Version
 */
public class Collector_32665 extends M2STestBase {
    private MongoClient mongoClient = null;
    private Ssh ssh = null;
    private String databaseName = "db_32665";
    private String collectionName = "col_32665";
    private String indexName = "index_32665";
    ...
    public void test() throws Exception {
        ...
        collection.createIndex( Indexes.ascending( "name" ),
                new IndexOptions().sparse( true ).name( indexName ) );
