...
/**
 * @Descreption seqDB-32703 :: 版本: 1 :: 删除非增量同步的集合
 * @Author wangxingming
 * @CreateDate 2023/8/9
 ...
 * @Version 1.0
 */
public class SequoiaShake32703 {
    ...
    public void test() throws Exception {
        ...
        ssh.exec(
                "sed -i 's/filter.namespace.white =.*/filter.namespace.white = "
                        + "mgocs_1.mgocl_1;mgocs_1.mgocl_2/g' "
        ...
        mongoClient.getDatabase( cs2 ).getCollection( cl1 ).drop();
