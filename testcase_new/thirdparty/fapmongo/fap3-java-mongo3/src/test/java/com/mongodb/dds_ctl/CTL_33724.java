...
/**
 * @Descreption seqDB-33724:创建节点指定--dbpath的目录为相对路径
 * @Author HuangYouquan
 * @CreateDate
 * @UpdateUser
 ...
 * @Version
 */
public class CTL_33724 extends CTLTestBase {
    ...
    public void test() throws Exception {
        // 初始化节点, 指定--dbpath的目录为相对路径
        ssh.exec( " cd /opt/sequoiadds; " + ctlPath
                + " initdb --replname=rs0 --port=10000 --configsvr --dbpath=./database/10000" );
        // 启动节点
