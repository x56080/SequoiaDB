...
/**
 * @Descreption seqDB-32671 :: 版本: 1 :: 增量同步指定数据库数据
 * @Author wangxingming
 * @CreateDate 2023/8/7
 ...
 * @Version 1.0
 */
public class SequoiaShake32671 {
    ...
    public void test() throws Exception {
        ...
        ssh.exec(
                "sed -i 's/filter.namespace.white =.*/filter.namespace.white = mgocs_2/g' "
        ...
        CommLib.checkDataResult( "all", "config,sequoiashake,mgocs_1", ssh );
