...
public class Authentication21934 extends MongodbTestBase {
    ...
    public void test() throws UnknownHostException {
        ...
        // 删除用户
        temp1.executeCommand( new BasicDBObject( "dropUser", username1 ) );
        temp2.executeCommand( new BasicDBObject( "dropUser", username2 ) );
        // 重复删除用户
        temp1.executeCommand( new BasicDBObject( "dropUser", username1 ) );
        // 检查删除结果
        CommandResult userInfo3 = temp1
                .executeCommand( new BasicDBObject( "usersInfo", 1 ) );
        Assert.assertEquals( userInfo3.get( "users" ), Arrays.asList() );
