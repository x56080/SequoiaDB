...
/**
 * @Description seqDB-19324:复制对象，指定源对象内容较大（自动化用例验证复制1G大小文件）
 * @author wuyan
 * @Date 2019.09.18
 * @version 1.00
 */
public class CopyObject19324 extends S3TestBase {
    ...
    private String srcKeyName = "/srcObject19324";
    private String destKeyName = "/dest/object19324";
    private String bucketName = "bucket19324";
    private AmazonS3 s3Client = null;
    private int fileSize = 1024 * 1024 * 1024 * 1;
