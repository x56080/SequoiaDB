...
public class CreateRegion17299 extends S3TestBase {
    ...
    private static void setSystemTime( String host, String dateStr )
        ...
        Ssh ssh = null;
        try {
            ssh = new Ssh( host, S3TestBase.remoteuser,
                    S3TestBase.remotepasswd );
    ...
    private void test() throws Exception {
        ...
        for ( int i = 0; i < dateList.size(); i++ ) {
            String csName = RegionUtils.getDataCSName( regionName,
                    DataShardingType.MONTH, dateList.get( i ) );
            String clName = RegionUtils.getDataCLName( DataShardingType.YEAR,
                    dateList.get( i ) );
