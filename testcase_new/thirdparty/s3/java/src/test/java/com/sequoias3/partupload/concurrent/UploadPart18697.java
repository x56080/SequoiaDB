...
/**
 * @Description seqDB-18697: upload multiple parts concurrently,the length of
 *              the parts is different and there is partNum of 1.
 * @author wuyan
 * @Date 2019.07.29
 * @version 1.00
 */
public class UploadPart18697 extends S3TestBase {
    private boolean runSuccess = false;
    private String keyName = "/aa/object18697";
