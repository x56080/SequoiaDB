...
public class UploadPart18708 extends S3TestBase {
    ...
    public void uploadParts() throws Exception {
        ...
        List< PartETag > partEtags1 = PartUploadUtils.partUpload( s3Client,
                S3TestBase.bucketName, keyName, uploadId1, file1, partSize );
        PartUploadUtils.listPartsAndCheckPartNumbers( s3Client,
                S3TestBase.bucketName, keyName, partEtags1, uploadId1 );
        PartUploadUtils.completeMultipartUpload( s3Client,
                S3TestBase.bucketName, keyName, uploadId1, partEtags1 );
        ...
        List< PartETag > partEtags2 = PartUploadUtils.partUpload( s3Client,
                S3TestBase.bucketName, keyName, uploadId2, file2, partSize );
        PartUploadUtils.listPartsAndCheckPartNumbers( s3Client,
                S3TestBase.bucketName, keyName, partEtags2, uploadId2 );
        PartUploadUtils.completeMultipartUpload( s3Client,
                S3TestBase.bucketName, keyName, uploadId2, partEtags2 );
