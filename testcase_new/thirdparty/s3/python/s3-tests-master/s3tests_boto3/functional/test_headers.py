...
class TestHeaders(unittest.TestCase):
    ...
    def _add_header_create_object(self, headers, client=None):
    ...
    def _add_header_create_bad_object(self, headers, client=None):
    ...
    def _remove_header_create_bad_object(self, remove, client=None):
    ...
    def _remove_header_create_object(self, remove, client=None):
    ...
    def _add_header_create_bucket(self, headers, client=None):
    ...
    def _add_header_create_bad_bucket(self, headers=None, client=None):
    ...
    def _remove_header_create_bucket(self, remove, client=None):
    ...
    def _remove_header_create_bad_bucket(self, remove, client=None):
    ...
    def test_object_create_bad_md5_invalid_short(self):
        e = self._add_header_create_bad_object({'Content-MD5': 'YWJyYWNhZGFicmE='})
        status, error_code = _get_status_and_error_code(e.response)
        self.assertEqual(status, 400)
        self.assertEqual(error_code, 'InvalidDigest')
    ...
    # @attr(assertion='fails 400')
    def test_object_create_bad_md5_bad(self):
        e = self._add_header_create_bad_object({'Content-MD5': 'rL0Y20xC+Fzt72VPzMSk2A=='})
        status, error_code = _get_status_and_error_code(e.response)
        self.assertEqual(status, 400)
        self.assertEqual(error_code, 'BadDigest')
    ...
    # @attr(assertion='fails 400')
    def test_object_create_bad_md5_empty(self):
        e = self._add_header_create_bad_object({'Content-MD5': ''})
        status, error_code = _get_status_and_error_code(e.response)
        self.assertEqual(status, 400)
        self.assertEqual(error_code, 'InvalidDigest')
    ...
    def test_object_create_bad_md5_none(self):
        bucket_name, key_name = self._remove_header_create_object('Content-MD5')
        client = get_client()
    ...
    def test_object_create_bad_expect_mismatch(self):
        bucket_name, key_name = self._add_header_create_object({'Expect': 200})
        client = get_client()
        client.put_object(Bucket=bucket_name, Key=key_name, Body='bar')
    ...
    def test_object_create_bad_expect_empty(self):
        bucket_name, key_name = self._add_header_create_object({'Expect': ''})
        client = get_client()
        client.put_object(Bucket=bucket_name, Key=key_name, Body='bar')
    ...
    # @attr(assertion='succeeds')
    def test_object_create_bad_expect_none(self):
        bucket_name, key_name = self._remove_header_create_object('Expect')
        client = get_client()
        client.put_object(Bucket=bucket_name, Key=key_name, Body='bar')
    ...
    # @attr('fails_on_rgw')
    def test_object_create_bad_contentlength_empty(self):
        e = self._add_header_create_bad_object({'Content-Length': ''})
        status, error_code = _get_status_and_error_code(e.response)
        self.assertEqual(status, 400)
    ...
    def test_object_create_bad_contentlength_negative(self):
        client = get_client()
        bucket_name = get_new_bucket()
        key_name = 'foo'
    ...
    # # TODO: remove 'fails_on_rgw' and once we have learned how to remove the content-length header
    # @attr('fails_on_rgw')
    def test_object_create_bad_contentlength_none(self):
        remove = 'Content-Length'
        e = self._remove_header_create_bad_object('Content-Length')
        status, error_code = _get_status_and_error_code(e.response)
        self.assertEqual(status, 411)
        self.assertEqual(error_code, 'MissingContentLength')
    ...
    # # TODO: remove 'fails_on_rgw' and once we have learned how to remove the content-length header
    # @attr('fails_on_rgw')
    def test_object_create_bad_contentlength_mismatch_above(self):
        content = 'bar'
    ...
    # @attr(assertion='succeeds')
    def test_object_create_bad_contenttype_invalid(self):
        bucket_name, key_name = self._add_header_create_object({'Content-Type': 'text/plain'})
        client = get_client()
        client.put_object(Bucket=bucket_name, Key=key_name, Body='bar')
    ...
    # @attr(assertion='succeeds')
    def test_object_create_bad_contenttype_empty(self):
        client = get_client()
        key_name = 'foo'
        bucket_name = get_new_bucket()
    ...
    # @attr(assertion='succeeds')
    def test_object_create_bad_contenttype_none(self):
        bucket_name = get_new_bucket()
        key_name = 'foo'
        client = get_client()
    ...
    # @attr('fails_on_rgw')
    def test_object_create_bad_authorization_empty(self):
        e = self._add_header_create_bad_object({'Authorization': ''})
        status, error_code = _get_status_and_error_code(e.response)
    ...
    # @attr('fails_on_rgw')
    def test_object_create_date_and_amz_date(self):
        date = formatdate(usegmt=True)
        bucket_name, key_name = self._add_header_create_object({'Date': date, 'X-Amz-Date': date})
        client = get_client()
        client.put_object(Bucket=bucket_name, Key=key_name, Body='bar')
    ...
    # # TODO: remove 'fails_on_rgw' and once we have learned how to pass both the 'Date' and 'X-Amz-Date' header during signing and not 'X-Amz-Date' before
    # @attr('fails_on_rgw')
    def test_object_create_amz_date_and_no_date(self):
        date = formatdate(usegmt=True)
        bucket_name, key_name = self._add_header_create_object({'Date': '', 'X-Amz-Date': date})
        client = get_client()
        client.put_object(Bucket=bucket_name, Key=key_name, Body='bar')
    ...
    # # TODO: remove 'fails_on_rgw' and once we have learned how to remove the authorization header
    # @attr('fails_on_rgw')
    def test_object_create_bad_authorization_none(self):
        e = self._remove_header_create_bad_object('Authorization')
        status, error_code = _get_status_and_error_code(e.response)
        self.assertEqual(status, 403)
    ...
    # # TODO: remove 'fails_on_rgw' and once we have learned how to remove the content-length header
    # @attr('fails_on_rgw')
    def test_bucket_create_contentlength_none(self):
        remove = 'Content-Length'
        self._remove_header_create_bucket(remove)
    ...
    # # TODO: remove 'fails_on_rgw' and once we have learned how to remove the content-length header
    # @attr('fails_on_rgw')
    def test_object_acl_create_contentlength_none(self):
        bucket_name = get_new_bucket()
        client = get_client()
    ...
    # @attr(assertion='fails 400')
    def test_bucket_put_bad_canned_acl(self):
        bucket_name = get_new_bucket()
        client = get_client()
    ...
    # @attr(operation='create w/expect 200')
    # @attr(assertion='garbage, but S3 succeeds!')
    def test_bucket_create_bad_expect_mismatch(self):
        bucket_name = get_new_bucket_name()
        client = get_client()
    ...
    # @attr(assertion='garbage, but S3 succeeds!')
    def test_bucket_create_bad_expect_empty(self):
        headers = {'Expect': ''}
        self._add_header_create_bucket(headers)
    ...
    # @attr('fails_on_rgw')
    def test_bucket_create_bad_contentlength_empty(self):
        headers = {'Content-Length': ''}
        e = self._add_header_create_bad_bucket(headers)
        status, error_code = _get_status_and_error_code(e.response)
        self.assertEqual(status, 400)
    ...
    # @attr(assertion='fails 400')
    # @attr('fails_on_mod_proxy_fcgi')
    def test_bucket_create_bad_contentlength_negative(self):
    ...
    # # TODO: remove 'fails_on_rgw' and once we have learned how to remove the content-length header
    # @attr('fails_on_rgw')
    def test_bucket_create_bad_contentlength_none(self):
        remove = 'Content-Length'
        self._remove_header_create_bucket(remove)
    ...
    # @attr('fails_on_rgw')
    def test_bucket_create_bad_authorization_empty(self):
    ...
    # # TODO: remove 'fails_on_rgw' and once we have learned how to manipulate the authorization header
    # @attr('fails_on_rgw')
    def test_bucket_create_bad_authorization_none(self):
        e = self._remove_header_create_bad_bucket('Authorization')
        status, error_code = _get_status_and_error_code(e.response)
        self.assertEqual(status, 403)
        self.assertEqual(error_code, 'AccessDenied')
    ...
    # @attr(operation='create w/invalid MD5')
    # @attr(assertion='fails 400')
    def test_object_create_bad_md5_invalid_garbage_aws2(self):
        v2_client = get_v2_client()
        headers = {'Content-MD5': 'AWS HAHAHA'}
        e = self._add_header_create_bad_object(headers, v2_client)
        status, error_code = _get_status_and_error_code(e.response)
        self.assertEqual(status, 400)
        self.assertEqual(error_code, 'InvalidDigest')
    ...
    # @attr('fails_on_rgw')
    def test_object_create_bad_contentlength_mismatch_below_aws2(self):
        v2_client = get_v2_client()
        content = 'bar'
        length = len(content) - 1
        headers = {'Content-Length': str(length)}
    ...
    # # TODO: remove 'fails_on_rgw' and once we have learned how to manipulate the authorization header
    # @attr('fails_on_rgw')
    def test_object_create_bad_authorization_incorrect_aws2(self):
        v2_client = get_v2_client()
    ...
    # # TODO: remove 'fails_on_rgw' and once we have learned how to manipulate the authorization header
    # @attr('fails_on_rgw')
    def test_object_create_bad_authorization_invalid_aws2(self):
        v2_client = get_v2_client()
    ...
    # @attr(assertion='succeeds')
    def test_object_create_bad_ua_empty_aws2(self):
        v2_client = get_v2_client()
        headers = {'User-Agent': ''}
        bucket_name, key_name = self._add_header_create_object(headers, v2_client)
    ...
    # @attr(assertion='succeeds')
    def test_object_create_bad_ua_none_aws2(self):
        v2_client = get_v2_client()
        remove = 'User-Agent'
        bucket_name, key_name = self._remove_header_create_object(remove, v2_client)
        v2_client.put_object(Bucket=bucket_name, Key=key_name, Body='bar')
    ...
    # @attr(assertion='fails 403')
    def test_object_create_bad_date_invalid_aws2(self):
        v2_client = get_v2_client()
    ...
    # @attr(assertion='fails 403')
    def test_object_create_bad_date_empty_aws2(self):
        v2_client = get_v2_client()
        headers = {'x-amz-date': ''}
        e = self._add_header_create_bad_object(headers, v2_client)
        status, error_code = _get_status_and_error_code(e.response)
    ...
    # @attr('fails_on_rgw')
    def test_object_create_bad_date_none_aws2(self):
        v2_client = get_v2_client()
        remove = 'x-amz-date'
        e = self._remove_header_create_bad_object(remove, v2_client)
        status, error_code = _get_status_and_error_code(e.response)
        self.assertEqual(status, 403)
        self.assertEqual(error_code, 'AccessDenied')
    ...
    # @attr(assertion='fails 403')
    def test_object_create_bad_date_before_today_aws2(self):
        v2_client = get_v2_client()
        headers = {'x-amz-date': 'Tue, 07 Jul 2010 21:53:04 GMT'}
        e = self._add_header_create_bad_object(headers, v2_client)
        status, error_code = _get_status_and_error_code(e.response)
        self.assertEqual(status, 403)
        self.assertEqual(error_code, 'RequestTimeTooSkewed')
    ...
    # @attr(assertion='fails 403')
    def test_object_create_bad_date_before_epoch_aws2(self):
        v2_client = get_v2_client()
    ...
    # @attr(assertion='fails 403')
    def test_object_create_bad_date_after_end_aws2(self):
        v2_client = get_v2_client()
    ...
    # # TODO: remove 'fails_on_rgw' and once we have learned how to remove the date header
    # @attr('fails_on_rgw')
    def test_bucket_create_bad_authorization_invalid_aws2(self):
        v2_client = get_v2_client()
        headers = {'Authorization': 'AWS HAHAHA'}
        e = self._add_header_create_bad_bucket(headers, v2_client)
        status, error_code = _get_status_and_error_code(e.response)
        self.assertEqual(status, 400)
        self.assertEqual(error_code, 'InvalidArgument')
    ...
    # @attr(operation='create w/empty user agent')
    # @attr(assertion='succeeds')
    def test_bucket_create_bad_ua_empty_aws2(self):
        v2_client = get_v2_client()
        headers = {'User-Agent': ''}
        self._add_header_create_bucket(headers, v2_client)
    ...
    # @attr(operation='create w/no user agent')
    # @attr(assertion='succeeds')
    def test_bucket_create_bad_ua_none_aws2(self):
        v2_client = get_v2_client()
        remove = 'User-Agent'
        self._remove_header_create_bucket(remove, v2_client)
    ...
    # @attr(operation='create w/invalid date')
    # @attr(assertion='fails 403')
    def test_bucket_create_bad_date_invalid_aws2(self):
        v2_client = get_v2_client()
        headers = {'x-amz-date': 'Bad Date'}
        e = self._add_header_create_bad_bucket(headers, v2_client)
        status, error_code = _get_status_and_error_code(e.response)
    ...
    # @attr(operation='create w/empty date')
    # @attr(assertion='fails 403')
    def test_bucket_create_bad_date_empty_aws2(self):
        v2_client = get_v2_client()
        headers = {'x-amz-date': ''}
        e = self._add_header_create_bad_bucket(headers, v2_client)
        status, error_code = _get_status_and_error_code(e.response)
    ...
    # # TODO: remove 'fails_on_rgw' and once we have learned how to remove the date header
    # @attr('fails_on_rgw')
    def test_bucket_create_bad_date_none_aws2(self):
        v2_client = get_v2_client()
        remove = 'x-amz-date'
        e = self._remove_header_create_bad_bucket(remove, v2_client)
        status, error_code = _get_status_and_error_code(e.response)
        self.assertEqual(status, 403)
        self.assertEqual(error_code, 'AccessDenied')
    ...
    # @attr(operation='create w/date in past')
    # @attr(assertion='fails 403')
    def test_bucket_create_bad_date_before_today_aws2(self):
        v2_client = get_v2_client()
        headers = {'x-amz-date': 'Tue, 07 Jul 2010 21:53:04 GMT'}
        e = self._add_header_create_bad_bucket(headers, v2_client)
        status, error_code = _get_status_and_error_code(e.response)
    ...
    # @attr(assertion='fails 403')
    def test_bucket_create_bad_date_after_today_aws2(self):
        v2_client = get_v2_client()
    ...
    # @attr(operation='create w/date before epoch')
    # @attr(assertion='fails 403')
    def test_bucket_create_bad_date_before_epoch_aws2(self):
        v2_client = get_v2_client()
        headers = {'x-amz-date': 'Tue, 07 Jul 1950 21:53:04 GMT'}
        e = self._add_header_create_bad_bucket(headers, v2_client)
        status, error_code = _get_status_and_error_code(e.response)
