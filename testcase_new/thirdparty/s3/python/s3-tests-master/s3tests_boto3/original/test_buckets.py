...
from s3tests_boto3.functional.utils import assert_raises, Counter
...
from s3tests_boto3.functional.file_utils import *
...
class TestBucket(unittest.TestCase):
    ...
    def validate_bucket_list(self, bucket_name, prefix, delimiter, marker, max_keys,
        ...
        print('response[NextMarker] =', response['NextMarker'])
    ...
    def test_bucket_list_prefix_basic(self):
        ...
        print('response = ', response)
        print("response[Prefix]", response['Prefix'])
    ...
    def test_bucket_list_unordered(self):
        ...
        reponse = client.list_objects(Bucket=bucket_name, Delimiter="/")
    ...
    def test_bucket_list_maxkeys_invalid(self):
        ...
        reponse = client.list_objects(Bucket=bucket_name)
        print('------------------reponse=', reponse)
    ...
    #     bucket_name = get_new_bucket_name()
    #     client = get_client()
    #     print('location_constraint:', location_constraint)
    ...
    def test_atomic_write_1mb(self):
        self._test_atomic_write(1024 * 1024 * 1)
    ...
    def test_ranged_request_skip_leading_bytes_response_code(self):
        ...
        fetched_content = self._get_body(response)
        print('fetched_content:', fetched_content)
