...
/**
 * @FileName:seqDB-6640: range百分比切分，分区键为多个字段
 * 1、CL为range分区集合，分区键为单个字段，压缩类型为snappy，对CL做百分比切分
 * 2、检查返回结果 
 * @Author linsuqiang
 * @Date 2016-12-21
 * @Version 1.00
 */
public class TestSnappy6640 extends SdbTestBase {
    private Sequoiadb sdb = null;
    private String clName = "cl_6640";
    ...
    private DBCollection createCL(){
        ...
        try{
            option.put("ShardingKey", (BSONObject)JSON.parse("{a:1},{b:1},{c:1}"));
