...
public class CompressUtils extends SdbTestBase {
    ...
    public static void checkCompressed(DBCollection cl, String dataGroupName, String compressionType){
        int tryTimes = 10;
        ...
        for(int i = 0; i < tryTimes; i++){
            ...
            if(compressionType != null){
                ...
                boolean ratioRight = (double)detail.get("CurrentCompressionRatio") < expRatio;
                boolean attrRight = ((String)detail.get("Attribute")).equals("Compressed");
                boolean typeRight = ((String)detail.get("CompressionType")).equals(compressionType);
                if(ratioRight && attrRight && typeRight){
                    compressed = true;
                    break;
                }
            }else{
                boolean typeRight = ((String)detail.get("CompressionType")).equals("");
