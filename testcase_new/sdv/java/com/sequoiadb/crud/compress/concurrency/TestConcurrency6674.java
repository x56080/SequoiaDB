...
/**
 * @FileName:seqDB-6674:对不同压缩类型的CL并发插入数据
 * 1、创建多个不同压缩类型的CL（包括不压缩、snappy压缩、lzw压缩），并发插入大量数据 
...
public class TestConcurrency6674 extends SdbTestBase {
     ...
     * @param clName
     * @param compressionType. if null, not compressed.
     * @return cl
     */
    private DBCollection createCL(Sequoiadb db, String clName, String compressionType){
