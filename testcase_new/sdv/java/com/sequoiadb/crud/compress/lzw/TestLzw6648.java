...
/**
 * @FileName:seqDB-6648:插入记录数<100条，总记录大小>64M 1、CL压缩类型为lzw，插入记录满足如下条件：
 ...
 * @Version 1.00
 */
public class TestLzw6648 extends SdbTestBase {
    ...
    public void test() {
        ...
        try {
            ...
            Assert.assertEquals( LzwUtils.isDictExist( cl, dataGroupName ),
                    false,
    ...
    private DBCollection createCL() {
        ...
        try {
            dataGroupName = ( ( ArrayList< String > ) LzwUtils
