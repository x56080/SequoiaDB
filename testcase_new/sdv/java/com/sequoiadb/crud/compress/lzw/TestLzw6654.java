...
/**
 * @FileName:seqDB-6654:插入16M大小的记录
 * 1、CL压缩类型为lzw，插入多条16M大小的记录 
 * 2、检查返回结果，并检查数据压缩情况 
 * @Author linsuqiang
 * @Date 2016-12-27
 * @Version 1.00
...
public class TestLzw6654 extends SdbTestBase {
    ...
    private String bigStr = LzwUtils.getRandomString(15 * 1024 * 1024);
    private String smallStr = LzwUtils.getRandomString(512 * 1024);
