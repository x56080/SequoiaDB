 ...
 * @Date 2016-12-16
 */
public class TestCompress6669 extends SdbConfTestBase {
    ...
    public void checkAdd() {
        try {
            DBCursor cursor = this.cl.query((BSONObject) JSON.parse("{$and:[{_id:{$gte:115}},{_id:{$lt:120}}]}"), null, null, null);
            int i = 0;
            while( cursor.hasNext() ) {
               cursor.getNext();
               i++;
