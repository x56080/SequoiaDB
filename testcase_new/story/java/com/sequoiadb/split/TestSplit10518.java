 ...
 *
 */
public class TestSplit10518 extends SdbTestBase{
    private Sequoiadb sdb;
    private CollectionSpace cs;
    private DBCollection cl;
    private String clName1 = "cl10518_0";
    private String clName2 = "cl10518_1";
    ...
    public void test() {
        try {
            ...
            BSONObject option = (BSONObject) JSON.parse("{ShardingKey:{subobj:1},ShardingType:\"range\",Group:\"" + rgNames.get(0) + "\"}");
            ...
            BSONObject b1 = new BasicBSONObject();
            BSONObject b2 = new BasicBSONObject();
            b1.put("a", 55);
            b2.put("a", 87);
            BSONObject startCondition = new BasicBSONObject();
            BSONObject endCondition = new BasicBSONObject();
            startCondition.put("subobj", b1);
            endCondition.put("subobj", b2);
