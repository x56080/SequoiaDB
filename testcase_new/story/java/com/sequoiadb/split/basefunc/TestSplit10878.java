...
/**
 * @FileName:seqDB-10878: hash分区表指定分区键值为OID类型，执行切分 
 * 1、创建cl，指定shardingType为“hash” 
 * 2、向cl中插入数据，其中分区键字段值为OID类型 
 * 3、执行splitAysnc异步切分，设置范围切分条件 
...
public class TestSplit10878 extends SdbTestBase{
    ...
    public void test() {
        try {
            ...
            taskIDs[0] = cl.splitAsync(srcGroup, dstGroup, startCondition, endCondition);
