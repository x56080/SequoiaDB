 ...
 *
 */
public class TestSplit10509 extends SdbTestBase{
    private Sequoiadb sdb;
    private CollectionSpace cs;
    private DBCollection cl;
    private String clName1 = "cl10509_0";
    private String clName2 = "cl10509_1";
    ...
    public void test() {
        try {
            ...
            BSONObject option = (BSONObject) JSON.parse("{ShardingKey:{num:1},ShardingType:\"range\",Group:\"" + rgNames.get(0) + "\"}");
            ...
            BSONObject startCondition = (BSONObject) JSON.parse("{num:0.59}");
    ...
    public void testReverse() {
        try {
            ...
            this.insertRecods = (ArrayList<BSONObject>) SplitUtils2.insertData(this.cl, 100);
            BSONObject startCondition = (BSONObject) JSON.parse("{num:0.79}");
            BSONObject endCondition = new BasicBSONObject();
            this.cl.split(rgNames.get(0), rgNames.get(1), startCondition, endCondition);
            //连接coord节点验证数据是否正确
            testCoordSplitResult(rgNames);
