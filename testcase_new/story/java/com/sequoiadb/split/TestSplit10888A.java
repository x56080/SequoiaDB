...
public class TestSplit10888A extends SdbTestBase{
    ...
    public void testCombination1() {
        try {
            ...
            BSONObject option = 
                    (BSONObject) JSON.parse("{ShardingKey:{arrtype:1,height:-1,num:-1,timestamp:1}," +
            ...
            long splitAsync1 = this.cl.splitAsync(rgNames.get(0), rgNames.get(1), startCondition, endCondition);
    ...
    public void testCombination2() {
        try {
            ...
            List<String> rgNames = SplitUtils2.getDataRgNames(this.sdb); 
            BSONObject option = 
                    (BSONObject) JSON.parse("{ShardingKey:{_id:1,date:1,bdecimal:-1}," +
                            "ShardingType:\"hash\",Partition:1024,Group:\"" + rgNames.get(0) + "\"}");
            ...
            long splitAsync2 = this.cl.splitAsync(rgNames.get(0), rgNames.get(1), startCondition, endCondition);
    ...
    public void testCombination3() {
        try {
            ...
            List<String> rgNames = SplitUtils2.getDataRgNames(this.sdb); 
            BSONObject option = 
                    (BSONObject) JSON.parse("{ShardingKey:{_id:-1,num:1}," +
                            "ShardingType:\"hash\",Partition:1024,Group:\"" + rgNames.get(0) + "\"}");
            ...
            endCondition.put("Partition", 1024);
            long splitAsync3 = this.cl.splitAsync(rgNames.get(0), rgNames.get(1), startCondition, endCondition);
    ...
    public void insertData(int len){
        ...
        try{
            ...
            for (int i = 1; i < len; i++) {
                ...
                str = "2016-12-0" + i; 
                str = str + " 12:30:0" + i + "." + (100000 + (123456+i)%100000); 
                String mydate = str;
