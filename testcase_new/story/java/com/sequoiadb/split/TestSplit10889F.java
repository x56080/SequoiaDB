 ...
 *
 */
public class TestSplit10889F extends SdbTestBase{
    private Sequoiadb sdb;
    private CollectionSpace cs;
    private DBCollection mainCL;
    private DBCollection subCL;
    private String mainCLName = "mainCL10889F_0";
    private String subCLName = "subCL10889F_0";
    ...
    public void test() {
        ...
        //创建主表
        BSONObject option = 
                (BSONObject) JSON.parse("{IsMainCL:true,ShardingKey:{_id:-1,bdecimal:1},ShardingType:\"range\"}");
        this.mainCL = SplitUtils2.createCL(this.cs, this.mainCLName, option);
        
        //a、_id+decimal
        option = 
              (BSONObject) JSON.parse("{ShardingKey:{_id:-1,bdecimal:1}," +
