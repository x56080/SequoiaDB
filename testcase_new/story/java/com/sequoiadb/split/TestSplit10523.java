...
public class TestSplit10523 extends SdbTestBase{
    ...
    public void testCombination1() {
        try {
            ...
            BSONObject option = 
                    (BSONObject) JSON.parse("{ShardingKey:{height:-1,timestamp:1},ShardingType:\"range\",Group:\"" + rgNames.get(0) + "\"}");
            this.cl = SplitUtils2.createCL(this.cs, this.clName1, option); 
            insertData(10);

            BSONObject startCondition = 
                    (BSONObject) JSON.parse("{height:0,timestamp:{\"$timestamp\":\"2016-11-30-00.00.00.000000\"}}"); 
            BSONObject endCondition = 
                    (BSONObject) JSON.parse("{height:0,timestamp:{\"$timestamp\":\"2016-11-30-23.59.59.999999\"}}");
    ...
    public void testCombination2() {
        try {
            ...
            List<String> rgNames = SplitUtils2.getDataRgNames(this.sdb); 
            BSONObject option = 
                    (BSONObject) JSON.parse("{ShardingKey:{num:1,date:1,age:-1},ShardingType:\"range\",Group:\"" + rgNames.get(0) + "\"}");
    ...
    public void testCombination3() {
        try {
            ...
            List<String> rgNames = SplitUtils2.getDataRgNames(this.sdb); 
            BSONObject option = 
                    (BSONObject) JSON.parse("{ShardingKey:{_id:-1,bdecimal:1},ShardingType:\"range\",Group:\"" + rgNames.get(0) + "\"}");
