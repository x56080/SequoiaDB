...
/**
 * @FileName:SEQDB-10497 range分区表指定范围切分数据 1、向cl中插入数据记录 2、执行split，设置范围切分条件
...
public class Split10497 extends SdbTestBase {
	private String clName = "testcaseCL10497";
	...
	public void split() {
		try {
			...
			commCL.split(srcGroupName, destGroupName, (BSONObject) JSON.parse("{sk:30}"), // 切分
