...
public class TestSplit10513 extends SdbTestBase{
    ...
    public void test() {
        try {
            ...
            BSONObject option = (BSONObject) JSON.parse("{ShardingKey:{boolvalue:1},ShardingType:\"range\",Group:\"" + rgNames.get(0) + "\"}");
            ...
            BSONObject endCondition = (BSONObject) JSON.parse("{boolvalue:true}");
    ...
    public void testReverse() {
        try {
            ...
            this.insertRecods = (ArrayList<BSONObject>) SplitUtils2.insertData(this.cl, 100);
            BSONObject startCondition = (BSONObject) JSON.parse("{boolvalue:false}");
