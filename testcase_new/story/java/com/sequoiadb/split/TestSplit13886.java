...
/**
* FileName: TestSplit13886.java
* test content:split and insert record
* testlink case:seqDB-13886
* @author luweikang
    * @Date    2017.12.20
* @version 1.00
*/
...
public class TestSplit13886 extends SdbTestBase {
	...
	public void setUp(){
		...
		try{
			...
			Assert.assertFalse(false, "connect %s failed,"+coordUrl+e.getMessage());
		}
	...
	private class Split extends SdbThreadBase{
        ...
        public void exec() throws Exception {
            ...
            try{
                ...
                sourceRGName = SplitUtils.getSrcGroupName(db,SdbTestBase.csName,clName);
	...
	public void insertRecord(){
		try {
			...
			Assert.assertTrue(false,"init data failed:"+e.getMessage()+e.getStackTrace());
		}
	}
