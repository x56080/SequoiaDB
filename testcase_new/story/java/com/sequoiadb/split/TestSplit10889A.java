 ...
 *
 */
public class TestSplit10889A extends SdbTestBase{
    private Sequoiadb sdb;
    private CollectionSpace cs;
    private DBCollection mainCL;
    private DBCollection subCL;
    private String mainCLName = "mainCL10889A_0";
    private String subCLName = "subCL10889A_0";
    ...
    public void test() {
        ...
        //执行切分      
        this.subCL.split(rgNames.get(0), rgNames.get(1), startCondition, endCondition);
