 ...
 *
 */
public class TestSplit10519 extends SdbTestBase{
    private Sequoiadb sdb;
    private CollectionSpace cs;
    private DBCollection cl;
    private String clName1 = "cl10519_0";
    private String clName2 = "cl10519_1";
    ...
    public void test() {
        try {
            ...
            BSONObject option = (BSONObject) JSON.parse("{ShardingKey:{arrtype:1},ShardingType:\"range\",Group:\"" + rgNames.get(0) + "\"}");
            ...
            BSONObject b1 = new BasicBSONList();
            b1.put("0", 23);
            BSONObject b2 = new BasicBSONList();
            b2.put("0", 73);
            BSONObject startCondition = new BasicBSONObject();
            BSONObject endCondition = new BasicBSONObject();
            startCondition.put("arrtype", b1);
            endCondition.put("arrtype", b2);
