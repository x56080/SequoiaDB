...
/**
 * hash分区表指定指定多个分区键执行切分 
 * @author chensiqin
 * @Date 2016-12-21
 *
 */
public class TestSplit10887 extends SdbTestBase{
    private Sequoiadb sdb;
    private CollectionSpace cs;
    private DBCollection cl;
    private String clName1 = "cl10887_0";
    private String clName2 = "cl10887_1";
    private String clName3 = "cl10887_2";
    ...
    public void testCombination1() {
        try {
            ...
            BSONObject option = 
                    (BSONObject) JSON.parse("{ShardingKey:{arrtype:1,age:-1,timestamp:1}," +
    ...
    public void testCombination2() {
        try {
            ...
            List<String> rgNames = SplitUtils2.getDataRgNames(this.sdb); 
            BSONObject option = 
                    (BSONObject) JSON.parse("{ShardingKey:{height:1,num:1,date:1,bdecimal:-1}," +
                    		"ShardingType:\"hash\",Partition:1024,Group:\"" + rgNames.get(0) + "\"}");
    ...
    public void testCombination3() {
        try {
            ...
            List<String> rgNames = SplitUtils2.getDataRgNames(this.sdb); 
            BSONObject option = 
                    (BSONObject) JSON.parse("{ShardingKey:{_id:-1,height:-1}," +
                    		"ShardingType:\"hash\",Partition:1024,Group:\"" + rgNames.get(0) + "\"}");
