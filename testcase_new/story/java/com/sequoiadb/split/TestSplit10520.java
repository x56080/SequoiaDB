 ...
 *
 */
public class TestSplit10520 extends SdbTestBase{
    private Sequoiadb sdb = null;
    private CollectionSpace cs;
    private DBCollection cl;
    private String clName1 = "cl10520_0";
    private String clName2 = "cl10520_1";
    ...
    public void test() {
        try {
            ...
            BSONObject option = (BSONObject) JSON.parse("{ShardingKey:{nulltype:1},ShardingType:\"range\",Group:\"" + rgNames.get(0) + "\"}");
            ...
            startCondition.put("nulltype", null);
            endCondition.put("nulltype", 8);
    ...
    public void testReverse() {
        try {
            ...
            BSONObject startCondition = new BasicBSONObject();
            BSONObject endCondition = new BasicBSONObject();
            startCondition.put("nulltype", "");
            endCondition.put("nulltype", null);
            this.cl.split(rgNames.get(0), rgNames.get(1), startCondition, endCondition);
            //连接coord节点验证数据是否正确
            testCoordSplitResult(rgNames);
    ...
    public void testSrcDataSplitResult(List<String> rgNames, boolean isReverse) {
        ...
        try {
            ...
            if ( isReverse ) {
                //当切分键["",null),期望结果是[1,100)之间i%2==0的记录
                for (int i = 1; i < 100; i++ ){
                    if ( i%2 == 0 ) {
    ...
    public void testDestDataSplitResult(List<String> rgNames, boolean isReverse) {
        ...
        try {
            ...
            List<BSONObject> expected = new ArrayList<BSONObject>();
            if ( isReverse ) {
                //逆序当切分键["",null),期望结果是[1,100)之间i%2==1的记录
                for (int i = 1; i < 100; i++ ){
                    if ( i%2 == 1 ) {
                        expected.add(this.insertRecods.get(i-1));
                    }
                ...
                //[null,8)在组上的期望结果对应的是1,2,3,5,7,8,[9,100)之间i能被2整除的
