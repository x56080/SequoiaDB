...
/**
 * hash分区表指定分区键值为空类型，执行切分 
 * @author chensiqin
 * @Date 2016-12-21
 *
 */
public class TestSplit10886 extends SdbTestBase{
    private Sequoiadb sdb = null;
    private CollectionSpace cs;
    private DBCollection cl1;
    private DBCollection cl2;
    private String clName1 = "cl10886_0";
    private String clName2 = "cl10886_1";
    ...
    public void testCoordSplitResult(List<String> rgNames, boolean isReverse) {
        try {
            ...
            if ( isReverse ) {
                cursor = this.cl2.query(null,null,"{\"_id\":1}",null);
            } else {
                cursor = this.cl1.query(null,null,"{\"_id\":1}",null);
            }
    ...
    public void insertData(DBCollection cl, int len){
        ...
        try{
            ...
            for (int i = 1; i <= len; i++) {
                ...
                this.insertRecords.add(bson);
            } 
            cl.bulkInsert(this.insertRecords, 0 );
        }catch (BaseException e) {
            e.printStackTrace();
            Assert.fail();
        }
