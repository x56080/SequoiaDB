...
/**
 *  range分区表指定分区键为多种数据类型，执行切分 ,比较类型
 *   1、创建cl，分区类型为“range”
 ...
 *   3、执行split，设置范围切分条件 （切分键字段要分别覆盖所有的数据类型，如db.cs.cl.split("group1","group2",{a:int类型数据})）
...
public class TestSplit10894 extends SdbTestBase{
    ...
    public Object[][] providerMethod() {
        ...
        String destRe2 = "[{ \"_id\" : 1 , \"type\" : 123}, " +
                ...
                "{ \"_id\" : 14 , \"type\" :  null }, { \"_id\" : 15 , \"type\" : { \"$minKey\" : 1}}]";
        //double
        BSONObject startCondition3 = (BSONObject) JSON.parse("{type:123.456}");
        ...
        String destRe3 = "[{ \"_id\" : 1 , \"type\" : 123}, " +
                ...
                "{ \"_id\" : 13 , \"type\" : [ 0]}, " +
                "{ \"_id\" : 14 , \"type\" :  null }, { \"_id\" : 15 , \"type\" : { \"$minKey\" : 1}}]";
        BSONObject startCondition4 = (BSONObject) JSON.parse("{type:{\"$decimal\":\"12345.06789123456789012345100\"}}");
        ...
        String destRe4 = "[{ \"_id\" : 1 , \"type\" : 123}, " +
                ...
                "{ \"_id\" : 14 , \"type\" :  null }, { \"_id\" : 15 , \"type\" : { \"$minKey\" : 1}}]";
        //String
        BSONObject startCondition5 = (BSONObject) JSON.parse("{type:\"zhangsan\"}");
        ...
        String destRe5 = "[{ \"_id\" : 1 , \"type\" : 123}, " +
                ...
                "{ \"_id\" : 14 , \"type\" :  null }, { \"_id\" : 15 , \"type\" : { \"$minKey\" : 1}}]";
        //OID
        BSONObject startCondition6 = (BSONObject) JSON.parse("{type:{\"$oid\":\"15713f7953e6769804000001\"}}");
        ...
        String destRe7 = "[{ \"_id\" : 1 , \"type\" : 123}, " +
                ...
                "{ \"_id\" : 14 , \"type\" :  null }, { \"_id\" : 15 , \"type\" : { \"$minKey\" : 1}}]";
        //date
        BSONObject startCondition8 = (BSONObject) JSON.parse("{type:{\"$date\":\"2016-12-12\"}}");
        ...
        String destRe8 = "[{ \"_id\" : 1 , \"type\" : 123}, " +
                ...
                "{ \"_id\" : 14 , \"type\" :  null }, { \"_id\" : 15 , \"type\" : { \"$minKey\" : 1}}]";
        //timstamp
        BSONObject startCondition9 = (BSONObject) JSON.parse("{type:{\"$timestamp\":\"2014-07-01-12.30.30.124232\"}}");
        ...
        String destRe9 = "[{ \"_id\" : 1 , \"type\" : 123}, " +
                ...
                "{ \"_id\" : 14 , \"type\" :  null }, { \"_id\" : 15 , \"type\" : { \"$minKey\" : 1}}]";
        //binary
        BSONObject startCondition10 = (BSONObject) JSON.parse("{type:{\"$binary\":\"aGVsbG8gd29ybGQ=\"}}");
        ...
        String destRe10 = "[{ \"_id\" : 1 , \"type\" : 123}, " +
                ...
                "{ \"_id\" : 14 , \"type\" :  null }, { \"_id\" : 15 , \"type\" : { \"$minKey\" : 1}}]";
        //正则
        BSONObject startCondition11 = (BSONObject) JSON.parse("{type:{\"$regex\":\"^2001\",\"$options\":\"i\"}}");
        ...
        String destRe11 = "[{ \"_id\" : 1 , \"type\" : 123}, " +
                ...
                "{ \"_id\" : 14 , \"type\" :  null }, { \"_id\" : 15 , \"type\" : { \"$minKey\" : 1}}]";
        //对象
        BSONObject startCondition12 = (BSONObject) JSON.parse("{type:{\"a\":1}}");
        ...
        String destRe12 = "[{ \"_id\" : 1 , \"type\" : 123}, " +
                ...
                "{ \"_id\" : 14 , \"type\" :  null }, { \"_id\" : 15 , \"type\" : { \"$minKey\" : 1}}]";
        //数组
        BSONObject startCondition13 = (BSONObject) JSON.parse("{\"type\" : [ 0]}");
        ...
        String destRe13 ="[{ \"_id\" : 13 , \"type\" : [ 0]}, " +
                "{ \"_id\" : 14 , \"type\" :  null }, { \"_id\" : 15 , \"type\" : { \"$minKey\" : 1}}]";
        //空
        BSONObject startCondition14 = (BSONObject) JSON.parse("{\"type\" :  null}");
        ...
        //minkey
        //BSONObject startCondition15 = (BSONObject) JSON.parse("{\"type\" : { \"$maxKey\" : 1}}");
        return new Object[][]{
                {startCondition1, srcRe1, destRe1, all},
    ...
    public void test(BSONObject startCondition1,String srcRe1,String destRe1,String all) {
        try {
            //得到数据组
            ...
            insertData();
            //执行切分
            this.cl.split(rgNames.get(0), rgNames.get(1), startCondition1, new BasicBSONObject());
            //连接源组data验证数据
    ...
    public void testSrcDataSplitResult(List<String> rgNames,String expected) {
        Sequoiadb dataDb = null;
        try {
            //连接源组data验证数据
            String url = SplitUtils2.getGroupIPByGroupName(this.sdb, rgNames.get(0));
            dataDb = new Sequoiadb(url, "", "");
            CollectionSpace cs1 = dataDb.getCollectionSpace(SdbTestBase.csName);
    ...
    public void testDestDataSplitResult(List<String> rgNames, String expected) {
        Sequoiadb dataDb = null;
        try {
            //连接目标组data查询
    ...
    public void insertData() {
        try{
            ...
            this.cl.insert(obj);
            //正则表达式
            Pattern pattern = Pattern.compile("^2001",Pattern.CASE_INSENSITIVE);
            obj = new BasicBSONObject();
