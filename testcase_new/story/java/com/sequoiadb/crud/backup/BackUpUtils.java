...
public class BackUpUtils {
	 ...
	 */
	public static DBCollection createCL(Sequoiadb sdb, String csName, String clName) throws BaseException {
		try {
	 ...
	 * @throws BaseException
	 */
	public static String getSrcGroupName(Sequoiadb sdb, DBCollection cl) throws BaseException {
		try {
	 ...
	 * @throws BaseException
	 */
	public static String getDstGroupName(Sequoiadb sdb, String srcGroupName) throws BaseException {
		// get all groups name
		...
		for (int i = 0; i < groupNames.size(); i++) {
			...
			if (currGroupName.equals(srcGroupName) || currGroupName.equals("SYSCatalogGroup")
