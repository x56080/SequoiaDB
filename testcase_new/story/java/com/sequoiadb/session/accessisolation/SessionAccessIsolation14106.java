...
/**
* FileName: SessionAccessIsolation14106.java
* test content:multiple session connections on the same coord,seting session properties differently
* testlink case:seqDB-14106
* @author wuyan
    * @Date    2018.1.16
* @version 1.00
*/
public class SessionAccessIsolation14106 extends SdbTestBase {
	...
	public void testSession(){
		...
		for ( int i = 0; i < instanceid.length; i++ ){
			...
			accessSessions.add(new AccessSession( instanceid[i], nodeName))  ;
		}
