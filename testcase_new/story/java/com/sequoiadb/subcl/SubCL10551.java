...
/**
 * @TestName:SEQDB-10551 子表在不同分区组上部分存在索引，通过主表进行索引操作:1.创建主子表，其中子表指定在不同的数据组上，
 *                       且部分子表存在步骤2中操作的索引
...
public class SubCL10551 extends SdbTestBase {
	private Sequoiadb sdb;
	private CollectionSpace commCS;
	private DBCollection mainCL;
	private DBCollection subCL1;
	private DBCollection subCL2;
	private String mainCLName = "mainCL10551";
	private String subCL1Name = "subCL10551_1";
	private String subCL2Name = "subCL1051_2";
