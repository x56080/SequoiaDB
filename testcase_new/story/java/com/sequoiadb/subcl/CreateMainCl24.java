...
/**
 * FileName: CreateMainCl24.java
 * test content:  创建主表时指定多个分区键 
 * testlink case: seqDB-24
 * @author zengxianquan
 * @date 2016年12月9日
 * @version 1.00
 */
public class CreateMainCl24 extends SdbTestBase{
	...
	public void createMaincl(){
		...
		try{
			...
			Assert.fail("Failed to create maincl  "
					+ "ErrorMsg:\n" +e.getMessage());
		}
		Assert.assertEquals(cs.isCollectionExist(mainclName),true,"maincl is not exist");
	}
