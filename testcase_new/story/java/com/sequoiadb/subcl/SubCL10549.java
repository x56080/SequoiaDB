...
/**
 * @TestName:SEQDB-10549 子表在不同分区组上不存在索引，通过主表进行索引操作
 *                       1.创建主子表，其中子表指定在不同的数据组上，且所有子表不存在步骤2中操作的索引
...
public class SubCL10549 extends SdbTestBase {
	private Sequoiadb sdb;
	private CollectionSpace commCS;
	private DBCollection mainCL;
	private DBCollection subCL1;
	private DBCollection subCL2;
	private String mainCLName = "mainCL10549";
	private String subCL1Name = "subCL10549_1";
	private String subCL2Name = "subCL10549_2";
	...
	public void test() {
		try {
			...
			// 再次查询，检查扫描方式
			queryByIndexAndCheckExplain("{sk:80}", "{sk:80,num:80,_id:{$oid:\"" + oidPrefix + "80\"}}", "tbscan");
