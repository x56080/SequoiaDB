...
/**
 * FileName: CreateMainCl28.java
 * test content: 使用默认参数创建主表功能验证 
 * testlink case: seqDB-28
 * @author zengxianquan
 * @date 2016年12月9日
 * @version 1.00
 */
public class CreateMainCl28 extends SdbTestBase{
	private Sequoiadb db = null;
	private String csName = null;
	private CollectionSpace cs = null;
	private String mainclName = "maincl_28";
	private String subclName = "subcl_28";
