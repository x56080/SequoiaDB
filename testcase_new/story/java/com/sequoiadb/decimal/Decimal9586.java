...
public class Decimal9586 extends SdbTestBase{
	...
	public Object[][] createTypicalData(){
		return new Object[][]{
			...
			{"-.2","-0.2"},
			{"1.7e+310",""},
			{"-17E309","-"},
			{"-4.94065645841246544E-329","-0."},
			{"49406.5645841246544e-333","0."},
		};
	}
	...
	public void test(String basicString, int genPrecision, int genScale){
		//insert data and check
		genBoundaryDecimalFromBigDecimalAndCheck( basicString, genPrecision, genScale);
	}
	...
	public void testAbnormal(String basicString, int genPrecision, int genScale){
		//illegaData check
		try{
	...
	public void genBoundaryDecimalFromBigDecimalAndCheck( String basicString, 
		...
		try{
			...
			if(actualBigDecimal.compareTo(data) != 0){
				Assert.fail("compare bigDecimal data failed,expect data:" + data + 
	...
	public void genIllegalDecimalAndCheck(String basicString,int genPrecision, int genScale){
		String genValue = "";
		String genInteger = basicString;
		String genFractional = "";
		if(basicString.contains("-")){
	...
	public void genTypicalDecimalFromBigDecimalAndCheck(String value, String expectValue){
		BSONObject obj = new BasicBSONObject();
		try{
