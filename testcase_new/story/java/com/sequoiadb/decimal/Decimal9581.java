...
public class Decimal9581 extends SdbTestBase{
	...
	public Object[][] createData(){
		return new Object[][]{
			...
			{"0","0.000",5,3},
			{"112233.112233445566778899","112233.112233445566778899",24,18},
			{"-123.112233445566778899","-123.112233445566778899",21,18},
			...
			{"1.7e+310",".00",
				1000,2},
			{"-1.7E310","-",
				1000,0},
			{"-4.94065645841246544E-329","-0.",
					1000,350},
			{"4.94065645841246544e-329","0.",
						1000,350},
			//seqDB-9582
	...
	public void testAbnormal(String value, int precision, int scale){
		//illegaData check
		try{
			BSONDecimal illegalData = new BSONDecimal(value, precision, scale);
