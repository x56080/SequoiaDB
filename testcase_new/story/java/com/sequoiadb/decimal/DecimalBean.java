...
public String toString() {
	return "DecimalBean [decimalNoPrecision=" + decimalNoPrecision + ", decimalWithPrecision=" + decimalWithPrecision
...
public int hashCode() {
	...
	result = prime * result + ((decimalNoPrecision == null) ? 0 : decimalNoPrecision.hashCode());
	result = prime * result + ((decimalWithPrecision == null) ? 0 : decimalWithPrecision.hashCode());
	return result;
}
@Override
