...
public class Split10538 extends SdbTestBase {
	...
	public void tearDown() {
		try {
			...
			commSdb.removeBackup((BSONObject) JSON.parse("{Name:'testcase10538backupSrc'}"));
	...
	private void checkDestGroup(int expectedCount, String macher, int expectTotalCount, String groupName) {
		Sequoiadb destDataNode = null;
		try {
			destDataNode = commSdb.getReplicaGroup(groupName).getMaster().connect();// 获得目标组主节点链接
