...
public class ParameterTest extends DataSourceTestBase {
	...
	void createDataSource(){
		try{
			super.init();
			if (datasource == null){
				datasource = new SequoiadbDatasource(this.coordAddr, this.userName, this.password, null);
			}
	...
	void coordUrlTest(){
		try{
			SequoiadbDatasource datasource = new SequoiadbDatasource(null, this.userName, this.password, null);
			Assert.assertTrue(false);
			datasource.close();
		}catch(BaseException e){
			super.judegeErrCode("SDB_INVALIDARG", e.getErrorCode());
		...
		try{
			SequoiadbDatasource datasource = new SequoiadbDatasource(null, this.userName, this.password, null, null);
			Assert.assertTrue(false);
			datasource.close();
		}catch(BaseException e){
			super.judegeErrCode("SDB_INVALIDARG", e.getErrorCode());
		...
		coordAddrList.add(null);
		coordAddrList.add("");
		
		try{
			SequoiadbDatasource datasource = new SequoiadbDatasource(coordAddrList, this.userName, this.password, null, null);
			Assert.assertTrue(false);
		}catch(BaseException e){
			super.judegeErrCode("SDB_INVALIDARG", e.getErrorCode());
		}*/
