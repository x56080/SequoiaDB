...
public class CacheTurnOnTest16718 extends SdbTestBase {
    ...
    public Object[][] getClientOption() {
        return new Object[][] { new Object[] { true, 15000 },
    ...
    void init() {
        try {
            ...
            Assert.fail( "connect " + SdbTestBase.coordUrl + " failed."
                    + e.getMessage() );
        }
    ...
    CollectionSpace createCS( BSONObject options ) {
        ...
        try {
            ...
            if ( e.getErrorCode() != new BaseException( "SDB_DMS_CS_NOTEXIST" )
                    .getErrorCode() ) {
                Assert.assertFalse( true, e.getMessage() );
            }
        }
        ...
        try {
            ...
            if ( enable && spendTime < inteval ) {
                ...
                Assert.assertEquals( e.getErrorCode(),
                        new BaseException( "SDB_DMS_CS_NOTEXIST" )
                                .getErrorCode(),
                        e.getMessage() );
            }
        }
    ...
    boolean isStandAlone() {
        try {
            ...
            if ( e.getErrorCode() == new BaseException( "SDB_RTN_COORD_ONLY" )
                    .getErrorCode() ) {
                return true;
            }
        }
    ...
    void testGetCLAfterDropCS( boolean enable, int inteval ) {
        ...
        try {
            ...
            Assert.assertEquals( e.getErrorCode(),
                    new BaseException( expectRes ).getErrorCode() );
        }
    }
