...
public class Transaction17765F extends SdbTestBase {

    private String clName = "transCL_17765F";
    ...
    public void setUp() {
        ...
        insertR1 = ( BSONObject ) JSON
                .parse( "{_id:'insertID17765F_1',a:3,b:3}" );
        insertR2 = ( BSONObject ) JSON
                .parse( "{_id:'insertID17765F_2',a:2,b:2}" );
        updateR1 = ( BSONObject ) JSON
                .parse( "{_id:'insertID17765F_1',a:1,b:1}" );
        updateR2 = ( BSONObject ) JSON
                .parse( "{_id:'insertID17765F_2',a:5,b:5}" );
        updateR3 = ( BSONObject ) JSON
                .parse( "{_id:'insertID17765F_1',a:4,b:4}" );
    }
    ...
    public Object[][] createIndex() {
        ...
        return new Object[][] {
                { "{'a': 1}", expPositiveReadList4, expReverseReadList4,
                        ...
                        expPositiveReadList2, new ArrayList< BSONObject >() },
                { "{'a': -1}", expPositiveReadList4, expReverseReadList4,
                        expPositiveReadList2, expReverseReadList2,
                        expPositiveReadList1, new ArrayList< BSONObject >() } };
    }
