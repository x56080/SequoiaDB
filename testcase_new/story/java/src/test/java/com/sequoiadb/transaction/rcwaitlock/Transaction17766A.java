...
/**
 * @Description seqDB-17766.java 更新并发，更新的记录同时匹配已提交记录及其他事务更新的记录，事务回滚，过程中读
 * @author luweikang
 * @date 2019年1月15日
 */
@Test(groups = "rcwaitlock")
public class Transaction17766A extends SdbTestBase {

    private String clName = "transCL_17766A";
