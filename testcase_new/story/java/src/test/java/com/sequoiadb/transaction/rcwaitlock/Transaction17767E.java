...
public class Transaction17767E extends SdbTestBase {
    private Sequoiadb sdb = null;
    private String clName = "cl_17767E";
    ...
    public void test() throws InterruptedException {
        ...
        // 事务1更新记录R1为R3,R3<R1<R2
        cl1.update( "{a:2}", "{$set:{a:1}}", hint );
        ...
        // 非事务读
        BSONObject updateR1 = ( BSONObject ) JSON.parse( "{_id:1,a:1,b:2}" );
