...
/**
 * @Dscription Test of data switch with subCL not have data
 */
public class SdbSchedule_34363 extends SdbTestBase {

    private Sequoiadb sDB;
    private Sequoiadb tDB;
    private String scheduleName = "SdbSchedule_34363_schedule";
    private String csName = "SdbSchedule_34363";
