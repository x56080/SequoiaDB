...
/**
 * @FileName seqDB-20146:回滚时产生pending object并修改pending object产生 INSERT日志
 * @Author zhaoyu
 * @Date 2019年11月1日
 */
public class Transaction20146 extends SdbTestBase {

    private String clName = "cl20146";
    ...
    public void testIdIndex() {
        ...
        try {
            ...
            for ( int i = insertNum; i < insertNum * 2; i++ ) {
                String record = "{_id:" + i + ",a:" + i + ",b:'insert20146'}";
    ...
    public void testcommonUniqueIdx() {
        Sequoiadb db = new Sequoiadb( SdbTestBase.coordUrl, "", "" );
        cl.createIndex( "idx20146", "{a:1}", true, true );
        ...
        try {
            ...
            expDataList.clear();
            for ( int i = insertNum; i < insertNum * 2; i++ ) {
                String record = "{a:" + i + ",b:'insert20146'}";
                expDataList.add( ( BSONObject ) JSON.parse( record ) );
            }
            cl.insert( expDataList );
            db.rollback();
