...
/**
 * @Description seqDB-18416:事务1加u锁后，事务2加s锁返回，事务3加u锁继续等锁
 * @author yinzhen
 * @date 2019-6-12
 *
 */
@Test(groups = { "rc", "rs" })
public class Transaction18416 extends SdbTestBase {
    private Sequoiadb sdb;
    private Sequoiadb db1;
    private Sequoiadb db2;
    private Sequoiadb db3;
    private String clName = "cl18416";
    private String idxName = "textIndex18416";
