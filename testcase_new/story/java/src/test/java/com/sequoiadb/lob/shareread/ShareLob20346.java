...
/**
 * @Description seqDB-20346 SHARED_READ|WRITE先写后读同一个lob
 * @author luweikang
 * @Date 2019.8.26
 */

public class ShareLob20346 extends SdbTestBase {

    private Sequoiadb sdb = null;
    private CollectionSpace cs = null;
    private String clName = "cl20346";
    private String mainCLName = "mainCL20346";
    private String subCLName = "subCL20346";
    ...
    public void testLob( String clName, byte[] writeLobBuff ) {
        ...
        lob.read( readLob2 );
        byte[] expData2 = Arrays.copyOfRange( lobBuff, writeSize + 1024,
                writeSize * 2 + 1024 );
        System.arraycopy( writeLobBuff, 1024, expData2, 0, writeSize - 1024 );
