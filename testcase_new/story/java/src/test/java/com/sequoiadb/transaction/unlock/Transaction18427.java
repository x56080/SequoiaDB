...
/**
 * @Description seqDB-18427: s锁升级为x后，事务提交唤醒x锁
 * @author yinzhen
 * @date 2019-6-12
 *
 */
@Test(groups = { "rs" })
public class Transaction18427 extends SdbTestBase {
    private Sequoiadb sdb;
    private Sequoiadb db1;
    private Sequoiadb db2;
    private String clName = "cl18427";
    private String idxName = "textIndex18427";
