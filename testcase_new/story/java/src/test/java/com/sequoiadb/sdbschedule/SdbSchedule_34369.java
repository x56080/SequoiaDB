...
/**
 * @Dscription Test of data switch with sub collection meta difference
 */
public class SdbSchedule_34369 extends SdbTestBase {

    private Sequoiadb sDB;
    private Sequoiadb tDB;
    private String scheduleName = "SdbSchedule_34369_schedule";
    private String csName = "SdbSchedule_34369";
    private String clName = "SdbSchedule_34369";
    ...
    public void test() {
        ...
        sDB.getCollectionSpace( csName ).getCollection( clName )
                .alterCollection( new BasicBSONObject( "Compressed", false ) );
