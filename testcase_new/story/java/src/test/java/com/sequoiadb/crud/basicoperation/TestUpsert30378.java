...
public class TestUpsert30378 extends SdbTestBase {
    private final String csName = "cs_30378";
    private final String clName = "cl_30378";
    private final String indexName = "index_30378";
    ...
    public Object[][] generateUpsertDatas() {
        ...
        // upsert( { $set: { a: { b: 1 } }, c: 1 }, { a: { b: 3 } } ); index:{
        // a: { b: 1 } }
        ...
        return new Object[][] {
                new Object[] { 1, existData1, insertData1, matcher1, index1 },
    ...
    private void test( int num, BasicBSONObject existData,
            BasicBSONObject insertData, BasicBSONObject matcher,
            BasicBSONObject index ) throws Exception {
