...
public class Transaction17823B extends SdbTestBase {
    ...
    public void setUp() {
        ...
        insertR1 = ( BSONObject ) JSON
                .parse( "{_id:'insertID17823B_1',a:2,b:2,c:2}" );
        insertR2 = ( BSONObject ) JSON
                .parse( "{_id:'insertID17823B_2',a:1,b:1,c:1}" );
        updateR1 = ( BSONObject ) JSON
                .parse( "{_id:'insertID17823B_1',a:3,b:3,c:2}" );
        updateR2 = ( BSONObject ) JSON
                .parse( "{_id:'insertID17823B_2',a:4,b:4,c:1}" );
        updateR3 = ( BSONObject ) JSON
                .parse( "{_id:'insertID17823B_1',a:6,b:6,c:2}" );
    ...
    public void test( String indexKey, List< BSONObject > expPositiveReadList1,
        ...
        try {
            ...
            // 事务1更新记录R1为R2
            cl1.update( "{a:2}", "{$inc:{a:1,b:1}}", hintTbScan );
    ...
    private class UpdateThread extends SdbThreadBase {
        ...
        public void exec() throws BaseException {
            cl2.update( null, "{'$inc': {'a': 3, 'b': 3}}", hintTbScan );
        }
    }
