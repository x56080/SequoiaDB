...
/**
 * @Description Transaction17263.java query.remove操作时，事务提交，与读并发
 * @author luweikang
 * @date 2019年1月15日
 */
@Test(groups = "ru")
public class Transaction17263 extends SdbTestBase {

    private String clName = "transCL_17263";
