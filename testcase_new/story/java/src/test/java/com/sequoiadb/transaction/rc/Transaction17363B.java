...
/**
 * @Description seqDB-17363.java 更新并发，更新的记录同时匹配已提交记录及其他事务更新的记录，更新走索引，事务回滚，过程中读
 *              R2<R1<R3
 * @author luweikang
 * @date 2019年1月15日
 */
@Test(groups = "rc")
public class Transaction17363B extends SdbTestBase {

    private String clName = "transCL_17363B";
    ...
    public void setUp() {
        ...
        insertR1 = ( BSONObject ) JSON
                .parse( "{_id:'insertID17363B_1',a:2,b:2,c:2}" );
        insertR2 = ( BSONObject ) JSON
                .parse( "{_id:'insertID17363B_2',a:1,b:1,c:1}" );
        updateR1 = ( BSONObject ) JSON
                .parse( "{_id:'insertID17363B_1',a:3,b:3,c:2}" );
        updateR2 = ( BSONObject ) JSON
                .parse( "{_id:'insertID17363B_2',a:4,b:4,c:1}" );
        updateR3 = ( BSONObject ) JSON
                .parse( "{_id:'insertID17363B_1',a:6,b:6,c:2}" );
