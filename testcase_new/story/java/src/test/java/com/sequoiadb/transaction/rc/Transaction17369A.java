...
/**
 * @FileName:seqDB-17369：删除与更新并发，删除的记录同时匹配已提交记录及其他事务更新的记录，事务回滚，过程中读 更新/删除走索引扫描,
 *                                                                  R1<R2<R3
 * @Author zhaoyu
 * @Date 2019-01-29
 * @Version 1.00
 */
@Test(groups = "rc")
public class Transaction17369A extends SdbTestBase {
    private Sequoiadb sdb = null;
    private String clName = "cl_17369A";
    ...
    public void setUp() {
        ...
        insertR1 = ( BSONObject ) JSON
                .parse( "{_id:'insertID17369A_1',a:1,b:1,c:1}" );
        insertR2 = ( BSONObject ) JSON
                .parse( "{_id:'insertID17369A_2',a:2,b:2,c:2}" );
        updateR1 = ( BSONObject ) JSON
                .parse( "{_id:'insertID17369A_1',a:2,b:2,c:1}" );
        updateR2 = ( BSONObject ) JSON
                .parse( "{_id:'insertID17369A_2',a:3,b:3,c:2}" );
    }
    ...
    public Object[][] createIndex() {
        ...
        return new Object[][] {
                { "{'a': 1}", expReadList1, expPositiveReadList2,
                        expReverseReadList2 },
                { "{'a': 1, b: 1}", expReadList1, expPositiveReadList2,
                        expReverseReadList2 },
                { "{'a': 1, b: -1}", expReadList1, expPositiveReadList2,
                        expReverseReadList2 },
                { "{'a': -1}", expReadList2, expPositiveReadList2,
                        expReverseReadList2 },
                { "{'a': -1, b: 1}", expReadList2, expPositiveReadList2,
                        expReverseReadList2 },
                { "{'a': -1, b: -1}", expReadList2, expPositiveReadList2,
                        expReverseReadList2 },
    ...
    private class UpdateThread extends SdbThreadBase {
        ...
        public void exec() throws BaseException {
            cl2.update( null, "{$inc:{a:1,b:1}}", hintIxScan );
        }
    }
}
