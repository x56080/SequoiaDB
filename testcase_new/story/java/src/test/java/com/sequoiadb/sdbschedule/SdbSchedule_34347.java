...
public class SdbSchedule_34347 extends SdbTestBase {

    private String scheduleName = "SdbSchedule_34347_schedule";
    ...
    public void test() {
        ...
        Assert.assertTrue( found,
                "Scheduled task with running_flag=3 not found within " + maxWait
                        + " seconds" );
