...
/**
 * @Dscription Test of data switch with enable interruption
 */
public class SdbSchedule_34365 extends SdbTestBase {

    private Sequoiadb sDB;
    private Sequoiadb tDB;
    private String scheduleName = "SdbSchedule_34365_schedule";
    private String csName = "SdbSchedule_34365";
