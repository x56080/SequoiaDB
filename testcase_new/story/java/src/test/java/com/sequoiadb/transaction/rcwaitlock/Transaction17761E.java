...
public class Transaction17761E extends SdbTestBase {

    private String clName = "transCL_17761E";
    ...
    public void setUp() {
        ...
        insertR1 = ( BSONObject ) JSON
                .parse( "{_id:'insertID17761E_1',a:3,b:3}" );
        insertR2 = ( BSONObject ) JSON
                .parse( "{_id:'insertID17761E_2',a:2,b:2}" );
        updateR1 = ( BSONObject ) JSON
                .parse( "{_id:'insertID17761E_1',a:1,b:1}" );
        updateR2 = ( BSONObject ) JSON
                .parse( "{_id:'insertID17761E_2',a:0,b:0}" );
    }
    ...
    public Object[][] createIndex() {
        ...
        return new Object[][] {
                { "{'a': 1}", expPositiveReadList1, expReverseReadList1,
                        ...
                        new ArrayList< BSONObject >(), expReverseReadList3 },
