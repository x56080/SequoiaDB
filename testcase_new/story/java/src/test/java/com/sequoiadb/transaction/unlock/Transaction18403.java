...
/**
 * @Description seqDB-18403: 事务1加x锁后，事务2加u锁超时，事务3加x锁继续等锁
 * @author yinzhen
 * @date 2019-6-11
 *
 */
@Test(groups = { "ru", "rc", "rs" })
public class Transaction18403 extends SdbTestBase {
    private Sequoiadb sdb;
    private Sequoiadb db1;
    private Sequoiadb db2;
    private Sequoiadb db3;
    private String clName = "cl18403";
    private String idxName = "textIndex18403";
    ...
    public void test() throws InterruptedException {
        ...
        // 待事务2等锁超时后，提交事务1，事务3返回，删除记录R1成功，再次开启事务，执行查询，检查结果
        Assert.assertFalse(
