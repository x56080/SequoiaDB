...
/**
 * @Description : Test of clean schedule with not match clean site
 */
public class SdbSchedule_34352 extends SdbTestBase {

    private Sequoiadb sDB;
    private Sequoiadb tDB;
    private String scheduleName = "SdbSchedule_34352_schedule";
    private String csName = "SdbSchedule_34352";
    private String clName = "SdbSchedule_34352";
    ...
    private String clean() {
        ...
        cleanRange.put( "clean_site", targetSite );
