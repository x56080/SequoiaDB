...
/**
 * @Description seqDB-20434
 *              只读事务与只写事务并发，只写事务覆盖：插入、更新、删除，TW1与TW3存在交集，不同时刻发起事务读，隔离级别为RR
 * @author luweikang
 * @date 2020.1.15
 */
@Test(groups = "rr")
public class Transaction20434B extends SdbTestBase {

    private String clName = "transCL_20434B";
    private String mainCLName = "mainCL_20434B";
    private String subCLName1 = "subCL_20434B_1";
    private String subCLName2 = "subCL_20434B_2";
    private String hashCLName = "hashCL_20434B";
    ...
    public void test( String clName, String indexKey ) {
        ...
        TransUtils.insertRandomDatas( clTW2, recordNum, recordNum + 1000 );
        ...
        TransUtils.insertRandomDatas( clTW1, recordNum + 1000,
                recordNum + 2000 );
        ...
        TransUtils.insertRandomDatas( clTW3, recordNum + 2000,
                recordNum + 3000 );
