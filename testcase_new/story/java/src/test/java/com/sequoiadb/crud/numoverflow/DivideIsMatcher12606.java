...
/**
 * FileName: DivideIsMatcher12606.java test content:Numeric value overflow for
 * many character using $divide operation, and the $divide is used as a matcher.
 * testlink case:seqDB-12606
 * 
 * @author luweikang
 * @Date 2017.9.13
 * @version 1.00
...
public class DivideIsMatcher12606 extends SdbTestBase {

    private String clName = "divide_matcher12606";
    ...
    public void testDivide() {
        ...
        String matcher = "{'int32':{'$divide':-1,'$et':{'$numberLong':'2147483648'}},'long':{'$divide':-1,"
                + "'$et':{'$decimal':'9223372036854775808'}},"
                + "'arr.0':{'$divide':0.1,'$et':21474836470.0},"
                + "'obj.a.b':{'$divide':-2049,'$et':{'$numberLong':'-4501401677332735'}}}";
        String[] expRecords = {
                "{'int32':-2147483648,'long':{'$numberLong':'-9223372036854775808'},"
                        + "'arr':[2147483647,{'$numberLong':'-9223372036854775808'}],"
                        + "obj:{a:{b:{'$numberLong':'9223372036854775807'}}}}" };
