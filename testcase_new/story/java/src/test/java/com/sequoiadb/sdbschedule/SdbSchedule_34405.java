...
/**
 * @Dscription Test of transfer sub collection with not met the transfer
 *             condition
 */
public class SdbSchedule_34405 extends SdbTestBase {

    private Sequoiadb sDB;
    private Sequoiadb tDB;
    private String scheduleName = "SdbSchedule_34405_schedule";
    private String csName = "SdbSchedule_34405";
    ...
    public void test() {
        ...
        Assert.assertFalse( tCS.isCollectionExist( subCLName ),
                "SubCL should not exist in datasource site" );
