...
/**
 * @FileName:seqDB-17771：删除与更新并发，删除的记录同时匹配已提交记录及其他事务更新的记录，事务提交，过程中读 索引扫描,R2<R1<
 *                                                                  R3
 * @Author zhaoyu
 * @Date 2019-01-29
 * @Version 1.00
...
public class Transaction17771C extends SdbTestBase {
    private Sequoiadb sdb = null;
    private String clName = "cl_17771C";
    ...
    public void test() {
        ...
        // 非事务读
        BSONObject updateR2 = ( BSONObject ) JSON.parse( "{_id:2,a:3,b:1}" );
