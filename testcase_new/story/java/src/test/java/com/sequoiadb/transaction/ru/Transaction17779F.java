 ...
 */
@Test(groups = "ru")
public class Transaction17779F extends SdbTestBase {
    private Sequoiadb sdb = null;
    private String clName = "cl_17779F";
    ...
    public void test() {
        ...
        // 事务1索引读
        BSONObject updateR3 = ( BSONObject ) JSON.parse( "{_id:1,a:1,b:3}" );
