...
/**
 * @Dscription Test of transfer sub collection with have lob data
 */
public class SdbSchedule_34402 extends SdbTestBase {

    private Sequoiadb sDB;
    private Sequoiadb tDB;
    private String scheduleName = "SdbSchedule_34402_schedule";
    private String csName = "SdbSchedule_34402";
