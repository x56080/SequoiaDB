 ...
 *              删除的记录同时匹配已提交记录及其他事务插入的记录，删除走索引，事务提交，过程中读 R2>R1
 * @author luweikang
 * @date 2019年1月15日
 */
@Test(groups = "rc")
public class Transaction17360B extends SdbTestBase {

    private String clName = "transCL_17360B";
    ...
    public void setUp() {
        ...
        insertR1 = ( BSONObject ) JSON
                .parse( "{_id:'insertID17360B_1',a:1,b:1,c:1}" );
        insertR2 = ( BSONObject ) JSON
                .parse( "{_id:'insertID17360B_2',a:2,b:2,c:2}" );
