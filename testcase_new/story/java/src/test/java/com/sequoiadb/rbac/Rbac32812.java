...
/**
 * @Description seqDB-32812:创建用户使用内建角色，指定为_cs name.readWrite
 * @Author liuli
 * @Date 2023.08.22
 * @UpdateAuthor liuli
 ...
 */
@Test(groups = "rbac")
public class Rbac32812 extends SdbTestBase {
    private Sequoiadb sdb = null;
    private String user = "user_32812";
    private String password = "passwd_32812";
    private String csName = "cs_32812";
    private String clName1 = "cl_32812_1";
    private String clName2 = "cl_32812_2";
