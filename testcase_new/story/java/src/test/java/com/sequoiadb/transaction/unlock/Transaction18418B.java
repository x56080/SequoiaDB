...
/**
 * @Description seqDB-18418:事务1加s锁后，事务2加x锁，事务3加x锁继续等锁
 * @author yinzhen
 * @date 2019-6-12
 *
 */
@Test(groups = { "rs" })
public class Transaction18418B extends SdbTestBase {
    private Sequoiadb sdb;
    private Sequoiadb db1;
    private Sequoiadb db2;
    private Sequoiadb db3;
    private String clName = "cl18418b";
    private String idxName = "textIndex18418";
