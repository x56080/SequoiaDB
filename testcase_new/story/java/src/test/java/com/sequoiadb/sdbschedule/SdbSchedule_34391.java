...
/**
 * @Dscription Test of transfer sub collection with change range
 */
public class SdbSchedule_34391 extends SdbTestBase {

    private Sequoiadb sDB;
    private Sequoiadb tDB;
    private String scheduleName = "SdbSchedule_34391_schedule";
    private String csName = "SdbSchedule_34391";
