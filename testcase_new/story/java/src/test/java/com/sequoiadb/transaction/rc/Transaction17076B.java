...
@Test(groups = "rc")
public class Transaction17076B extends SdbTestBase {
    private String clName = "cl_17076B";
    ...
    public void test() {
        ...
        // 非事务索引扫描记录
        TransUtils.queryAndCheck( cl, "{'':'_id'}", expList );
        ...
        // 事务2索引扫描记录
        TransUtils.queryAndCheck( cl2, "{'':'_id'}", expList );
