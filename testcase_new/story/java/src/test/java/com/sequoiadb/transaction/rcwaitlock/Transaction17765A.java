...
public class Transaction17765A extends SdbTestBase {

    private String clName = "transCL_17765A";
    ...
    public void setUp() {
        ...
        insertR1 = ( BSONObject ) JSON
                .parse( "{_id:'insertID17765A_1',a:1,b:1}" );
        insertR2 = ( BSONObject ) JSON
                .parse( "{_id:'insertID17765A_2',a:2,b:2}" );
        updateR1 = ( BSONObject ) JSON
                .parse( "{_id:'insertID17765A_1',a:3,b:3}" );
        updateR2 = ( BSONObject ) JSON
                .parse( "{_id:'insertID17765A_2',a:4,b:4}" );
        updateR3 = ( BSONObject ) JSON
                .parse( "{_id:'insertID17765A_1',a:5,b:5}" );
    }
