...
/**
 * @testcase seqDB-17184:select for update与读并发，同时与更新并发
 * @date 2019-1-22
 * @author yinzhen
 *
 */
@Test(groups = "rcwaitlock")
public class Transaction17184 extends SdbTestBase {
    private Sequoiadb sdb = null;
    private String clName = "cl17184";
    ...
    public void setUp() {
        ...
        cl.createIndex( "textIndex17184", "{a:1}", false, false );
    ...
    public void test() {
        ...
        // 事务2 select for update 读记录走索引扫描
        recordsCursor = cl2.query( "{a:{$exists:1}}", null, null,
                "{'':'textIndex17184'}", DBQuery.FLG_QUERY_FOR_UPDATE );
        actList = TransUtils.getReadActList( recordsCursor );
        Assert.assertEquals( actList, expList );
