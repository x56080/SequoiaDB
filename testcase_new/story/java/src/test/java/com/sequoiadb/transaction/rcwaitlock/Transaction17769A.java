...
/**
 * @FileName:seqDB-17769：删除并发，删除的记录同时匹配已提交记录及其他事务删除的记录，事务提交，过程中读 索引扫描，R1<R2
 * @Author zhaoyu
 * @Date 2019-01-29
 * @Version 1.00
 */
@Test(groups = "rcwaitlock")
public class Transaction17769A extends SdbTestBase {
    private Sequoiadb sdb = null;
    private String clName = "cl_17769A";
