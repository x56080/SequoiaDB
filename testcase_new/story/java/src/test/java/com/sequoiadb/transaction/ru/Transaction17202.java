...
/**
 * @testcase seqDB-17202:插入相同的记录与读并发,事务提交
 * @date 2019-1-16
 * @author yinzhen
 *
 */
@Test(groups = "ru")
public class Transaction17202 extends SdbTestBase {
    private Sequoiadb sdb = null;
    private String clName = "cl17202";
    ...
    public void setUp() {
        ...
        cl.createIndex( "textIndex17202", "{a:1}", false, false );
