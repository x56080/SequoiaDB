 ...
 */
@Test(groups = "rr")
public class Transaction20429B extends SdbTestBase {

    private String clName = "transCL_20429B";
    private String mainCLName = "mainCL_20429B";
    private String subCLName1 = "subCL_20429B_1";
    private String subCLName2 = "subCL_20429B_2";
    private String hashCLName = "hashCL_20429B";
    ...
    public void test( String clName, String indexKey ) {
        ...
        // 8 TW3 insert R5s
        TransUtils.insertRandomDatas( clTW3, recordNum, recordNum + 1000 );
        ...
        TransUtils.queryAndCheck( clTR1, "{'_id': 1}", "{'': 'a'}",
                expDataList );
        TransUtils.queryAndCheck( clTR2, "{'_id': 1}", "{'': null}",
                expDataList );
        TransUtils.queryAndCheck( clTR2, "{'_id': 1}", "{'': 'a'}",
                expDataList );
        TransUtils.queryAndCheck( clTR3, "{'_id': 1}", "{'': null}",
                expDataList );
        TransUtils.queryAndCheck( clTR3, "{'_id': 1}", "{'': 'a'}",
                expDataList );
        TransUtils.queryAndCheck( clTR4, "{'_id': 1}", "{'': null}",
                expDataList );
        TransUtils.queryAndCheck( clTR4, "{'_id': 1}", "{'': 'a'}",
                expDataList );
        TransUtils.queryAndCheck( clTR5, "{'_id': 1}", "{'': null}",
                expDataList );
        TransUtils.queryAndCheck( clTR5, "{'_id': 1}", "{'': 'a'}",
                expDataList );
        ...
        TransUtils.queryAndCheck( clTR4, "{'a': {'$gte': 0, '$lt': 4000}}",
                "{'_id': 1}", "{'': 'a'}", expDataList );
        TransUtils.queryAndCheck( clTR5, "{'a': {'$gte': 0, '$lt': 4000}}",
                "{'_id': 1}", "{'': null}", expDataList );
        TransUtils.queryAndCheck( clTR5, "{'a': {'$gte': 0, '$lt': 4000}}",
                "{'_id': 1}", "{'': 'a'}", expDataList );
        ...
        TransUtils.queryAndCheck( clTR6, "{'a': {'$gte': 0, '$lt': 5000}}",
                "{'_id': 1}", "{'': 'a'}", expDataList );
        TransUtils.queryAndCheck( clTR7, "{'a': {'$gte': 0, '$lt': 5000}}",
                "{'_id': 1}", "{'': null}", expDataList );
        TransUtils.queryAndCheck( clTR7, "{'a': {'$gte': 0, '$lt': 5000}}",
                "{'_id': 1}", "{'': 'a'}", expDataList );
