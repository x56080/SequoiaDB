 ...
 *              插入与更新并发，更新的记录同时匹配已提交记录及其他事务插入的记录，更新走索引，事务提交，过程中读 R1<R3<R2
 * @author luweikang
 * @date 2019年1月15日
 */
@Test(groups = "rcwaitlock")
public class Transaction17761B extends SdbTestBase {

    private String clName = "transCL_17761B";
    ...
    public void setUp() {
        ...
        insertR1 = ( BSONObject ) JSON
                .parse( "{_id:'insertID17761B_1',a:1,b:1}" );
        insertR2 = ( BSONObject ) JSON
                .parse( "{_id:'insertID17761B_2',a:3,b:3}" );
        updateR1 = ( BSONObject ) JSON
                .parse( "{_id:'insertID17761B_1',a:2,b:2}" );
        updateR2 = ( BSONObject ) JSON
                .parse( "{_id:'insertID17761B_2',a:4,b:4}" );
    }
    ...
    public Object[][] createIndex() {
        ...
        expPositiveReadList4.add( insertR1 );
        ...
        expReverseReadList4.add( insertR1 );
        ...
        return new Object[][] {
                ...
                { "{'a': -1}", expPositiveReadList4, expReverseReadList4,
                        expPositiveReadList2, expReverseReadList2,
                        expPositiveReadList3, expReverseReadList3 } };
    }
