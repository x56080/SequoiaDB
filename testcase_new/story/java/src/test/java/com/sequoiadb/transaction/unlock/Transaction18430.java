...
/**
 * @Description seqDB-18430: s锁升级为u后，事务提交/回滚唤醒u锁
 * @author yinzhen
 * @date 2019-6-12
 *
 */
@Test(groups = { "rs" })
public class Transaction18430 extends SdbTestBase {
    private Sequoiadb sdb;
    private Sequoiadb db1;
    private Sequoiadb db2;
    private String clName = "cl18430";
    private String idxName = "textIndex18430";
    ...
    public void test() throws InterruptedException {
        ...
        th1.start();
        Assert.assertTrue( th1.matchBlockingMethod( DBCursor.class.getName(),
                "hasNext" ) );

        // 提交事务2，检查结果
        db2.commit();
        Assert.assertTrue( th1.isSuccess(), th1.getErrorMsg() );
        actList = ( List< BSONObject > ) th1.getExecResult();
        Assert.assertTrue(
                actList.size() == 1 && record.equals( actList.get( 0 ) ),
                "actList: " + actList );
