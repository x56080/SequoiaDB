 ...
 */
@Test(groups = "rc")
public class Transaction17358F extends SdbTestBase {

    private String clName = "transCL_17358F";
    ...
    public void setUp() {
        ...
        insertR1 = ( BSONObject ) JSON
                .parse( "{_id:'insertID17358F_1',a:3,b:3,c:3}" );
        insertR2 = ( BSONObject ) JSON
                .parse( "{_id:'insertID17358F_2',a:2,b:2,c:2}" );
        updateR1 = ( BSONObject ) JSON
                .parse( "{_id:'insertID17358F_1',a:1,b:1,c:3}" );
        updateR2 = ( BSONObject ) JSON
                .parse( "{_id:'insertID17358F_2',a:0,b:0,c:2}" );
