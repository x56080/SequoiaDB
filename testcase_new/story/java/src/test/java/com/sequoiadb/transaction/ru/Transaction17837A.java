...
/**
 * @FileName:seqDB-17837:删除并发，删除的记录同时匹配已提交记录及其他事务删除的记录，删除操作走索引，事务提交，过程中读 删除走索引扫描
 *                                                                       R1<R2
 * @Author zhaoyu
 * @Date 2019-01-29
 * @Version 1.00
 */
@Test(groups = "ru")
public class Transaction17837A extends SdbTestBase {
    private Sequoiadb sdb = null;
    private String clName = "cl_17837A";
