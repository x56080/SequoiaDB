 ...
 * @Date 2019.05.10
 */
public class Fulltext15843B extends FullTestBase {
    ...
    protected void caseInit() throws Exception {
        ...
        // 这里插入少量数据，意图是构造ES已执行完全量同步，并在同步固定集合中的记录的过程中，同时删除全文索引和执行增删改
