...
/**
 * @Dscription Test of data switch empty collection
 */
public class SdbSchedule_34359 extends SdbTestBase {

    private Sequoiadb sDB;
    private Sequoiadb tDB;
    private String scheduleName = "SdbSchedule_34359_schedule";
    private String csName = "SdbSchedule_34359";
    private String clName = "SdbSchedule_34359";
    ...
    private void checkProgress( String id ) {
        ...
        for ( Object obj : taskList ) {
            ...
            for ( Object o : progressList ) {
                ...
                Boolean canDataSwitch = ( Boolean ) progress
                        .get( "can_data_switch" );
                Boolean dataSwitched = ( Boolean ) progress
                        .get( "data_switched" );
                if ( canDataSwitch && dataSwitched ) {
                    switched = true;
                    break;
                }
            }
        ...
        Assert.assertTrue( switched,
                "Data switch progress did not occur as expected" );
    }
}