...
public class SdbSchedule_34398 extends SdbTestBase {

    private Sequoiadb sDB;
    private Sequoiadb tDB;
    private String scheduleName = "SdbSchedule_34398_schedule";
    private String csName = "SdbSchedule_34398";
    private String clName = "SdbSchedule_34398";
    private String sourceSite = "rootsite";
    private String targetSite;
    private DBCollection sCL;
    private int lobCount = 10;
    private ObjectId truncateLobId;
    ...
    public void setUp() {
        ...
        for ( int i = 0; i < lobCount; i++ ) {
            ...
            String content = "This is a test lob content for SdbSchedule_34398 "
                    + i;
            lob.write( content.getBytes() );
            lob.close();
            if ( truncateLobId == null ) {
                truncateLobId = lob.getID();
            }
        }
    }
