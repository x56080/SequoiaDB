...
/**
 * @Description seqDB-20351 SHARED_READ和SHARED_READ|WRITE并发
 * @author luweikang
 * @Date 2019.8.26
 */

public class ShareLob20351B extends SdbTestBase {

    private Sequoiadb sdb = null;
    private Sequoiadb db1 = null;
    private Sequoiadb db2 = null;
    private CollectionSpace cs = null;
    private String clName = "cl20351B";
    private String mainCLName = "mainCL20351B";
    private String subCLName = "subCL20351B";
