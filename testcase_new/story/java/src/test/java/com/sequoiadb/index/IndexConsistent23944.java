...
/**
 * @description seqDB-23944:并发创建索引和删除子表所在cs()
 * @author wuyan
 * @date 2021.4.8
 * @version 1.10
 */

public class IndexConsistent23944 extends SdbTestBase {
    private boolean runSuccess = false;
    private Sequoiadb sdb = null;
    private CollectionSpace cs1;
    private CollectionSpace cs2;
    private String subcsName = "cs_23944";
    private String mainclName = "maincl_23944";
    private String subclName1 = "subcl_23944a";
    private String subclName2 = "subcl_23944b";
    ...
    public void setUp() {
        ...
        cs1 = sdb.createCollectionSpace( subcsName );
        cs2 = sdb.getCollectionSpace( SdbTestBase.csName );
        DBCollection dbcl = createAndAttachCL( cs1, cs2, mainclName, subclName1,
                subclName2 );
    ...
    public void test() throws Exception {
        String indexName = "testindex23944";
    ...
    private DBCollection createAndAttachCL( CollectionSpace cs1,
        ...
        DBCollection mainCL = cs2.createCollection( mainclName, optionsM );
