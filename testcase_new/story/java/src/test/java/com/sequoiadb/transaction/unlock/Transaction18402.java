...
/**
 * @Description seqDB-18402: 事务1加x锁后，事务2加u锁超时，事务3加u锁继续等锁
 * @author yinzhen
 * @date 2019-6-11
 *
 */
@Test(groups = { "ru", "rc", "rs" })
public class Transaction18402 extends SdbTestBase {
    private Sequoiadb sdb;
    private Sequoiadb db1;
    private Sequoiadb db2;
    private Sequoiadb db3;
    private String clName = "cl18402";
    private String idxName = "textIndex18402";
