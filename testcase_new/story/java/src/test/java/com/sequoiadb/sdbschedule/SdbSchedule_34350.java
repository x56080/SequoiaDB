...
/**
 * @Description : Test of clean schedule have more clean range
 */
public class SdbSchedule_34350 extends SdbTestBase {

    private Sequoiadb sDB;
    private Sequoiadb tDB;
    private String scheduleName = "SdbSchedule_34350_schedule";
    private String csName = "SdbSchedule_34350";
    private String clName = "SdbSchedule_34350";
    ...
    private String clean() {
        ...
        BSONObject cleanRange1 = new BasicBSONObject();
        cleanRange1.put( "max_retention_days", 30 );
        cleanRange1.put( "clean_site", null );
        cleanRange1.put( "clean_site_regex", ".*" );
        BasicBSONList clList = new BasicBSONList();
        clList.add( csName + "." + clName );
        cleanRange1.put( "cl_list", clList );
        cleanRange1.put( "cs_list", new BasicBSONList() );
        cleanRange1.put( "cs_regex", null );
        cleanRange1.put( "cl_regex", null );

        BSONObject cleanRange2 = new BasicBSONObject();
        cleanRange2.put( "max_retention_days", 0 );
        cleanRange2.put( "clean_site", null );
        cleanRange2.put( "clean_site_regex", ".*" );
        cleanRange2.put( "cl_list", clList );
        cleanRange2.put( "cs_list", new BasicBSONList() );
        cleanRange2.put( "cs_regex", null );
        cleanRange2.put( "cl_regex", null );

        BasicBSONList cleanRangeList = new BasicBSONList();
        cleanRangeList.add( cleanRange1 );
        cleanRangeList.add( cleanRange2 );
