 ...
 */
@Test(groups = { "rc", "rr" })
public class Transaction17361A extends SdbTestBase {

    private String clName = "transCL_17361A";
    ...
    public void setUp() {
        ...
        insertR1 = ( BSONObject ) JSON
                .parse( "{_id:'insertID17361A_1',a:2,b:2,c:2}" );
        insertR2 = ( BSONObject ) JSON
                .parse( "{_id:'insertID17361A_2',a:1,b:1,c:1}" );
