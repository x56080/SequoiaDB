 ...
 */
@Test(groups = "rc")
public class Transaction17358D extends SdbTestBase {

    private String clName = "transCL_17358D";
    ...
    public void setUp() {
        ...
        insertR1 = ( BSONObject ) JSON
                .parse( "{_id:'insertID17358D_1',a:2,b:2,c:2}" );
        insertR2 = ( BSONObject ) JSON
                .parse( "{_id:'insertID17358D_2',a:1,b:1,c:1}" );
        updateR1 = ( BSONObject ) JSON
                .parse( "{_id:'insertID17358D_1',a:4,b:4,c:2}" );
        updateR2 = ( BSONObject ) JSON
                .parse( "{_id:'insertID17358D_2',a:3,b:3,c:1}" );
