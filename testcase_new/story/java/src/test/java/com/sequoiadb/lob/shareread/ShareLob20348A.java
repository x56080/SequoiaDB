...
/**
 * @Description seqDB-20348A READ和SHARED_READ|WRITE并发
 * @author luweikang
 * @Date 2019.8.26
 */

public class ShareLob20348A extends SdbTestBase {

    private Sequoiadb sdb = null;
    private Sequoiadb db1 = null;
    private Sequoiadb db2 = null;
    private CollectionSpace cs = null;
    private String clName = "cl20348A";
    private String mainCLName = "mainCL20348A";
    private String subCLName = "subCL20348A";
    ...
    public void testLob( String clName, byte[] writeLobBuff ) {
        ...
        WriteThread write = new WriteThread( cl2, id,
