...
public class Transaction17770A extends SdbTestBase {
    private Sequoiadb sdb = null;
    private String clName = "cl_17770A";
    ...
    public void setUp() {
        ...
        insertR1 = ( BSONObject ) JSON
                .parse( "{_id:'insertID17770A_1',a:1,b:1}" );
        insertR2 = ( BSONObject ) JSON
                .parse( "{_id:'insertID17770A_2',a:2,b:2}" );
    }
