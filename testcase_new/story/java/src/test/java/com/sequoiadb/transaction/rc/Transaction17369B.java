 ...
 */
@Test(groups = "rc")
public class Transaction17369B extends SdbTestBase {
    private Sequoiadb sdb = null;
    private String clName = "cl_17369B";
    ...
    public void setUp() {
        ...
        insertR1 = ( BSONObject ) JSON
                .parse( "{_id:'insertID17369B_1',a:3,b:3,c:3}" );
        insertR2 = ( BSONObject ) JSON
                .parse( "{_id:'insertID17369B_2',a:2,b:2,c:2}" );
        updateR1 = ( BSONObject ) JSON
                .parse( "{_id:'insertID17369B_1',a:1,b:1,c:3}" );
        updateR2 = ( BSONObject ) JSON
                .parse( "{_id:'insertID17369B_2',a:0,b:0,c:2}" );
    }
