...
/**
 * @FileName: seqDB-17096:更新并发，匹配更新前记录，事务提交，过程中读 更新走索引扫描
 * @Author zhaoyu
 * @Date 2019-01-23
 * @Version 1.00
 */
@Test(groups = "rc")
public class Transaction17096 extends SdbTestBase {
    ...
    private int updateValue1 = 10000;
    private int updateValue2 = 20000;
    private String hashCLName = "cl17096_hash";
    private String mainCLName = "cl17096_main";
    private String subCLName1 = "subcl17096_1";
    private String subCLName2 = "subcl17096_2";
    ...
    public void test( String indexKey, String clName )
        ...
        try {
            ...
            TransUtils.queryAndCheck(
                    cl2, "{a:{$lt:" + ( stopId + updateValue2 ) + ",$gte:"
                            + startId + "}}",
