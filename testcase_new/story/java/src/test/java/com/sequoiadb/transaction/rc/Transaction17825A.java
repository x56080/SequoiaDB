 ...
 */
@Test(groups = "rc")
public class Transaction17825A extends SdbTestBase {
    private Sequoiadb sdb = null;
    private String clName = "cl_17825A";
    ...
    public void setUp() {
        ...
        insertR1 = ( BSONObject ) JSON
                .parse( "{_id:'insertID17825A_1',a:1,b:1,c:1}" );
        insertR2 = ( BSONObject ) JSON
                .parse( "{_id:'insertID17825A_2',a:2,b:2,c:2}" );
    }
