...
/**
 * @Description seqDB-18408:事务1加x锁后，事务2加x锁超时，事务3加s锁立即返回
 * @author yinzhen
 * @date 2019-6-11
 *
 */
@Test(groups = { "rs" })
public class Transaction18408B extends SdbTestBase {
    private Sequoiadb sdb;
    private Sequoiadb db1;
    private Sequoiadb db2;
    private Sequoiadb db3;
    private String clName = "cl18408b";
    private String idxName = "textIndex18408";
