 ...
 *             enable "delete_more_lob_in_target" option
 */
public class SdbSchedule_34381 extends SdbTestBase {

    private Sequoiadb sDB;
    private Sequoiadb tDB;
    private String scheduleName = "SdbSchedule_34381_schedule";
    private String csName = "SdbSchedule_34381";
    private String clName = "SdbSchedule_34381";
    private String sourceSite = "rootsite";
    private String targetSite;
    private DBCollection sCL;
    private int lobCount = 10;
    private static List< ObjectId > removeLobIds = new ArrayList<>();
    ...
    public void setUp() {
        ...
        for ( int i = 0; i < lobCount; i++ ) {
            ...
            String content = "This is a test lob content for SdbSchedule_34381 "
                    + i;
    ...
    public void test() throws Exception {
        ...
        content.put( "delete_more_lob_in_target", true );
        ...
        try ( DBCursor cursor = tCL.listLobs(
            ...
            Assert.assertEquals( count, 0,
                    "Lobs that were deleted in source collection still exist in target collection" );
