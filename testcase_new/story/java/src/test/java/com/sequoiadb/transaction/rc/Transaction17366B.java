...
/**
 * @FileName:seqDB-17366：删除并发，删除的记录同时匹配已提交记录及其他事务删除的记录，事务提交，过程中读 删除走索引扫描，R1>R2
 * @Author zhaoyu
 * @Date 2019-01-29
 * @Version 1.00
 */
@Test(groups = "rc")
public class Transaction17366B extends SdbTestBase {
    private Sequoiadb sdb = null;
    private String clName = "cl_17366B";
    ...
    public void setUp() {
        ...
        insertR1 = ( BSONObject ) JSON
                .parse( "{_id:'insertID17366B_1',a:2,b:2,c:2}" );
        insertR2 = ( BSONObject ) JSON
                .parse( "{_id:'insertID17366B_2',a:1,b:1,c:1}" );
    }
