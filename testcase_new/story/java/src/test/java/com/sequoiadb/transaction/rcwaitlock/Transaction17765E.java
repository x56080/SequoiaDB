...
public class Transaction17765E extends SdbTestBase {

    private String clName = "transCL_17765E";
    ...
    public void setUp() {
        ...
        insertR1 = ( BSONObject ) JSON
                .parse( "{_id:'insertID17765E_1',a:3,b:3}" );
        insertR2 = ( BSONObject ) JSON
                .parse( "{_id:'insertID17765E_2',a:1,b:1}" );
        updateR1 = ( BSONObject ) JSON
                .parse( "{_id:'insertID17765E_1',a:2,b:2}" );
        updateR2 = ( BSONObject ) JSON
                .parse( "{_id:'insertID17765E_2',a:4,b:4}" );
        updateR3 = ( BSONObject ) JSON
                .parse( "{_id:'insertID17765E_1',a:5,b:5}" );
    }
    ...
    public Object[][] createIndex() {
        ...
        return new Object[][] {
                ...
                { "{'a': -1}", expPositiveReadList4, expReverseReadList4,
                        expPositiveReadList2, expReverseReadList2,
                        expPositiveReadList5, new ArrayList< BSONObject >() } };
    }
