...
/**
 * @FileName:seqDB-17755:更新并发，匹配更新前记录，事务回滚，过程中读 索引扫描
 * @Author zhaoyu
 * @Date 2019-01-29
 * @Version 1.00
 */
@Test(groups = "rcwaitlock")
public class Transaction17755B extends SdbTestBase {
    private Sequoiadb sdb = null;
    private String clName = "cl_17755B";
