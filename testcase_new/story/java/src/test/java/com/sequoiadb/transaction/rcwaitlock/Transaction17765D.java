...
public class Transaction17765D extends SdbTestBase {

    private String clName = "transCL_17765D";
    ...
    public void setUp() {
        ...
        insertR1 = ( BSONObject ) JSON
                .parse( "{_id:'insertID17765D_1',a:2,b:2}" );
        insertR2 = ( BSONObject ) JSON
                .parse( "{_id:'insertID17765D_2',a:1,b:1}" );
        updateR1 = ( BSONObject ) JSON
                .parse( "{_id:'insertID17765D_1',a:3,b:3}" );
        updateR2 = ( BSONObject ) JSON
                .parse( "{_id:'insertID17765D_2',a:4,b:4}" );
        updateR3 = ( BSONObject ) JSON
                .parse( "{_id:'insertID17765D_1',a:6,b:6}" );
    }
