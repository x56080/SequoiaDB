...
/**
 * @Description seqDB-17359.java
 *              插入与更新并发，更新的记录同时匹配已提交记录及其他事务插入的记录，更新走索引，事务回滚，过程中读 R3>R1>R2
 * @author luweikang
 * @date 2019年1月15日
 */
@Test(groups = "rc")
public class Transaction17359B extends SdbTestBase {

    private String clName = "transCL_17359B";
    ...
    BSONObject insertR1 = new BasicBSONObject();
    BSONObject insertR2 = new BasicBSONObject();
    BSONObject updateR1 = new BasicBSONObject();
    BSONObject updateR2 = new BasicBSONObject();
    ...
    public void setUp() {
        ...
        insertR1 = ( BSONObject ) JSON
                .parse( "{_id:'insertID17359B_1',a:2,b:2,c:2}" );
        insertR2 = ( BSONObject ) JSON
                .parse( "{_id:'insertID17359B_2',a:1,b:1,c:1}" );
        updateR1 = ( BSONObject ) JSON
                .parse( "{_id:'insertID17359B_1',a:4,b:4,c:2}" );
        updateR2 = ( BSONObject ) JSON
                .parse( "{_id:'insertID17359B_2',a:3,b:3,c:1}" );
    ...
    public Object[][] createIndex() {
        ...
        return new Object[][] {
                { "{'a': 1}", expPositiveReadList1, expReverseReadList1,
                        expPositiveReadList2, expPositiveReadList2 },
