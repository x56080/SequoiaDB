...
/**
 * @FileName:seqDB-17836：更新与删除并发， 删除的记录同时匹配已提交记录及其他事务更新的记录，更新/删除走表扫描，事务提交，过程中读
 *                                先插入R1再插入R2
 * @Author zhaoyu
 * @Date 2019-01-29
 * @Version 1.00
 */
@Test(groups = "ru")
public class Transaction17836A extends SdbTestBase {
    private Sequoiadb sdb = null;
    private String clName = "cl_17836A";
    ...
    public void test() {
        ...
        // 事务1索引读
        BSONObject updateR3 = ( BSONObject ) JSON.parse( "{_id:1,a:3,b:1}" );
