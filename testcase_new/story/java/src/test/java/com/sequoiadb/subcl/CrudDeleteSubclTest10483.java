...
public class CrudDeleteSubclTest10483 extends SdbTestBase {
    ...
    private String[] subclNames = { "maincl_10483_subcl_0",
            "maincl_10483_subcl_1", "maincl_10483_subcl_2" };
    ...
    public void test() {
        ...
        try {
            ...
            Assert.assertEquals( deleteSubcl.isSuccess(), true,
                    deleteSubcl.getErrorMsg() );
        } catch ( BaseException e ) {
    ...
    private void createCL() {
        ...
        try {
            ...
            subcls[ 2 ] = cs.createCollection( subclNames[ 2 ],
                    ( BSONObject ) JSON.parse( subclOptions[ 2 ] ) );
            ...
            maincl.attachCollection( SdbTestBase.csName + "." + subclNames[ 2 ],
                    ( BSONObject ) JSON
            ...
            subcls[ 2 ].split( replicaGroupNames.get( 0 ),
                    replicaGroupNames.get( 1 ),
                    ( BSONObject ) JSON.parse( "{a:250}" ),
    ...
    class DeleteSubcl extends SdbThreadBase {
        ...
        public void exec() throws Exception {
            sdb_other.getCollectionSpace( csName )
                    .dropCollection( subclNames[ 2 ] );
        }
    }
