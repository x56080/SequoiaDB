 ...
 */
@Test(groups = "rc")
public class Transaction17364C extends SdbTestBase {
    private Sequoiadb sdb = null;
    private String clName = "cl_17364C";
    ...
    public void setUp() {
        ...
        insertR1 = ( BSONObject ) JSON
                .parse( "{_id:'insertID17364C_1',a:2,b:2,c:2}" );
        insertR2 = ( BSONObject ) JSON
                .parse( "{_id:'insertID17364C_2',a:3,b:3,c:3}" );
        updateR1 = ( BSONObject ) JSON
                .parse( "{_id:'insertID17364C_1',a:1,b:1,c:2}" );
    ...
    public void test( String indexKey, List< BSONObject > expPositiveReadList1,
        ...
        try {
            ...
            cl1.update( "{a:2}", "{$set:{a:1,b:1}}", hintIxScan );
