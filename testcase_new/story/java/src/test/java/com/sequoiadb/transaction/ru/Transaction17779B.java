 ...
 */
@Test(groups = "ru")
public class Transaction17779B extends SdbTestBase {
    private Sequoiadb sdb = null;
    private String clName = "cl_17779B";
    ...
    public void test() {
        ...
        // 事务1索引读
        BSONObject updateR3 = ( BSONObject ) JSON.parse( "{_id:1,a:2,b:1}" );
