...
public class SplitHash11558C extends SdbTestBase {
    private Sequoiadb sdb;
    private String srcRg;
    private String dstRg;
    private CollectionSpace cs;
    private final static String CL_NAME_BASE = "cl_hash_11558_C";
    ...
    private void test() throws Exception {
        for (int i = 0; i < invalidDataArr.size(); i++) {
            ...
            // percent split
            ThreadExecutor es = new ThreadExecutor(900000);// 15 min
            es.addWorker(
