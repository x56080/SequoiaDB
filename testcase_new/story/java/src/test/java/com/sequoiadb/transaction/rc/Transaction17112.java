...
/**
 * @testcase seqDB-17112:读与select for update并发，同时与更新并发
 * @date 2019-1-25
 * @author yinzhen
 *
 */
@Test(groups = "rc")
public class Transaction17112 extends SdbTestBase {
    private Sequoiadb sdb = null;
    private String clName = "cl17112";
    ...
    public void test( String indexKey ) throws InterruptedException {
        try {
            ...
            // 事务1 select for update读记录走逆序表扫描
            ...
            // 事务1 select for update读记录走逆序索引扫描
