...
@Test(groups = "ru")
public class Transaction17231C extends SdbTestBase {
    private String clName = "cl_17231C";
    ...
    public void setUp() {
        ...
        BSONObject insertR1 = ( BSONObject ) JSON.parse( "{_id:1, b:1, c:1}" );
        cl.insert( insertR1 );
    }
