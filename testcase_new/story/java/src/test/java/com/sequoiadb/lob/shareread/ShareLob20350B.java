...
public class ShareLob20350B extends SdbTestBase {

    private Sequoiadb sdb = null;
    private Sequoiadb db1 = null;
    private Sequoiadb db2 = null;
    private CollectionSpace cs = null;
    private String clName = "cl20350B";
    private String mainCLName = "mainCL20350B";
    private String subCLName = "subCL20350B";
    ...
    public void testLob( String clName, byte[] writeLobBuff ) {
        ...
        ReadThread read = new ReadThread( cl1, id,
                DBLob.SDB_LOB_SHAREREAD | DBLob.SDB_LOB_WRITE, writeSize / 2,
                writeSize );
