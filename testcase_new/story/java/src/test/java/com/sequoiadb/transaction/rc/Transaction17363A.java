 ...
 */
@Test(groups = "rc")
public class Transaction17363A extends SdbTestBase {

    private String clName = "transCL_17363A";
    ...
    public void setUp() {
        ...
        insertR1 = ( BSONObject ) JSON
                .parse( "{_id:'insertID17363A_1',a:1,b:1,c:1}" );
        insertR2 = ( BSONObject ) JSON
                .parse( "{_id:'insertID17363A_2',a:2,b:2,c:2}" );
        updateR1 = ( BSONObject ) JSON
                .parse( "{_id:'insertID17363A_1',a:3,b:3,c:1}" );
        updateR2 = ( BSONObject ) JSON
                .parse( "{_id:'insertID17363A_2',a:4,b:4,c:2}" );
        updateR3 = ( BSONObject ) JSON
                .parse( "{_id:'insertID17363A_1',a:5,b:5,c:1}" );
