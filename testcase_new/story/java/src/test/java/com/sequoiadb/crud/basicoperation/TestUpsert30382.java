...
public class TestUpsert30382 extends SdbTestBase {
    private final String csName = "cs_30382";
    private final String clName = "cl_30382";
    private final String indexName = "index_30382";
    ...
    public Object[][] generateUpsertDatas() {
        ...
        // upsert( { $set: { a: 1, b: 1, c: 1 }, { a: { b: 1 } } ); index:{ a: {
        // b: 1 } }
        ...
        // upsert( { $set: {a: { b: 1 } }, { a: { b: { c: 1 } } } ); index:{ a:
        // { b: { c: 1 } } }
