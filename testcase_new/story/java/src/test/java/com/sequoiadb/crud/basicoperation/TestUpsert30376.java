...
public class TestUpsert30376 extends SdbTestBase {
    private final String csName = "cs_30376";
    private final String clName = "cl_30376";
    private final String indexName = "index_30376";
    ...
    public Object[][] generateUpsertDatas() {
        ...
        // upsert( { $set: { a: 2, b:2, c: 2 } }, { a: 1, b: 1 } ); index:{ a:
        // 1, b: 1 }
        ...
        // upsert( { $set: { a: 2, b: 2, c: 3 }, { a: 2, b: 2, c: 2 } ); index:{
        // a: 1, b: 1 }
        ...
        // upsert( { $set: { a: { b: 2 }, c: 1 }, { a: { b: 1 } } ); index:{ a:
        // { b: 1 } }
        ...
        // upsert( { $set: { a: 1, c: 1, d: 1 }, { a: { b: 1 }, c: 1 } );
        // index:{ a: { b: 1 } }
        ...
        return new Object[][] {
                new Object[] { 1, insertData1, matcher1, index1 },
    ...
    private void test( int num, BasicBSONObject insertData,
            BasicBSONObject matcher, BasicBSONObject index ) throws Exception {
