...
/**
 * FileName: UpsertUseInc12614.java test content:Numeric value overflow for
 * single character using $inc operation, and insert different data Type.
 * testlink case:seqDB-12614
 * 
 * @author luweikang
 * @Date 2017.9.15
 * @version 1.00
...
public class UpsertUseInc12614 extends SdbTestBase {
    ...
    public Object[][] generateDatas() {
        ...
        return new Object[][] {
                ...
                new Object[] { 0, "no", new Long( 9223372034707292161L ),
                        new Long( 2147483647 ), expRecords1, expDecimalType,
                        true, expDecimalTypeToJava },
                // obj: no.a inc -1,the result is -2147483647(int64)
                new Object[] { 1, "no.a", new Integer( -5 ),
                        new Integer( -2147483647 ), expRecords2, expLongType,
                        false, expLongTypeToJava },
                // -9223372036854775808 inc -1,the result is
                // {'$decimal':'-9223372036854775809'}
                new Object[] { 2, "no.a.b.c", new Long( 4 ),
    ...
    public Object[][] generateDatas1() {
        ...
        return new Object[][] {
                ...
                // array
                new Object[] { 10, matcher, "no.0", new Integer( 2147483647 ),
                        expRecords },
                // obj.arr
                new Object[] { 11, matcher1, "no.a.0",
                        new Long( -9223372036854775800L ), expRecords1 },
                // arr.obj
                new Object[] { 12, matcher2, "no.1.a", new Long( 8 ),
                        expRecords2 },
                // arr.arr
                new Object[] { 13, matcher3, "no.1.1",
                        new Integer( 2147483647 ), expRecords3 },
    ...
    private String clName = "inc_update12614";
