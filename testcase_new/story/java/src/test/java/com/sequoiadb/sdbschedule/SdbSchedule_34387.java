...
/**
 * @Dscription Test of transfer more sub collection
 */
public class SdbSchedule_34387 extends SdbTestBase {

    private Sequoiadb sDB;
    private Sequoiadb tDB;
    private String scheduleName = "SdbSchedule_34387_schedule";
    private String csName = "SdbSchedule_34387";
