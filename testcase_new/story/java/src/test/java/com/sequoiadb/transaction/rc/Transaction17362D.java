 ...
 */
@Test(groups = "rc")
public class Transaction17362D extends SdbTestBase {

    private String clName = "transCL_17362D";
    ...
    public void setUp() {
        ...
        insertR1 = ( BSONObject ) JSON
                .parse( "{_id:'insertID17362D_1',a:2,b:2,c:2}" );
        insertR2 = ( BSONObject ) JSON
                .parse( "{_id:'insertID17362D_2',a:1,b:1,c:1}" );
        updateR1 = ( BSONObject ) JSON
                .parse( "{_id:'insertID17362D_1',a:3,b:3,c:2}" );
        updateR2 = ( BSONObject ) JSON
                .parse( "{_id:'insertID17362D_2',a:4,b:4,c:1}" );
        updateR3 = ( BSONObject ) JSON
                .parse( "{_id:'insertID17362D_1',a:6,b:6,c:2}" );
