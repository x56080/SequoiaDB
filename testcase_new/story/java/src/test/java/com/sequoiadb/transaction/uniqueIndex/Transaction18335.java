...
/**
 * @Description seqDB-18335:多次更新记录与其他事务多次更新的记录重复
 * @author luweikang
 * @date 2019年1月15日
 */
public class Transaction18335 extends SdbTestBase {
    private String clName = "cl18335";
    private String idxName = "idx18335";
    ...
    public void testIdIndex1() {
        ...
        try {
            ...
            expDataList.clear();
            BSONObject data3 = ( BSONObject ) JSON.parse( "{_id:11,a:1}" );
    ...
    public void testCommonUniqueIdx1() {
        ...
        try {
            ...
            expDataList.clear();
            BSONObject data3 = ( BSONObject ) JSON.parse( "{_id:1,a:11}" );
            expDataList.add( data2 );
            expDataList.add( data3 );
