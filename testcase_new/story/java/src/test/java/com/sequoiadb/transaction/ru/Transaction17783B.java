...
/**
 * @FileName:seqDB-17783:删除与更新并发，删除的记录同时匹配已提交记录及其他事务更新的记录，事务提交，过程中读 更新/删除走索引扫描,
 *                                                                  R2<R1
 * @Author zhaoyu
 * @Date 2019-01-29
 * @Version 1.00
 */
@Test(groups = "ru")
public class Transaction17783B extends SdbTestBase {
    private Sequoiadb sdb = null;
    private String clName = "cl_17783B";
    ...
    public void test() {
        ...
        // 事务1索引读
        BSONObject updateR4 = ( BSONObject ) JSON.parse( "{_id:2,a:3,b:1}" );
