 ...
 */
@Test(groups = "rc")
public class Transaction17368D extends SdbTestBase {
    private Sequoiadb sdb = null;
    private String clName = "cl_17368D";
    ...
    public void setUp() {
        ...
        insertR1 = ( BSONObject ) JSON
                .parse( "{_id:'insertID17368D_1',a:2,b:2,c:2}" );
        insertR2 = ( BSONObject ) JSON
                .parse( "{_id:'insertID17368D_2',a:1,b:1,c:1}" );
        updateR2 = ( BSONObject ) JSON
                .parse( "{_id:'insertID17368D_2',a:3,b:3,c:1}" );
    }
    ...
    private class UpdateThread extends SdbThreadBase {
        ...
        public void exec() throws BaseException {
            ...
            hint = hintIxScan;
            cl2.update( null, "{$set:{a:3,b:3}}", hint );
        }
    }
}
