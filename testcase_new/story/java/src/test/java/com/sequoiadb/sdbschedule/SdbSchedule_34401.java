...
/**
 * @Dscription Test of transfer sub collection with disable interruption
 */
public class SdbSchedule_34401 extends SdbTestBase {

    private Sequoiadb sDB;
    private Sequoiadb tDB;
    private String scheduleName = "SdbSchedule_34401_schedule";
    private String csName = "SdbSchedule_34401";
