...
/**
 * @Description : Test of clean schedule with rename CL no exceed retention days
 */
public class SdbSchedule_34351 extends SdbTestBase {

    private Sequoiadb sDB;
    private Sequoiadb tDB;
    private String scheduleName = "SdbSchedule_34351_schedule";
    private String csName = "SdbSchedule_34351";
    private String clName = "SdbSchedule_34351";
