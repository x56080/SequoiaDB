 ...
 */
@Test(groups = "rc")
public class Transaction17362F extends SdbTestBase {

    private String clName = "transCL_17362F";
    ...
    public void setUp() {
        ...
        insertR1 = ( BSONObject ) JSON
                .parse( "{_id:'insertID17362F_1',a:3,b:3,c:3}" );
        insertR2 = ( BSONObject ) JSON
                .parse( "{_id:'insertID17362F_2',a:2,b:2,c:2}" );
        updateR1 = ( BSONObject ) JSON
                .parse( "{_id:'insertID17362F_1',a:1,b:1,c:3}" );
        updateR2 = ( BSONObject ) JSON
                .parse( "{_id:'insertID17362F_2',a:5,b:5,c:2}" );
        updateR3 = ( BSONObject ) JSON
                .parse( "{_id:'insertID17362F_1',a:4,b:4,c:3}" );
    ...
    public void test( String indexKey, List< BSONObject > expPositiveReadList1,
        ...
        try {
            ...
            // 事务1更新记录R1为R2
            cl1.update( "{a:3}", "{$inc:{a:-2,b:-2}}", hintIxScan );
