...
/**
 * @testcase seqDB-17181:读并发与更新并发
 * @date 2019-1-22
 * @author yinzhen
 *
 */
@Test(groups = "rcwaitlock")
public class Transaction17181 extends SdbTestBase {
    private Sequoiadb sdb = null;
    private String clName = "cl17181";
    ...
    public void setUp() {
        ...
        cl.createIndex( "textIndex17181", "{a:1}", false, false );
    ...
    public void test() {
        ...
        // 事务3更新记录
        cl3.update( "{a:1}", "{$set:{a:4}}", "{'':'textIndex17181'}" );
        expList.clear();
