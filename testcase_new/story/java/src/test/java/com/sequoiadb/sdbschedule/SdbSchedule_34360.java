...
/**
 * @Dscription Test of data switch with more subCLs
 */
public class SdbSchedule_34360 extends SdbTestBase {

    private Sequoiadb sDB;
    private Sequoiadb tDB;
    private String scheduleName = "SdbSchedule_34360_schedule";
    private String csName = "SdbSchedule_34360";
    ...
    public void setUp() {
        ...
        cs.createCollection( subCLName1, new BasicBSONObject("ReplSize", 0) );
        cs.createCollection( subCLName2, new BasicBSONObject("ReplSize", 0) );
        ...
        TestUtils.attachCL( mainCL, new BasicBSONObject( "date", "20220201" ),
                ...
                csName + "." + subCLName2 );
        mainCL.insertRecord( new BasicBSONObject( "a", 1 ).append( "date",
                "20220101" ) );
        mainCL.insertRecord( new BasicBSONObject( "a", 2 ).append( "date",
                "20220201" ) );
        mainCL.deleteRecords( new BasicBSONObject() );
    }
    ...
    public void test() {
        ...
        Assert.assertTrue( TestUtils.compareSubCLRange( sDB,
                csName + "." + mainCLName, csName + "." + subCLName1,
                new BasicBSONObject( "date", "20220101" ),
                new BasicBSONObject( "date", "20220201" ) ) );
        Assert.assertTrue( TestUtils.compareSubCLRange( sDB,
                csName + "." + mainCLName, csName + "." + subCLName2,
                new BasicBSONObject( "date", "20220201" ),
                new BasicBSONObject( "date", "20220301" ) ) );
