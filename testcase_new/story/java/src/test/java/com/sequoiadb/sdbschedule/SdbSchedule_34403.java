...
/**
 * @Dscription Test of transfer sub collection and no have data
 */
public class SdbSchedule_34403 extends SdbTestBase {

    private Sequoiadb sDB;
    private Sequoiadb tDB;
    private String scheduleName = "SdbSchedule_34403_schedule";
    private String csName = "SdbSchedule_34403";
