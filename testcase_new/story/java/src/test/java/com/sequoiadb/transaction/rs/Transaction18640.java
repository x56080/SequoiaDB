...
/**
 * @Description seqDB-18640:批量更新记录与查询并发，事务提交
 * @date 2019-7-9
 * @author yinzhen
 *
 */
@Test(groups = { "rs" })
public class Transaction18640 extends SdbTestBase {
    ...
    public void test() {
        ...
        // 事务2表扫描/索引扫描记录
        TransUtils.queryAndCheck( cl2, "{a:1}", hintTbScan, updateList );
        TransUtils.queryAndCheck( cl2, "{a:1}", hintIxScan, updateList );
