...
/**
 * @Dscription Test of Data switch with collection auto increment difference
 */
public class SdbSchedule_34367 extends SdbTestBase {

    private Sequoiadb sDB;
    private Sequoiadb tDB;
    private String scheduleName = "SdbSchedule_34367_schedule";
    private String csName = "SdbSchedule_34367";
    private String clName = "SdbSchedule_34367";
    ...
    public void test() {
        ...
        sDB.getCollectionSpace( csName ).getCollection( clName )
                .createAutoIncrement(
                        new BasicBSONObject( "Field", "incField2" ) );
