...
/**
 * @Description seqDB-19304:并发事务，s锁升级为x锁，s锁升级为u锁
 * @date 2019-9-9
 * @author zhaoyu
 *
 */
@Test(groups = { "rs" })
public class Transaction19304 extends SdbTestBase {
    private Sequoiadb sdb;
    private Sequoiadb db1;
    private Sequoiadb db2;
    private DBCollection cl1;
    private DBCollection cl2;
    private String clName = "cl19304";
    private String idxName = "idx19304";
    private String hintTbScan = "{'':null}";
    private String hintIxScan = "{'':'" + idxName + "'}";
    private DBCollection cl;
    private ArrayList< BSONObject > expList = new ArrayList<>();
    private String recordR1 = "{_id:'cl19304', a:1}";
    ...
    public void test( String hint ) throws Exception {
        try {
            ...
            // 查询记录
            expList.clear();
            expList.add( ( BSONObject ) JSON.parse( "{_id:'cl19304',a:2}" ) );
