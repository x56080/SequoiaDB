 ...
 */
@Test(groups = "rc")
public class Transaction17368B extends SdbTestBase {
    private Sequoiadb sdb = null;
    private String clName = "cl_17368B";
    ...
    public void setUp() {
        ...
        insertR1 = ( BSONObject ) JSON
                .parse( "{_id:'insertID17368B_1',a:1,b:1,c:1}" );
        insertR2 = ( BSONObject ) JSON
                .parse( "{_id:'insertID17368B_2',a:3,b:3,c:3}" );
        updateR2 = ( BSONObject ) JSON
                .parse( "{_id:'insertID17368B_2',a:2,b:2,c:3}" );
    }
