...
/**
 * @Dscription Test of transfer sub collection have data
 */
public class SdbSchedule_34392 extends SdbTestBase {

    private Sequoiadb sDB;
    private Sequoiadb tDB;
    private String scheduleName = "SdbSchedule_34392_schedule";
    private String csName = "SdbSchedule_34392";
