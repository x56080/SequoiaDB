 ...
 */
@Test(groups = "rc")
public class Transaction17364A extends SdbTestBase {
    private Sequoiadb sdb = null;
    private String clName = "cl_17364A";
    ...
    public void setUp() {
        ...
        insertR1 = ( BSONObject ) JSON
                .parse( "{_id:'insertID17364A_1',a:1,b:1,c:1}" );
        insertR2 = ( BSONObject ) JSON
                .parse( "{_id:'insertID17364A_2',a:2,b:2,c:2}" );
        updateR1 = ( BSONObject ) JSON
                .parse( "{_id:'insertID17364A_1',a:3,b:3,c:1}" );
    ...
    public void test( String indexKey, List< BSONObject > expPositiveReadList1,
        ...
        try {
            ...
            // 事务1更新记录R1为R3,R2小于R3
            cl1.update( "{a:1}", "{$set:{a:3,b:3}}", hintIxScan );
