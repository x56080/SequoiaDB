...
/**
 * @testlink 更新重复键及_id字段，穿插执行元数据操作：truncate操作
 * @author zhaoyu
 * @Date 2019.11.11
 */
public class UniqueIndexReplSyncOptimize20252b extends SdbTestBase {

    private String clName = "cl20252b";
    ...
    public void test() throws Exception {
        for ( int i = 0; i < loopNum; i++ ) {
            ...
            if ( 0 == i % 1000 ) {
                dbcl.createIndex( "b", "{b:1}", false, false );
                dbcl.dropIndex( "b" );
                dbcl.truncate();
                dbcl.bulkInsert( insertRecords, 0 );
            }
