...
/**
 * @FileName: seqDB-17105:删除并发，事务提交，过程中读 删除走索引扫描
 * @Author zhaoyu
 * @Date 2019-01-23
 * @Version 1.00
 */
@Test(groups = "rc")
public class Transaction17105 extends SdbTestBase {
    ...
    private String hashCLName = "cl17105_hash";
    private String mainCLName = "cl17105_main";
    private String subCLName1 = "subcl17105_1";
    private String subCLName2 = "subcl17105_2";
    ...
    public void test( String indexKey, String clName )
        ...
        try {
            ...
            TransUtils.queryAndCheck( cl1,
                    "{a:{$lt:" + stopId + ",$gte:" + startId + "}}", orderByPos,
                    hintTbScan, expList1 );
            ...
            TransUtils.queryAndCheck( cl3,
                    "{a:{$lt:" + stopId + ",$gte:" + startId + "}}", orderByRev,
                    hintTbScan, expList3 );
