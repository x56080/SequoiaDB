...
/**
 * @Description seqDB-18420:事务1加s锁后，事务2加x锁，事务3加s锁
 * @author yinzhen
 * @date 2019-6-12
 *
 */
@Test(groups = { "rs" })
public class Transaction18420B extends SdbTestBase {
    private Sequoiadb sdb;
    private Sequoiadb db1;
    private Sequoiadb db2;
    private Sequoiadb db3;
    private String clName = "cl18420b";
    private String idxName = "textIndex18420";
