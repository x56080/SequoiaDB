...
/**
 * @Description seqDB-17774.java 插入与更新并发，更新的记录同时匹配已提交记录及其他事务插入的记录，事务回滚，过程中读
 * @author luweikang
 * @date 2019年1月15日
 */
@Test(groups = "ru")
public class Transaction17774 extends SdbTestBase {

    private String clName = "transCL_17774";
