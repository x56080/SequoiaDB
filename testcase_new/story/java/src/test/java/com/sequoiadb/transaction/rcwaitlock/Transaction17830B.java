...
/**
 * @FileName:seqDB-17830：更新与删除并发， 删除的记录同时匹配已提交记录及其他事务更新的记录，更新/删除走表扫描，事务提交，过程中读
 *                                表扫描,先插入R2，再插入R1
 * @Author zhaoyu
 * @Date 2019-01-29
 * @Version 1.00
...
public class Transaction17830B extends SdbTestBase {
    private Sequoiadb sdb = null;
    private String clName = "cl_17830B";
