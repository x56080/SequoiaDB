...
/**
 * @Dscription Test of transfer with collection have data including records and
 *             LOBs
 */
public class SdbSchedule_34380 extends SdbTestBase {

    private Sequoiadb sDB;
    private Sequoiadb tDB;
    private String scheduleName = "SdbSchedule_34380_schedule";
    private String csName = "SdbSchedule_34380";
    private String clName = "SdbSchedule_34380";
    private String sourceSite = "rootsite";
    private String targetSite;
    private DBCollection sCL;
    private int recordCount = 10;
    private int lobCount = 20;
    ...
    public void setUp() {
        ...
        for ( int i = 0; i < recordCount; i++ ) {
            ...
            record.put( "index", i );
            record.put( "message",
                    "This is a test record for SdbSchedule_34380 " + i );
    ...
    private void checkProgress( String scheduleId ) {
        ...
        for ( Object obj : taskList ) {
            ...
            for ( Object o : progressList ) {
                ...
                number = ( Number ) progress.get( "success_record_num" );
