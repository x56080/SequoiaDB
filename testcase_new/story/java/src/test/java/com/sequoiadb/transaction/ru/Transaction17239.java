...
/**
 * @testcase seqDB-17239:读与select for update并发，同时与更新并发
 * @date 2019-1-16
 * @author yinzhen
 *
 */
@Test(groups = "ru")
public class Transaction17239 extends SdbTestBase {
    private Sequoiadb sdb = null;
    private String clName = "cl17239";
    ...
    public void setUp() {
        ...
        cl.createIndex( "textIndex17239", "{a:1}", false, false );
    ...
    public void test() {
        ...
        recordsCursor = cl1.query( "{a:{$exists:1}}", null, null,
                "{'':'textIndex17239'}", DBQuery.FLG_QUERY_FOR_UPDATE );
        actList = TransUtils.getReadActList( recordsCursor );
        Assert.assertEquals( actList, expList );
    ...
    public class CL3Update extends SdbThreadBase {

        @Override
        public void exec() throws Exception {
            cl3.update( "{a:1}", "{$set:{a:4}}", "{'':'textIndex17240'}" );
        }
    }
}
