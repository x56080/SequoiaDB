...
/**
 * @Description seqDB-17829.java 更新并发，更新的记录同时匹配已提交记录及其他事务更新的记录，更新走表扫描，事务提交，过程中读
 * @author luweikang
 * @date 2019年1月15日
 */
@Test(groups = "rcwaitlock")
public class Transaction17829A extends SdbTestBase {

    private String clName = "transCL_17829A";
