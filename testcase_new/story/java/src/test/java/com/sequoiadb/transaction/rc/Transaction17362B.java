 ...
 */
@Test(groups = "rc")
public class Transaction17362B extends SdbTestBase {

    private String clName = "transCL_17362B";
    ...
    public void setUp() {
        ...
        insertR2 = ( BSONObject ) JSON
                .parse( "{_id:'insertID17362B_2',a:3,b:3,c:3}" );
        updateR1 = ( BSONObject ) JSON
                .parse( "{_id:'insertID17362B_1',a:2,b:2,c:1}" );
        updateR2 = ( BSONObject ) JSON
                .parse( "{_id:'insertID17362B_2',a:5,b:5,c:3}" );
        updateR3 = ( BSONObject ) JSON
                .parse( "{_id:'insertID17362B_1',a:4,b:4,c:1}" );
    ...
    public void test( String indexKey, List< BSONObject > expPositiveReadList1,
        ...
        try {
            ...
            // 事务1更新记录R1为R2
            cl1.update( "{a:1}", "{$inc:{a:1,b:1}}", hintIxScan );
