 ...
 */
@Test(groups = "rc")
public class Transaction17362C extends SdbTestBase {

    private String clName = "transCL_17362C";
    ...
    public void setUp() {
        ...
        insertR1 = ( BSONObject ) JSON
                .parse( "{_id:'insertID17362C_1',a:2,b:2,c:2}" );
        insertR2 = ( BSONObject ) JSON
                .parse( "{_id:'insertID17362C_2',a:3,b:3,c:3}" );
        updateR1 = ( BSONObject ) JSON
                .parse( "{_id:'insertID17362C_1',a:1,b:1,c:2}" );
        updateR2 = ( BSONObject ) JSON
                .parse( "{_id:'insertID17362C_2',a:6,b:6,c:3}" );
        updateR3 = ( BSONObject ) JSON
                .parse( "{_id:'insertID17362C_1',a:4,b:4,c:2}" );
