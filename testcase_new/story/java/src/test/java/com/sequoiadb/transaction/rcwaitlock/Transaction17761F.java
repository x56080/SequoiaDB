 ...
 *              插入与更新并发，更新的记录同时匹配已提交记录及其他事务插入的记录，更新走索引，事务提交，过程中读 R3<R1<R2
 * @author luweikang
 * @date 2019年1月15日
 */
...
public class Transaction17761F extends SdbTestBase {
    ...
    public void setUp() {
        ...
        insertR1 = ( BSONObject ) JSON
                .parse( "{_id:'insertID17761F_1',a:2,b:2}" );
        insertR2 = ( BSONObject ) JSON
                .parse( "{_id:'insertID17761F_2',a:4,b:4}" );
        updateR1 = ( BSONObject ) JSON
                .parse( "{_id:'insertID17761F_1',a:1,b:1}" );
        updateR2 = ( BSONObject ) JSON
                .parse( "{_id:'insertID17761F_2',a:3,b:3}" );
    }
    ...
    public Object[][] createIndex() {
        ...
        return new Object[][] {
                ...
                { "{'a': -1}", expPositiveReadList4, expReverseReadList4,
                        expPositiveReadList2, expReverseReadList2,
                        expReverseReadList3, expReverseReadList2 } };
    }
