...
/**
 * @Description seqDB-17074: 插入记录与读记录并发，事务提交 
 * @author xiaoni Zhao
 * @date 2019-1-18
 */
...
@Test(groups = "rc")
public class Transaction17074 extends SdbTestBase {
    private String clName = "cl_17074";
    ...
    public void test() {
        ...
        // 非事务索引扫描记录
        TransUtils.queryAndCheck( cl, "{'':'a'}", expList );
