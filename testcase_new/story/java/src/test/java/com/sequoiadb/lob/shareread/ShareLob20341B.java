...
public class ShareLob20341B extends SdbTestBase {
    ...
    private String clName = "cl20341B";
    private String mainCLName = "mainCL20341B";
    private String subCLName = "subCL20341B";
