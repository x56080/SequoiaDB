 ...
 */
@Test(groups = "rc")
public class Transaction17358B extends SdbTestBase {

    private String clName = "transCL_17358B";
    ...
    public void setUp() {
        ...
        insertR1 = ( BSONObject ) JSON
                .parse( "{_id:'insertID17358B_1',a:1,b:1,c:1}" );
        insertR2 = ( BSONObject ) JSON
                .parse( "{_id:'insertID17358B_2',a:3,b:3,c:3}" );
        updateR1 = ( BSONObject ) JSON
                .parse( "{_id:'insertID17358B_1',a:2,b:2,c:1}" );
        updateR2 = ( BSONObject ) JSON
                .parse( "{_id:'insertID17358B_2',a:4,b:4,c:3}" );
