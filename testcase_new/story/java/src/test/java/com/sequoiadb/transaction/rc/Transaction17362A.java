...
/**
 * @Description seqDB-17362.java 更新并发，更新的记录同时匹配已提交记录及其他事务更新的记录，更新走索引，事务提交，过程中读
 *              R1<R2<R3
 * @author luweikang
 * @date 2019年1月15日
 */
@Test(groups = "rc")
public class Transaction17362A extends SdbTestBase {

    private String clName = "transCL_17362A";
    ...
    public void setUp() {
        ...
        insertR1 = ( BSONObject ) JSON
                .parse( "{_id:'insertID17362A_1',a:1,b:1,c:1}" );
        insertR2 = ( BSONObject ) JSON
                .parse( "{_id:'insertID17362A_2',a:2,b:2,c:2}" );
        updateR1 = ( BSONObject ) JSON
                .parse( "{_id:'insertID17362A_1',a:3,b:3,c:1}" );
        updateR2 = ( BSONObject ) JSON
                .parse( "{_id:'insertID17362A_2',a:4,b:4,c:2}" );
        updateR3 = ( BSONObject ) JSON
                .parse( "{_id:'insertID17362A_1',a:5,b:5,c:1}" );
    ...
    public void test( String indexKey, List< BSONObject > expPositiveReadList1,
        ...
        try {
            ...
            // 事务1更新记录R1为R2
            cl1.update( "{a:1}", "{$inc:{a:2,b:2}}", hintIxScan );
