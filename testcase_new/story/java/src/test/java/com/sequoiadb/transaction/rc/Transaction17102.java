...
/**
 * @FileName: seqDB-17102:更新与删除并发，匹配更新前记录，事务回滚，过程中读 更新/删除走索引
 * @Author zhaoyu
 * @Date 2019-01-23
 * @Version 1.00
 */
@Test(groups = "rc")
public class Transaction17102 extends SdbTestBase {
    ...
    private String hashCLName = "cl17102_hash";
    private String mainCLName = "cl17102_main";
    private String subCLName1 = "subcl17102_1";
    private String subCLName2 = "subcl17102_2";
    ...
    public void test( String indexKey, String clName )
        ...
        try {
            ...
            // 非事务记录读
            TransUtils.queryAndCheck( cl3, hintTbScan, expList4 );

            // 非事务索引读
            TransUtils.queryAndCheck( cl3, hintIxScan, expList4 );
        } finally {
