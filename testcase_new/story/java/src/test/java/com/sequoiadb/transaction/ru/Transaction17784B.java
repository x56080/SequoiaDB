 ...
 */
@Test(groups = "ru")
public class Transaction17784B extends SdbTestBase {
    private Sequoiadb sdb = null;
    private String clName = "cl_17784B";
    ...
    public void setUp() {
        ...
        insertR2 = ( BSONObject ) JSON
                .parse( "{_id:'insertID17784B_2',a:1,b:1}" );
        updateR1 = ( BSONObject ) JSON
                .parse( "{_id:'insertID17784B_1',a:4,b:2}" );
        updateR2 = ( BSONObject ) JSON
                .parse( "{_id:'insertID17784B_2',a:3,b:1}" );
    }
