...
/**
 * @FileName: seqDB-17226：删除与更新并发，事务提交，过程中读 更新/删除走索引扫描
 * @Author zhaoyu
 * @Date 2019-01-16
 * @Version 1.00
 */
@Test(groups = "ru")
public class Transaction17226 extends SdbTestBase {
    private Sequoiadb sdb = null;
    private String clName = "cl_17226";
    ...
    public void test( String indexKey ) {
        try {
            ...
            // 事务1匹配R1删除
            hint = "{\"\":\"a\"}";
            cl1.delete( "{a: {$gte: " + startId + ", $lt: " + stopId + "}}",
                    hint );
