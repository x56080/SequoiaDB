...
/**
 * @Description seqDB-18411:事务1加x锁后，事务2加s锁，事务3加u锁继续等锁
 * @author yinzhen
 * @date 2019-6-11
 *
 */
@Test(groups = { "rc" })
public class Transaction18411A extends SdbTestBase {
    private Sequoiadb sdb;
    private Sequoiadb db1;
    private Sequoiadb db2;
    private Sequoiadb db3;
    private String clName = "cl18411a";
    private String idxName = "textIndex18411";
