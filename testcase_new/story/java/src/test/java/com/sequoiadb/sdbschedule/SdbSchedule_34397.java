...
/**
 * @Dscription Test of transfer timeout
 */
public class SdbSchedule_34397 extends SdbTestBase {

    private Sequoiadb sDB;
    private Sequoiadb tDB;
    private String scheduleName = "SdbSchedule_34397_schedule";
    private String csName = "SdbSchedule_34397";
    private String mainCLName = "mainCL";
    private String subCLName = "subCL1";
    private String sourceSite = "rootsite";
    private String targetSite;
    private int lobCount = 100;
    ...
    public void test() throws Exception {
        ...
        TestUtils.waitTaskNum( id, 2 );
        BusinessApiFactory.Schedule.switchEnable( id, false );
        resp = BusinessApiFactory.Schedule.listTasks( id, 0, 1, null,
                new BasicBSONObject( "create_time", 1 ) );
        BasicBSONList taskList = ( BasicBSONList ) BsonUtils
                .fromResponse( resp );
        BasicBSONObject task = ( BasicBSONObject ) taskList.get( 0 );
        Assert.assertEquals( task.get( "running_flag" ), 5,
                "The task should be timeout" );
