...
public class Transaction17772A extends SdbTestBase {
    private Sequoiadb sdb = null;
    private String clName = "cl_17772A";
    ...
    public void setUp() {
        ...
        insertR1 = ( BSONObject ) JSON
                .parse( "{_id:'insertID17772A_1',a:1,b:1}" );
        insertR2 = ( BSONObject ) JSON
                .parse( "{_id:'insertID17772A_2',a:2,b:2}" );
        updateR1 = ( BSONObject ) JSON
                .parse( "{_id:'insertID17772A_1',a:3,b:3}" );
        updateR2 = ( BSONObject ) JSON
                .parse( "{_id:'insertID17772A_2',a:4,b:4}" );
    }
