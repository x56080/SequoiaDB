...
/**
 * @Description seqDB-18425:事务1加s锁后，事务2加s锁，事务3加u锁
 * @author yinzhen
 * @date 2019-6-12
 *
 */
@Test(groups = { "rc", "rs" })
public class Transaction18425 extends SdbTestBase {
    private Sequoiadb sdb;
    private Sequoiadb db1;
    private Sequoiadb db2;
    private Sequoiadb db3;
    private String clName = "cl18425";
    private String idxName = "textIndex18425";
