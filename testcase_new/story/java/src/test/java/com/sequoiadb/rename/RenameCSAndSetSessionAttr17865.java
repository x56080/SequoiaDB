...
/**
 * @FileName RenameCSAndSetSessionAttr17865
 ...
 *          slave node has no synchronous rename CS,the operator access the
 *          master node. *
 * @testlink seqDB-17865
 * @author wuyan
 * @Date 2019.2.18
 * @version 1.00
 */
public class RenameCSAndSetSessionAttr17865 extends SdbTestBase {
    private String clName = "renameCL_17865";
    private String oldCSName = "oldRenameCS_17865";
    private String newCSName = "newRenameCS_17865";
    ...
    private ObjectId lobOid = new ObjectId( "5c6a5373d5d5a3f1282f75d0" );
    ...
    public void setUp() {
        ...
        dbcl = RenameUtil.createCL( cs, clName, options );
    ...
    public class CountThread extends SdbThreadBase {
        ...
        public void exec() throws BaseException {
            try {
                DBCollection dbcl = db.getCollectionSpace( newCSName )
                        .getCollection( clName );
