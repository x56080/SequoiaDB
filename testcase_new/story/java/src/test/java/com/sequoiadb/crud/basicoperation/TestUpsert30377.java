...
public class TestUpsert30377 extends SdbTestBase {
    private final String csName = "cs_30377";
    private final String clName = "cl_30377";
    private final String indexName = "index_30377";
    ...
    public Object[][] generateUpsertDatas() {
        ...
        // upsert( { $set: { a: 1, b: 1, c: 3 } }, { a: 1, b: 1 } ); index:{ a:
        // 1, b: 1 },{ a: 1 }
        ...
        // upsert( { $set: { a: { b: 1 }, c: 3 }, { a: { b: 1 } , c: 3 } );
        // index:{ a: { b: 1 } },{ c: 1 }
    ...
    private void test( int num, BasicBSONObject insertData,
            BasicBSONObject matcher, BasicBSONObject index1,
            BasicBSONObject index2 ) throws Exception {
    ...
    private class testUpsert {
        private final BasicBSONObject insertData;
        private final BasicBSONObject matcher;
        int num;

        private testUpsert( int num, BasicBSONObject insertData,
