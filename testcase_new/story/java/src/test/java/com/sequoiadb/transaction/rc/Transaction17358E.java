 ...
 */
@Test(groups = "rc")
public class Transaction17358E extends SdbTestBase {

    private String clName = "transCL_17358E";
    ...
    public void setUp() {
        ...
        insertR1 = ( BSONObject ) JSON
                .parse( "{_id:'insertID17358E_1',a:3,b:3,c:3}" );
        insertR2 = ( BSONObject ) JSON
                .parse( "{_id:'insertID17358E_2',a:1,b:1,c:1}" );
        updateR1 = ( BSONObject ) JSON
                .parse( "{_id:'insertID17358E_1',a:2,b:2,c:3}" );
        updateR2 = ( BSONObject ) JSON
                .parse( "{_id:'insertID17358E_2',a:0,b:0,c:1}" );
