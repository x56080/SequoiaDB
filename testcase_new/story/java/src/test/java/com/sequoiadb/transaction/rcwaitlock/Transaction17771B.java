...
public class Transaction17771B extends SdbTestBase {
    private Sequoiadb sdb = null;
    private String clName = "cl_17771B";
    ...
    public void test() {
        ...
        // 非事务记录读
        expList.clear();
        BSONObject updateR2 = ( BSONObject ) JSON.parse( "{_id:2,a:2,b:3}" );
