...
public class TestUpsert30343 extends SdbTestBase {
    private final String csName = "cs_30343";
    private final String clName = "cl_30343";
    private final String indexName = "index_30343";
    ...
    public Object[][] generateUpsertDatas() {
        ...
        // eg: upsert( { $set: { a: 1, b: 1, c: 3 } }, { a: 1, b: 1 } ); index:{
        // a: 1, b: 1 }
        ...
        // upsert( { $set: { a: { b: 1 }, c: 1, d: 1 }, { a: { b: 1 }, c: 1 } );
        // index:{ a: { b: 1 }, c: 1 }
        ...
        // upsert( { $set: { a: { b: 1 }, c: 1 }, { a: { b: 1 }, c: 1 } );
        // index:{ a: { b: 1 }, c: 1 }
