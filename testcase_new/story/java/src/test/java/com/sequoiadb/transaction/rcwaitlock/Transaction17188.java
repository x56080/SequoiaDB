...
/**
 * @Description seqDB-17188:   更新多个索引，同时与读并发 
 * @author xiaoni Zhao
 * @date 2019-1-23
 */
...
public class Transaction17188 extends SdbTestBase {
    private String clName = "cl_17188";
    ...
    public void setUp() {
        ...
        cl.createIndex( "c", "{c:1}", false, false );
