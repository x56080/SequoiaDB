 ...
 */
@Test(groups = "rc")
public class Transaction17364E extends SdbTestBase {
    private Sequoiadb sdb = null;
    private String clName = "cl_17364E";
    ...
    public void setUp() {
        ...
        insertR1 = ( BSONObject ) JSON
                .parse( "{_id:'insertID17364E_1',a:3,b:3,c:3}" );
        insertR2 = ( BSONObject ) JSON
                .parse( "{_id:'insertID17364E_2',a:1,b:1,c:1}" );
        updateR1 = ( BSONObject ) JSON
                .parse( "{_id:'insertID17364E_1',a:2,b:2,c:3}" );
    ...
    public Object[][] createIndex() {
        ...
        return new Object[][] { { "{'a': 1}", expReadList1, expReadList1 },
                { "{'a': 1, b: 1}", expReadList1, expReadList1 },
                { "{'a': 1, b: -1}", expReadList1, expReadList1 },
    ...
    public void test( String indexKey, List< BSONObject > expPositiveReadList1,
        ...
        try {
            ...
            // 事务1更新记录R1为R3,R2小于R3
            cl1.update( "{a:3}", "{$set:{a:2,b:2}}", hintIxScan );
