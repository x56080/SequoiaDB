 ...
 */
@Test(groups = "ru")
public class Transaction17773B extends SdbTestBase {

    private String clName = "transCL_17773B";
    ...
    public void setUp() {
        ...
        insertR1 = ( BSONObject ) JSON
                .parse( "{_id:'insertID17773B_1',a:2,b:2}" );
        insertR2 = ( BSONObject ) JSON
                .parse( "{_id:'insertID17773B_2',a:1,b:1}" );
        updateR1 = ( BSONObject ) JSON
                .parse( "{_id:'insertID17773B_1',a:4,b:4}" );
        updateR2 = ( BSONObject ) JSON
                .parse( "{_id:'insertID17773B_2',a:3,b:3}" );
    }
