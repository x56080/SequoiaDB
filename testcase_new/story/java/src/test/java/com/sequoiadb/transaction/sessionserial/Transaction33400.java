...
/**
 * @Description seqDB-33400:事务中查询和切主并发，回滚事务
 * @Author liuli
 * @Date 2023.09.18
 * @UpdateAuthor liuli
 ...
 */
@Test(groups = "ru")
public class Transaction33400 extends SdbTestBase {

    private Sequoiadb sdb;
    private Sequoiadb db1;
    private CollectionSpace dbcs;
    private List< String > groupNames = new ArrayList<>();
    private String tclName = "testcl_33400";
    private String clName = "cl_33400";
