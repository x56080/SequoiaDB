/******************************************************************************
*@Description : test sdblobtool migration between hash collection and normal 
...
function main ( db )
{
   ...
   {
      println( ">fail to test migration HNMany,rc = " + e );
      throw e;
   }
   finally
   {
...
catch( e )
{
   ...
   cmd.run( "mv sdblobtool.log /tmp/lobtool/migrationHNMany.log" );
   throw e;
}
finally
{
