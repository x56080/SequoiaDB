/******************************************************************************
*@Description : test sdblobtool export and import between hash collection
                and normal collection with many lobs
*@Modify list :
...
function main ( db )
{
   ...
   try
   {
      ...
      println( ">success to test eximport HN with many lobs.\n\n" );
   }
   catch( e )
   {
      println( ">fail to test eximport HNMany,rc = " + e );
      throw e;
   }
   finally
   {
...
catch( e )
{
   ...
   cmd.run( "mv sdblobtool.log /tmp/lobtool/eximportHNMany.log" );
   throw e;
}
finally
{
