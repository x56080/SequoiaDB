...
function test ()
{
   ...
   commCheckLSN( db );
   var expCursor = db.snapshot( SDB_SNAP_COLLECTIONS, { Name: csName + "." + clName }, {}, { "Details.Group.NodeName": 1 } );
   ...
   commCheckLSN( db );
   var actCursor = db.snapshot( SDB_SNAP_COLLECTIONS, { Name: csName + "." + clName }, {}, { "Details.Group.NodeName": 1 } );
