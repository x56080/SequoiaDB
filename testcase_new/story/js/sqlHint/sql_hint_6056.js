/************************************************************************
*@Description:   一个select中多个hint重复_st.sql.hint.008
...
function selectRecs ( csName, clName, idxName )
{
   ...
   var rc = db.exec( "select t1.c from " + csName + "." + clName + " as t1 where t1.b = 2 /*+use_index(t1, " + idxName + ") use_index(t1, " + idxName + ")*/" );
   var rtRecsArray = [];
