/************************************
*@Description: use ceiling:{field:{$ceiling:1}}
...
function main ()
{
	...
	var selectCondition1 = { a: { $ceiling: 1 } };
	...
	{ a: null }, { a: null }, { a: null }, { a: null }, { a: null }, { a: null }, { a: [null, 3, 3, null] }, { a: null }, { a: null }, { a: null }, { a: null }];
	checkResult( dbcl, null, selectCondition1, expRecs1, { _id: 1 } );

	/*1.two field;seqDB-8218
	  2.field is Non-existent;seqDB-5632*/
	var selectCondition2 = { a: { $ceiling: 1 }, b: { $ceiling: 1 }, c: { $ceiling: 1 } };
