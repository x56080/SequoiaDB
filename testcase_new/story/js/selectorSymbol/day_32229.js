/******************************************************************************
 * @Description   : seqDB-32229:decimal类型调用$day
 * @Author        : Cheng Jingjing
 * @CreateTime    : 2023.06.15
 * @LastEditTime  : 2023.06.15
 * @LastEditors   : Cheng Jingjing
 ******************************************************************************/
testConf.clName = COMMCLNAME + "32229";
main( test )
function test ( testPara )
{
    ...
    // 作为匹配符
    var actRecords = cl.find( { "a": { "$day": 1, "$et": 17 } } );
    commCompareResults( actRecords, [ { No: 3, a: { $decimal: "-9223372036854775808" } }, { No: 5, a: { $decimal: "9223372036854775807" } } ] );
}