/******************************************************************************
 * @Description   : seqDB-32202:date类型调用$year
 * @Author        : Cheng Jingjing
 * @CreateTime    : 2023.06.15
 * @LastEditTime  : 2023.06.15
 * @LastEditors   : Cheng Jingjing
 ******************************************************************************/
testConf.clName = COMMCLNAME + "32202";
...
function test ( testPara )
{
    ...
    // 作为匹配符
    var actRecords = cl.find( { "a": { "$year": 1, "$et": 9999 } } );
    commCompareResults( actRecords, [ { No: 3, a: { $date: "9999-12-31" } } ] );
}