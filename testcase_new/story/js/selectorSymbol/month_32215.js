/******************************************************************************
 * @Description   : seqDB-32215:int64类型调用$month
 * @Author        : Cheng Jingjing
 * @CreateTime    : 2023.06.15
 * @LastEditTime  : 2023.06.15
 * @LastEditors   : Cheng Jingjing
 ******************************************************************************/
testConf.clName = COMMCLNAME + "32215";
main( test )
function test ( testPara )
{
    ...
    // 作为匹配符
    var actRecords = cl.find( { "a": { "$month": 1, "$et": 8 } } );
    commCompareResults( actRecords, [ { No: 4, a: { $numberLong: "9223372036854775807" } } ] );
}