...
function main()
{
   ...
   cl.alter( {  Alter:[  {Name:"enable sharding", Args:{ShardingKey:{a:1}, ShardingType:'hash', AutoSplit:false}}, 
   ...
   try
   {
      ...
      cl.alter( {  Alter:[  {Name:"enable sharding", Args: {ShardingKey:{b:1}, ShardingType:'range'}}, 
      {Name:"set attributes", Args: {Name:"cs.cl"}}, 
