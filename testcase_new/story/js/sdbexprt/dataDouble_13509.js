/*******************************************************************
* @Description : test export with double data
...
var clname = COMMCLNAME + "_sdbexprt13509_double";
var clname1 = COMMCLNAME + "_sdbimprt13509_double";
var key = "double";
var doubleMin = -1.7e+308;
var doubleMax = 1.7e+308;
var docs = [{ "double": doubleMin },
{ "double": doubleMax }];
var csvContent = key + "\n" + doubleMin + "\n" + doubleMax + "\n";
var jsonContent = "{ \"" + key + "\": " + doubleMin + " }\n" +
   "{ \"" + key + "\": " + doubleMax + " }\n";
...
{
   var csvfile = tmpFileDir + "sdbexprt13509_double.csv";
...
{
   var jsonfile = tmpFileDir + "sdbexprt13509_double.json";
