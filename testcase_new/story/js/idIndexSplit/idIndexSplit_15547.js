...
function main ()
{
   ...
   var varCL = commCreateCL( db, COMMCSNAME, clName, { ShardingKey: { a: 1 }, ShardingType: "hash", AutoIndexId: false, ReplSize: 2, Compressed: true, CompressionType: "lzw" }, true, false, "create CL" );
