/************************************
*@Description: update object(any arrays include arrays and objects) with pull_all_by
*@author:      liuxiaoxuan
*@createdate:  2017.09.19
*@testlinkCase: seqDB-12763/seqDB-12764/seqDB-12765
**************************************/
function main()
{
   ...
   var dbcl = commCreateCL( db, COMMCSNAME, COMMCLNAME, 0 );
	...
	var indexName = 'b';
	var key = {b:1}
	createIndex( dbcl, indexName, key )
   ...
   //insert data   
	...
	var updateRule1 = {$pull_all_by:{a1:[-100,-200],a2:['abc','def'],
	                                 'a3.0':[1,2],
	                                 'a4.0.1':[-10,-20],
										      a5:[{obj1:-1},{obj1:-2}],
   ...
   var expResult1 = [{a1:[1,2,3,0,-2,-1],b1:[10,20,30,-30,-10]},
	                  ...
	                  {a5:[{obj1:1,obj2:'testa51'},{obj1:2,obj2:'testa52'},{obj1:3}]},
				         ...
				         {b12:[{obj1:{obj2_1:-1,obj2_2:-2}},{obj1:{obj2_1:0,obj2_2:1}},{obj1:{obj2_1:1,obj2_2:2}}]},
				         {b13:[{obj1:{obj2:{obj3:1}},obj4:'tb13obj4aa'},{obj1:{obj2:{obj3:2}},obj4:'tb13obj4bb'},{obj1:{obj2:{obj3:2}}}]}];
	checkResult( dbcl, null, null, expResult1, {_id:1} );
	
	//pull_all_by , part of / all match
	var updateRule2 = {$pull_all_by:{a1:[-1,2],a2:['a','d','e'],
	                                 'a3.1':[-100,-200],
	                                 'a4.0.1':[0,-100],
												a5:[{obj1:1},{obj1:2}],
   ...
   var expResult2 = [{a1:[1,3,0,-2],b1:[10,30,-30]},
	...
	checkResult( dbcl, null, null, expResult2, {_id:1} );
}
