/************************************
*@Description: update object(any arrays include arrays,objects) with pull_by
*@author:      liuxiaoxuan
*@createdate:  2017.09.18
*@testlinkCase: seqDB-12757/seqDB-12758/seqDB-12759
**************************************/
function main()
{
   ...
   //insert data   
	...
	var updateRule1 = {$pull_by:{a1:4,a2:'f',a3:300,
   ...
   var expResult1 = [{a1:[1,2,3],b1:[10,20,30]},
	...
	var updateRule2 = {$pull_by:{a1:1,a2:'b',
		                          a3:[-100,-200],
