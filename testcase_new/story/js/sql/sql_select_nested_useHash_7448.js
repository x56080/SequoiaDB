/****************************************************
@description:	nested select with /*+use_hash()*/
/*        testlink cases:   seqDB-7448
@input:        1 insert into records
               2 nested select with /*+use_hash()*/
/*
