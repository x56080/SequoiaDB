/******************************************************************************
 * @Description   : seqDB-23477:多个子表使用相同数据源，主表上执行LOB操作
 * @Author        : Wu Yan
...
function test ()
{
   var dataSrcName = "datasrc23477";

   var srcCSName = "cs_23477";
   var csName = "cs_23477";
   var clName = "cl_23477";
   var mainCLName = "mainCL_23477";
...
function putLobAndCheckResult ( dbcl, dsMarjorVersion )
{
   ...
   else
   {
      ...
      dbcl.getLob( lobID, filePath + "checktruncateLob23477" );
      var expMD5 = File.md5( filePath + fileName );
      var actMD5 = File.md5( filePath + "checktruncateLob23477" );
