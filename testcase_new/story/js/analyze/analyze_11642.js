...
function test ()
{
   ...
   db.analyze( { Mode: 3, Collection: COMMCSNAME + "." + clName, Index: "a", GroupName: groupName, NodeID: nodeId } );
   ...
   //统计信息加载至缓存
   db.analyze( { Mode: 4, Collection: COMMCSNAME + "." + clName, Index: "a", GroupName: groupName, NodeID: nodeId } );
   ...
   //清空缓存
   db.analyze( { Mode: 5, Collection: COMMCSNAME + "." + clName, Index: "a", GroupName: groupName, NodeID: nodeId } );
