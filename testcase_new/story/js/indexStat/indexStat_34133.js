/******************************************************************************
 * @Description   : seqDB-34133:表类型为范围分区表，样本数超过阈值，查看索引统计信息
 * @Author        : chenzejia
...
{
   var clName = "cl_34133";
   var indexName = "idx_34133";
   var totalRecords = 20000;
   var sampleNum = 5000;
   var statmcvlimit = 2500;
   var testCL = commCreateCL( db, COMMCSNAME, clName, { ShardingType: "range", ShardingKey: { a: 1 } } );
   var docs = [];
