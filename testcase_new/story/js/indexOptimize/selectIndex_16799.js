/************************************
*@Description: seqDB-16799 multiple indexes match fields for query conditions,
               and sort field matching partial index,hint to index.
*@author:      wuyan
*@date:        2018.12.12
**************************************/
main();
function main()
{ 
   var clName = COMMCLNAME + "_selectIndex_16799";
   ...
   var findCond = {'intb':{$gt:0},'datec':{$ne:''},'stra':{$lt:1000}};  
   var sortCond = {'stra':1,'intb':1,'datec':1};
