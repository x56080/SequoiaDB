/******************************************************************************
 * @Description   : seqDB-27840 删除CL，CS在group下还存在CL
 * @Author        : HuangHaimei
 * @CreateTime    : 2022.09.25
 * @LastEditTime  : 2022.11.15
 * @LastEditors   : HuangHaimei
 ******************************************************************************/
testConf.csName = COMMCSNAME + "_27840";
...
function test ( testPara )
{
   ...
   var clName1 = "cl_27840_1";
   var clName2 = "cl_27840_2";
   var clName3 = "cl_27840_3";
   var filePath = WORKDIR + "/lob27840/";
   var fileName = "filelob_27840";
