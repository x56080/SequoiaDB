/******************************************************************************
 * @Description   : seqDB-27842:CL执行truncate
 * @Author        : HuangHaimei
 * @CreateTime    : 2022.09.26
 * @LastEditTime  : 2022.10.10
 * @LastEditors   : liuli
 ******************************************************************************/
testConf.csName = COMMCSNAME + "_27842";
testConf.csOpt = { LobPageSize: 262144 };
testConf.clName = COMMCLNAME + "_27842";
...
function test ( testPara )
{
   ...
   var filePath = WORKDIR + "/lob27842/";
   var fileName = "filelob_27842";
   ...
   csInfo[0]["FreeLobSpace"] += lobPages * lobPageSize * lobs * nodeNum;
