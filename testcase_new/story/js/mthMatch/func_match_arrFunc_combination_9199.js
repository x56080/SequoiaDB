...
function main ()
{
   ...
   for( var i = 0; i < loopNum; i++ )
   {
      ...
      println( "---combinationFind1: " + JSON.stringify( combinationFind1 ) );
...
function checkParse ( dbcl, condition, condition2, sortCondition )
{
   ...
   {
      println( "---condition: " + JSON.stringify( condition ) );
      println( "---condition2: " + JSON.stringify( condition2 ) );
      println( "---sortCondition: " + JSON.stringify( sortCondition ) );
      throw buildException( "checkParse() " + e + "\ncheckResult " + " \nExpect result: " + 0 + " \nActual result:" + e );
   }
}