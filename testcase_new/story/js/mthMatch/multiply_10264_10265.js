/************************************
*@Description: many fields use multiply to match,
*@author:      zhaoyu
...
function main ()
{
   ...
   var findCondition1 = { a: { $multiply: 2, $et: 2.4 }, b: { $multiply: -2, $et: 5 } };
   var expRecs1 = [{ No: 1, a: 1.2, b: -2.5 },
   { No: 3, a: [1.2, 2.5], b: [-1.2, -2.5] }];
   checkResult( dbcl, findCondition1, null, expRecs1, { _id: 1 } );

   var findCondition2 = { a: { $multiply: 2, $et: 2.4 }, b: { $multiply: -2, $et: 5 }, c: { $multiply: 1, $et: 1 } };
   var expRecs2 = [];
   checkResult( dbcl, findCondition2, null, expRecs2, { _id: 1 } );

   var findCondition3 = { "a.0": { $multiply: 2, $et: 2.4 }, "b.0": { $multiply: -2, $et: 2.4 } };
   var expRecs3 = [{ No: 3, a: [1.2, 2.5], b: [-1.2, -2.5] },
   { No: 5, a: [{ 0: 1.2 }, { 1: 2.5 }], b: [{ 0: -1.2 }, { 1: -2.5 }] },
   { No: 7, a: { 0: 1.2, 1: 2.5 }, b: { 0: -1.2, 1: -2.5 } }];
   checkResult( dbcl, findCondition3, null, expRecs3, { _id: 1 } );

   var findCondition4 = { "a.0": { $multiply: 2, $et: 2.4 }, "b.0": { $multiply: -2, $et: 2.4 }, "c.0": { $multiply: 1, $et: -1 } };
   var expRecs4 = [];
