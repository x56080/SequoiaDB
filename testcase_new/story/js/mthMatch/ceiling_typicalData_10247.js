...
*@testlinkCase: seqDB-10247/seqDB-10250
**************************************/
function main ()
{
   ...
   var findCondition1 = { a: { $abs: 1, $ceiling: 1, $et: 3 } };
   ...
   var findCondition2 = { a: { $ceiling: 1, $abs: 1, $et: { $numberLong: "3" } } };
   ...
   //numberLong
   var findCondition3 = { $and: [{ a: { $abs: 1, $et: { $decimal: "2.3", $precision: [10, 2] } } }, { a: { $ceiling: 1, $et: { $numberLong: "3" } } }] };
   var expRecs3 = [{ No: 1, a: 2.3 },
   { No: 9, a: { $decimal: "2.3" } }];
