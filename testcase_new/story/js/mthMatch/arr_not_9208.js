/************************************
*@Description: find condition type is arr,key exists $ ,find condition include arr/obj/regex/other,use not
*@author:      zhaoyu
...
function main ()
{
   ...
   //seqDB-9206
   var findCondition1 = { $not: [{ a: { $regex: '^string$', $options: 'i' } }, { b: 1 }, { c: { d: 1 } }, { e: { $abs: 1, $et: 200 } }, { $and: [{ f: { $type: 1, $et: 2 } }, { c: { $type: 1, $et: 3 } }] }] };
   var expRecs1 = [{ No: 2, a: "aString", b: 1, c: { h: 1 }, e: 20, f: 1 },
   { No: 3, a: "aString", b: 2, c: { d: 1 }, e: 20, f: 1 },
   { No: 4, a: "astring", b: 2, c: { h: 1 }, e: 200, f: 1 },
   { No: 5, a: "aString", b: 2, c: { h: 1 }, e: -20, f: "string" },
   { No: 6, a: "aString", b: 2, c: { h: 1 }, e: -20, f: 1 }];
   ...
   explainExpRecs1 = [{
      ...
      IndexName: "",
      UseExtSort: false,
      Query: { $not: [{ b: { $et: 1 } }, { "c": { $et: { d: 1 } } }, { c: { $type: 1, $et: 3 } }, { e: { $abs: 1, $et: 200 } }, { f: { $type: 1, $et: 2 } }, { a: { $regex: "^string$", $options: "i" } }] },
      IXBound: null,
      NeedMatch: true
   }];
