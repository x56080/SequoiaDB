...
function main ()
{
   ...
   //or
   //gt
   var findCondition1 = { $or: [{ a: { $gt: 1000 } }, { a: { $gt: 2000 } }, { a: { $gt: 3000 } }] };
   ...
   var findCondition2 = { $or: [{ a: { $gt: 1000 } }, { a: { $gt: 3000 } }, { a: { $gt: 2000 } }] };
   checkResult( dbcl, findCondition2, null, expRecs1, { No: 1 } );

   var findCondition3 = { $or: [{ a: { $gt: 2000 } }, { a: { $gt: 3000 } }, { a: { $gt: 1000 } }] };
   checkResult( dbcl, findCondition3, null, expRecs1, { No: 1 } );

   var findCondition4 = { $or: [{ a: { $gt: 2000 } }, { a: { $gt: 1000 } }, { a: { $gt: 3000 } }] };
   checkResult( dbcl, findCondition4, null, expRecs1, { No: 1 } );

   var findCondition5 = { $or: [{ a: { $gt: 3000 } }, { a: { $gt: 2000 } }, { a: { $gt: 1000 } }] };
   checkResult( dbcl, findCondition5, null, expRecs1, { No: 1 } );

   var findCondition6 = { $or: [{ a: { $gt: 3000 } }, { a: { $gt: 1000 } }, { a: { $gt: 2000 } }] };
   checkResult( dbcl, findCondition6, null, expRecs1, { No: 1 } );

   //gte 
   var findCondition7 = { $or: [{ a: { $gte: 3000 } }, { a: { $gte: 2000 } }, { a: { $gte: 1000 } }] };
   ...
   var findCondition8 = { $or: [{ a: { $gte: 1000 } }, { a: { $gte: 2000 } }, { a: { $gte: 3000 } }] };
   checkResult( dbcl, findCondition8, null, expRecs2, { No: 1 } );

   var findCondition9 = { $or: [{ a: { $gte: 1000 } }, { a: { $gte: 3000 } }, { a: { $gte: 2000 } }] };
   checkResult( dbcl, findCondition9, null, expRecs2, { No: 1 } );

   var findCondition10 = { $or: [{ a: { $gte: 2000 } }, { a: { $gte: 1000 } }, { a: { $gte: 3000 } }] };
   checkResult( dbcl, findCondition10, null, expRecs2, { No: 1 } );

   var findCondition11 = { $or: [{ a: { $gte: 2000 } }, { a: { $gte: 3000 } }, { a: { $gte: 1000 } }] };
   checkResult( dbcl, findCondition11, null, expRecs2, { No: 1 } );

   var findCondition12 = { $or: [{ a: { $gte: 3000 } }, { a: { $gte: 1000 } }, { a: { $gte: 2000 } }] };
   checkResult( dbcl, findCondition12, null, expRecs2, { No: 1 } );

   //lt 
   var findCondition13 = { $or: [{ a: { $lt: 1000 } }, { a: { $lt: 2000 } }, { a: { $lt: 3000 } }] };
   var expRecs3 = [{ No: 1, a: [500, 501, 502] }, { No: 2, a: [1000, 1001, 1002] }, { No: 3, a: [1500, 1501, 1502] },
   { No: 4, a: [2000, 2001, 2002] }, { No: 5, a: [2500, 2501, 2502] },
   { No: 8, a: [501, 1001, 2001] }, { No: 9, a: [1001, 2001, 3001] },
   { No: 10, a: [2001, 3001, 501] }];
   checkResult( dbcl, findCondition13, null, expRecs3, { No: 1 } );

   var findCondition14 = { $or: [{ a: { $lt: 1000 } }, { a: { $lt: 3000 } }, { a: { $lt: 2000 } }] };
   checkResult( dbcl, findCondition14, null, expRecs3, { No: 1 } );

   var findCondition15 = { $or: [{ a: { $lt: 2000 } }, { a: { $lt: 3000 } }, { a: { $lt: 1000 } }] };
   checkResult( dbcl, findCondition15, null, expRecs3, { No: 1 } );

   var findCondition16 = { $or: [{ a: { $lt: 2000 } }, { a: { $lt: 1000 } }, { a: { $lt: 3000 } }] };
   checkResult( dbcl, findCondition16, null, expRecs3, { No: 1 } );

   var findCondition17 = { $or: [{ a: { $lt: 3000 } }, { a: { $lt: 2000 } }, { a: { $lt: 1000 } }] };
   checkResult( dbcl, findCondition17, null, expRecs3, { No: 1 } );

   var findCondition18 = { $or: [{ a: { $lt: 3000 } }, { a: { $lt: 1000 } }, { a: { $lt: 2000 } }] };
   checkResult( dbcl, findCondition18, null, expRecs3, { No: 1 } );

   //lte
   var findCondition19 = { $or: [{ a: { $lte: 1000 } }, { a: { $lte: 2000 } }, { a: { $lte: 3000 } }] };
   ...
   var findCondition20 = { $or: [{ a: { $lte: 1000 } }, { a: { $lte: 3000 } }, { a: { $lte: 2000 } }] };
   checkResult( dbcl, findCondition20, null, expRecs4, { No: 1 } );

   var findCondition21 = { $or: [{ a: { $lte: 2000 } }, { a: { $lte: 1000 } }, { a: { $lte: 3000 } }] };
   checkResult( dbcl, findCondition21, null, expRecs4, { No: 1 } );

   var findCondition22 = { $or: [{ a: { $lte: 2000 } }, { a: { $lte: 3000 } }, { a: { $lte: 1000 } }] };
   checkResult( dbcl, findCondition22, null, expRecs4, { No: 1 } );

   var findCondition23 = { $or: [{ a: { $lte: 3000 } }, { a: { $lte: 2000 } }, { a: { $lte: 1000 } }] };
   checkResult( dbcl, findCondition23, null, expRecs4, { No: 1 } );

   var findCondition24 = { $or: [{ a: { $lte: 3000 } }, { a: { $lte: 1000 } }, { a: { $lte: 2000 } }] };
   checkResult( dbcl, findCondition24, null, expRecs4, { No: 1 } );

   //not
   //gt
   var findCondition1 = { $not: [{ a: { $gt: 1000 } }, { a: { $gt: 2000 } }, { a: { $gt: 3000 } }] };
   var expRecs1 = [{ No: 1, a: [500, 501, 502] }, { No: 2, a: [1000, 1001, 1002] }, { No: 3, a: [1500, 1501, 1502] },
   { No: 4, a: [2000, 2001, 2002] }, { No: 5, a: [2500, 2501, 2502] },
   { No: 8, a: [501, 1001, 2001] },
   { No: 11, a: { 0: 500, 1: 501, 2: 502 } }, { No: 12, a: { 0: 1000, 1: 1001, 2: 1002 } }, { No: 13, a: { 0: 1500, 1: 1501, 2: 1502 } },
   { No: 14, a: { 0: 2000, 1: 2001, 2: 2002 } }, { No: 15, a: { 0: 2500, 1: 2501, 2: 2502 } }, { No: 16, a: { 0: 3000, 1: 3001, 2: 3002 } },
   { No: 17, a: { 0: 3500, 1: 3501, 2: 3502 } }, { No: 18, a: { 0: 501, 1: 1001, 2: 2001 } }, { No: 19, a: { 0: 1001, 1: 2001, 2: 3001 } },
   { No: 20, a: { 0: 2001, 1: 3001, 2: 501 } },
   ...
   var findCondition2 = { $not: [{ a: { $gt: 1000 } }, { a: { $gt: 3000 } }, { a: { $gt: 2000 } }] };
   checkResult( dbcl, findCondition2, null, expRecs1, { No: 1 } );

   var findCondition3 = { $not: [{ a: { $gt: 2000 } }, { a: { $gt: 3000 } }, { a: { $gt: 1000 } }] };
   checkResult( dbcl, findCondition3, null, expRecs1, { No: 1 } );

   var findCondition4 = { $not: [{ a: { $gt: 2000 } }, { a: { $gt: 1000 } }, { a: { $gt: 3000 } }] };
   checkResult( dbcl, findCondition4, null, expRecs1, { No: 1 } );

   var findCondition5 = { $not: [{ a: { $gt: 3000 } }, { a: { $gt: 2000 } }, { a: { $gt: 1000 } }] };
   checkResult( dbcl, findCondition5, null, expRecs1, { No: 1 } );

   var findCondition6 = { $not: [{ a: { $gt: 3000 } }, { a: { $gt: 1000 } }, { a: { $gt: 2000 } }] };
   checkResult( dbcl, findCondition6, null, expRecs1, { No: 1 } );

   //gte
   var findCondition7 = { $not: [{ a: { $gte: 3000 } }, { a: { $gte: 2000 } }, { a: { $gte: 1000 } }] };
   ...
   var findCondition8 = { $not: [{ a: { $gte: 1000 } }, { a: { $gte: 2000 } }, { a: { $gte: 3000 } }] };
   checkResult( dbcl, findCondition8, null, expRecs2, { No: 1 } );

   var findCondition9 = { $not: [{ a: { $gte: 1000 } }, { a: { $gte: 3000 } }, { a: { $gte: 2000 } }] };
   checkResult( dbcl, findCondition9, null, expRecs2, { No: 1 } );

   var findCondition10 = { $not: [{ a: { $gte: 2000 } }, { a: { $gte: 1000 } }, { a: { $gte: 3000 } }] };
   checkResult( dbcl, findCondition10, null, expRecs2, { No: 1 } );

   var findCondition11 = { $not: [{ a: { $gte: 2000 } }, { a: { $gte: 3000 } }, { a: { $gte: 1000 } }] };
   checkResult( dbcl, findCondition11, null, expRecs2, { No: 1 } );

   var findCondition12 = { $not: [{ a: { $gte: 3000 } }, { a: { $gte: 1000 } }, { a: { $gte: 2000 } }] };
   checkResult( dbcl, findCondition12, null, expRecs2, { No: 1 } );

   //lt
   var findCondition13 = { $not: [{ a: { $lt: 1000 } }, { a: { $lt: 2000 } }, { a: { $lt: 3000 } }] };
   ...
   var findCondition14 = { $not: [{ a: { $lt: 1000 } }, { a: { $lt: 3000 } }, { a: { $lt: 2000 } }] };
   checkResult( dbcl, findCondition14, null, expRecs3, { No: 1 } );

   var findCondition15 = { $not: [{ a: { $lt: 2000 } }, { a: { $lt: 3000 } }, { a: { $lt: 1000 } }] };
   checkResult( dbcl, findCondition15, null, expRecs3, { No: 1 } );

   var findCondition16 = { $not: [{ a: { $lt: 2000 } }, { a: { $lt: 1000 } }, { a: { $lt: 3000 } }] };
   checkResult( dbcl, findCondition16, null, expRecs3, { No: 1 } );

   var findCondition17 = { $not: [{ a: { $lt: 3000 } }, { a: { $lt: 2000 } }, { a: { $lt: 1000 } }] };
   checkResult( dbcl, findCondition17, null, expRecs3, { No: 1 } );

   var findCondition18 = { $not: [{ a: { $lt: 3000 } }, { a: { $lt: 1000 } }, { a: { $lt: 2000 } }] };
   checkResult( dbcl, findCondition18, null, expRecs3, { No: 1 } );

   //lte
   var findCondition19 = { $not: [{ a: { $lte: 1000 } }, { a: { $lte: 2000 } }, { a: { $lte: 3000 } }] };
   var expRecs4 = [{ No: 3, a: [1500, 1501, 1502] },
   { No: 4, a: [2000, 2001, 2002] }, { No: 5, a: [2500, 2501, 2502] }, { No: 6, a: [3000, 3001, 3002] },
   { No: 7, a: [3500, 3501, 3502] }, { No: 9, a: [1001, 2001, 3001] },
   { No: 11, a: { 0: 500, 1: 501, 2: 502 } }, { No: 12, a: { 0: 1000, 1: 1001, 2: 1002 } }, { No: 13, a: { 0: 1500, 1: 1501, 2: 1502 } },
   { No: 14, a: { 0: 2000, 1: 2001, 2: 2002 } }, { No: 15, a: { 0: 2500, 1: 2501, 2: 2502 } }, { No: 16, a: { 0: 3000, 1: 3001, 2: 3002 } },
   ...
   var findCondition20 = { $not: [{ a: { $lte: 1000 } }, { a: { $lte: 3000 } }, { a: { $lte: 2000 } }] };
   checkResult( dbcl, findCondition20, null, expRecs4, { No: 1 } );

   var findCondition21 = { $not: [{ a: { $lte: 2000 } }, { a: { $lte: 1000 } }, { a: { $lte: 3000 } }] };
   checkResult( dbcl, findCondition21, null, expRecs4, { No: 1 } );

   var findCondition22 = { $not: [{ a: { $lte: 2000 } }, { a: { $lte: 3000 } }, { a: { $lte: 1000 } }] };
   checkResult( dbcl, findCondition22, null, expRecs4, { No: 1 } );

   var findCondition23 = { $not: [{ a: { $lte: 3000 } }, { a: { $lte: 2000 } }, { a: { $lte: 1000 } }] };
   checkResult( dbcl, findCondition23, null, expRecs4, { No: 1 } );

   var findCondition24 = { $not: [{ a: { $lte: 3000 } }, { a: { $lte: 1000 } }, { a: { $lte: 2000 } }] };
   checkResult( dbcl, findCondition24, null, expRecs4, { No: 1 } );
}
main();