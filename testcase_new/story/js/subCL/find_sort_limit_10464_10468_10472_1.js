...
function main()
{
   ...
   //attach subcl
   attachCL( dbcl, COMMCSNAME + "." + subCL_Name1, { LowBound:{a:-100},UpBound:{a:0} } );
   attachCL( dbcl, COMMCSNAME + "." + subCL_Name2, { LowBound:{a:0},UpBound:{a:100} } );
   attachCL( dbcl, COMMCSNAME + "." + subCL_Name3, { LowBound:{a:100},UpBound:{a:200} } );
   ...
   {
      throw buildException("find and sort data use limit", e );
   }
   ...
   {
      throw buildException("find and sort data use skip", e );
   }
