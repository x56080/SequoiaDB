...
function checkInsertSameSequence ( db, groupName, mainCL_Name, csName, subCL_Name1, subCL_Name2 )
{
   ...
   {
      throw buildException( "checkInsertSameSequence()", e, "insert data",
         "insert data success", "insert data fail" );
   }
   //检测插入的数据是否一致
...
function checkInsertDiffSequence ( db, groupName, mainCL_Name, csName, subCL_Name1, subCL_Name2 )
{
   ...
   {
      throw buildException( "checkInsertDiffSequence()", e, "insert data", "insert data success",
         "insert data fail" );
   }
   //检测插入的数据是否一致
   var expectDataArray1 = [];
