...
@input:    
         ...
         2 insert:
               ...
               ({total_exCount:i,exCount_id:i,tx_number:"testR"+i,tx_info:"hello/565bf18964f4f14fea84341b/image/20160101_1.png"}) ;
...
function insertRecs ( cl, csName, clName, number1, insertRecsNum )
{
   ...
   for( k = number1; k < insertRecsNum; k += 50000 )
   {
      ...
      for( i = 0 + k; i < 50000 + k; i++ )
      {
         doc.push( { total_exCount: i, exCount_id: i, tx_number: "testR" + i, tx_info: "hello/565bf18964f4f14fea84341b/image/20160101_1.png" } )
      };
      cl.insert( doc );
   }
}
...
function checkRecs ( cl, number1, insertRecsNum, checkRecsNum )
{
   ...
   println( '   ' + number1 + ' <= i < ' + insertRecsNum
      + ', recs: {total_exCount:i,exCount_id:i,tx_number:"testR"+i,tx_info:"hello/565bf18964f4f14fea84341b/image/20160101_1.png"}' );
   ...
   for( j = 0; j < checkRecsNum; j++ )
   {
      ...
      {
         var recsCnt = cl.find( { total_exCount: i, exCount_id: i, tx_number: "testR" + i, tx_info: "hello/565bf18964f4f14fea84341b/image/20160101_1.png" } ).count();
      }
