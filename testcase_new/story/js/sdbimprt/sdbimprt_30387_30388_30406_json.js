 ...
 * @LastEditors   : liuli
 ******************************************************************************/
testConf.clName = COMMCLNAME + "_30387_30388_json";
...
function test ( args )
{
   ...
   // 准备导入数据{ "_id": 1, "b": "aaa" }, {"_id": 2, "b": "bbb" }, { "_id": 4, "b": "fff" }
   var importData1 = '{ "_id": 1, "b": "aaa" }\n' + '{ "_id": 2, "b": "bbb" }\n' + '{ "_id": 4, "b": "fff" }\n';
...
{
   var filename = tmpFileDir + "30387_30388.json";
