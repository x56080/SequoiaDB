...
function testImprtCsv1( clName, cl )
{
   ...
   file.write( "null,null,null,null,null,null,null,null,null\n" );
   file.write( ", , , , , , , ,1\n" );
   ...
   cl.remove();
   cmd.run( command + " --fields='type1 int, type2 long, type3 double, type4 decimal, type5 number, type6 bool, type7 string, type8 null, type9 int' ");
   ...
   cl.remove();
   cmd.run( command + " --fields='type1 , type2 , type3 , type4 , type5 , type6 , type7 , type8, type9 ' ");
...
function testImprtCsv2( clName, cl )
{
   ...
   var command = installDir + "bin/sdbimprt" +
      ...
      " -l " + testConf.clName +
      " --type csv " + 
      "--fields='type1 timestamp, type2 date,date1 date' " +
      "--file " + filename;
