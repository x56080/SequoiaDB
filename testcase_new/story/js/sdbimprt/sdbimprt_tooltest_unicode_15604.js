/*******************************************************************************
*@Description:   seqDB-15604:导入文件编码含有Unicode格式的JSON文件数据，Unicode转义选项设置为true
...
function main ()
{
   try
   {
      ...
      var clName = COMMCLNAME + "_15604";
      var cl = readyCL( csName, clName );

      var imprtFile = tmpFileDir + "15604.json";
      readyData( imprtFile );
