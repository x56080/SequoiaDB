...
function importData ( csName, clName, imprtFile )
{
   ...
   var imprtOption = installDir + 'bin/sdbimprt -s ' + COORDHOSTNAME + ' -p ' + COORDSVCNAME
      + ' -c ' + csName + ' -l ' + clName
      + ' --type csv --fields "a int,v1 long" --cast true'
      + ' --file ' + imprtFile;
...
function checkCLData ( cl )
{
   ...
   var rc = cl.find( { v1: { $type: 1, $et: 18 } }, { _id: { $include: 0 } } ).sort( { a: 1 } );
   var recsArray = [];
   ...
   var expCnt = 6;
   var expRecs = '[{"a":1,"v1":-2147483649},{"a":2,"v1":2147483648},{"a":3,"v1":0},{"a":4,"v1":0},{"a":5,"v1":0},{"a":6,"v1":0}]';
