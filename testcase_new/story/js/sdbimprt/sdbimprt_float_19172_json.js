...
function main ()
{
   ...
   var expRecs = initExpectData_testPoint1();
   ...
   for( var i = 0; i < findTypeArr.length; i++ )
   {
      ...
      var expRecs = initExpectData_testPoint2( limitNum, findTypeArr[i] );
...
function initExpectData_testPoint1 ()
{
