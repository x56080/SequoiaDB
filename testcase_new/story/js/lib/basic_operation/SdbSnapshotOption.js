...
SdbSnapshotOption.prototype.hint=function(){try{return tmpSdbSnapshotOption.hint.apply(this,arguments);}catch(e){commThrowError(e);}};
SdbSnapshotOption.prototype.limit=function(){try{return tmpSdbSnapshotOption.limit.apply(this,arguments);}catch(e){commThrowError(e);}};
SdbSnapshotOption.prototype.options=function(){try{return tmpSdbSnapshotOption.options.apply(this,arguments);}catch(e){commThrowError(e);}};
SdbSnapshotOption.prototype.sel=function(){try{return tmpSdbSnapshotOption.sel.apply(this,arguments);}catch(e){commThrowError(e);}};
SdbSnapshotOption.prototype.skip=function(){try{return tmpSdbSnapshotOption.skip.apply(this,arguments);}catch(e){commThrowError(e);}};
SdbSnapshotOption.prototype.sort=function(){try{return tmpSdbSnapshotOption.sort.apply(this,arguments);}catch(e){commThrowError(e);}};
SdbSnapshotOption.prototype.toString=function(){try{return tmpSdbSnapshotOption.toString.apply(this,arguments);}catch(e){commThrowError(e);}};
