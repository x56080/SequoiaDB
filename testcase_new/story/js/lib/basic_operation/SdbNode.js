if ( tmpSdbNode == undefined )
{
   var tmpSdbNode = {
      ...
      setAttributes: SdbNode.prototype.setAttributes,
      setLocation: SdbNode.prototype.setLocation,
...
SdbNode.prototype.setAttributes=function(){try{return tmpSdbNode.setAttributes.apply(this,arguments);}catch(e){throw new Error(e);}};
SdbNode.prototype.setLocation=function(){try{return tmpSdbNode.setLocation.apply(this,arguments);}catch(e){throw new Error(e);}};
