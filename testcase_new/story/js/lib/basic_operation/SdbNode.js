...
SdbNode.prototype.getServiceName=function(){try{return tmpSdbNode.getServiceName.apply(this,arguments);}catch(e){commThrowError(e);}};
SdbNode.prototype.help=function(){try{return tmpSdbNode.help.apply(this,arguments);}catch(e){commThrowError(e);}};
SdbNode.prototype.start=function(){try{return tmpSdbNode.start.apply(this,arguments);}catch(e){commThrowError(e);}};
SdbNode.prototype.stop=function(){try{return tmpSdbNode.stop.apply(this,arguments);}catch(e){commThrowError(e);}};
SdbNode.prototype.toString=function(){try{return tmpSdbNode.toString.apply(this,arguments);}catch(e){commThrowError(e);}};
