...
SdbQueryOption.prototype.hint=function(){try{return tmpSdbQueryOption.hint.apply(this,arguments);}catch(e){commThrowError(e);}};
SdbQueryOption.prototype.limit=function(){try{return tmpSdbQueryOption.limit.apply(this,arguments);}catch(e){commThrowError(e);}};
SdbQueryOption.prototype.remove=function(){try{return tmpSdbQueryOption.remove.apply(this,arguments);}catch(e){commThrowError(e);}};
SdbQueryOption.prototype.sel=function(){try{return tmpSdbQueryOption.sel.apply(this,arguments);}catch(e){commThrowError(e);}};
SdbQueryOption.prototype.skip=function(){try{return tmpSdbQueryOption.skip.apply(this,arguments);}catch(e){commThrowError(e);}};
SdbQueryOption.prototype.sort=function(){try{return tmpSdbQueryOption.sort.apply(this,arguments);}catch(e){commThrowError(e);}};
SdbQueryOption.prototype.toString=function(){try{return tmpSdbQueryOption.toString.apply(this,arguments);}catch(e){commThrowError(e);}};
SdbQueryOption.prototype.update=function(){try{return tmpSdbQueryOption.update.apply(this,arguments);}catch(e){commThrowError(e);}};
