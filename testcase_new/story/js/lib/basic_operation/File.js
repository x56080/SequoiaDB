...
File._getPermission = function(){try{ return funcFile_getPermission.apply( this, arguments ); } catch( e ) { commThrowError(e) } };
File.chgrp = function(){try{ return funcFilechgrp.apply( this, arguments ); } catch( e ) { commThrowError(e) } };
File.chmod = function(){try{ return funcFilechmod.apply( this, arguments ); } catch( e ) { commThrowError(e) } };
File.chown = function(){try{ return funcFilechown.apply( this, arguments ); } catch( e ) { commThrowError(e) } };
File.copy = function(){try{ return funcFilecopy.apply( this, arguments ); } catch( e ) { commThrowError(e) } };
File.exist = function(){try{ return funcFileexist.apply( this, arguments ); } catch( e ) { commThrowError(e) } };
File.find = function(){try{ return funcFilefind.apply( this, arguments ); } catch( e ) { commThrowError(e) } };
File.getSize = function(){try{ return funcFilegetSize.apply( this, arguments ); } catch( e ) { commThrowError(e) } };
File.getUmask = function(){try{ return funcFilegetUmask.apply( this, arguments ); } catch( e ) { commThrowError(e) } };
File.help = function(){try{ return funcFilehelp.apply( this, arguments ); } catch( e ) { commThrowError(e) } };
File.isDir = function(){try{ return funcFileisDir.apply( this, arguments ); } catch( e ) { commThrowError(e) } };
File.isEmptyDir = function(){try{ return funcFileisEmptyDir.apply( this, arguments ); } catch( e ) { commThrowError(e) } };
File.isFile = function(){try{ return funcFileisFile.apply( this, arguments ); } catch( e ) { commThrowError(e) } };
File.list = function(){try{ return funcFilelist.apply( this, arguments ); } catch( e ) { commThrowError(e) } };
File.md5 = function(){try{ return funcFilemd5.apply( this, arguments ); } catch( e ) { commThrowError(e) } };
File.mkdir = function(){try{ return funcFilemkdir.apply( this, arguments ); } catch( e ) { commThrowError(e) } };
File.move = function(){try{ return funcFilemove.apply( this, arguments ); } catch( e ) { commThrowError(e) } };
File.remove = function(){try{ return funcFileremove.apply( this, arguments ); } catch( e ) { commThrowError(e) } };
File.scp = function(){try{ return funcFilescp.apply( this, arguments ); } catch( e ) { commThrowError(e) } };
File.setUmask = function(){try{ return funcFilesetUmask.apply( this, arguments ); } catch( e ) { commThrowError(e) } };
File.stat = function(){try{ return funcFilestat.apply( this, arguments ); } catch( e ) { commThrowError(e) } };
File._getFileObj = function(){try{ return funcFile_getFileObj.apply( this, arguments ); } catch( e ) { commThrowError(e) } };
File._readFile = function(){try{ return funcFile_readFile.apply( this, arguments ); } catch( e ) { commThrowError(e) } };
File._getPathType = function(){try{ return funcFile_getPathType.apply( this, arguments ); } catch( e ) { commThrowError(e) } };
File._getUmask = function(){try{ return funcFile_getUmask.apply( this, arguments ); } catch( e ) { commThrowError(e) } };
File._list = function(){try{ return funcFile_list.apply( this, arguments ); } catch( e ) { commThrowError(e) } };
File._find = function(){try{ return funcFile_find.apply( this, arguments ); } catch( e ) { commThrowError(e) } };
