...
SdbCursor.prototype.help=function(){try{return tmpSdbCursor.help.apply(this,arguments);}catch(e){commThrowError(e);}};
SdbCursor.prototype.next=function(){try{return tmpSdbCursor.next.apply(this,arguments);}catch(e){commThrowError(e);}};
SdbCursor.prototype.size=function(){try{return tmpSdbCursor.size.apply(this,arguments);}catch(e){commThrowError(e);}};
SdbCursor.prototype.toArray=function(){try{return tmpSdbCursor.toArray.apply(this,arguments);}catch(e){commThrowError(e);}};
SdbCursor.prototype.toString=function(){try{return tmpSdbCursor.toString.apply(this,arguments);}catch(e){commThrowError(e);}};
