...
SdbDomain.prototype.listCollectionSpaces=function(){try{return tmpSdbDomain.listCollectionSpaces.apply(this,arguments);}catch(e){commThrowError(e);}};
SdbDomain.prototype.listCollections=function(){try{return tmpSdbDomain.listCollections.apply(this,arguments);}catch(e){commThrowError(e);}};
SdbDomain.prototype.listGroups=function(){try{return tmpSdbDomain.listGroups.apply(this,arguments);}catch(e){commThrowError(e);}};
SdbDomain.prototype.removeGroups=function(){try{return tmpSdbDomain.removeGroups.apply(this,arguments);}catch(e){commThrowError(e);}};
SdbDomain.prototype.setAttributes=function(){try{return tmpSdbDomain.setAttributes.apply(this,arguments);}catch(e){commThrowError(e);}};
SdbDomain.prototype.setGroups=function(){try{return tmpSdbDomain.setGroups.apply(this,arguments);}catch(e){commThrowError(e);}};
SdbDomain.prototype.toString=function(){try{return tmpSdbDomain.toString.apply(this,arguments);}catch(e){commThrowError(e);}};
