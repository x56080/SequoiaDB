...
SdbOptionBase.prototype.hint=function(){try{return tmpSdbOptionBase.hint.apply(this,arguments);}catch(e){commThrowError(e);}};
SdbOptionBase.prototype.limit=function(){try{return tmpSdbOptionBase.limit.apply(this,arguments);}catch(e){commThrowError(e);}};
SdbOptionBase.prototype.sel=function(){try{return tmpSdbOptionBase.sel.apply(this,arguments);}catch(e){commThrowError(e);}};
SdbOptionBase.prototype.skip=function(){try{return tmpSdbOptionBase.skip.apply(this,arguments);}catch(e){commThrowError(e);}};
SdbOptionBase.prototype.sort=function(){try{return tmpSdbOptionBase.sort.apply(this,arguments);}catch(e){commThrowError(e);}};
SdbOptionBase.prototype.toString=function(){try{return tmpSdbOptionBase.toString.apply(this,arguments);}catch(e){commThrowError(e);}};
