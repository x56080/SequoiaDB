...
BSONArray.prototype.index=function(){try{return tmpBSONArray.index.apply(this,arguments);}catch(e){commThrowError(e);}};
BSONArray.prototype.more=function(){try{return tmpBSONArray.more.apply(this,arguments);}catch(e){commThrowError(e);}};
BSONArray.prototype.next=function(){try{return tmpBSONArray.next.apply(this,arguments);}catch(e){commThrowError(e);}};
BSONArray.prototype.pos=function(){try{return tmpBSONArray.pos.apply(this,arguments);}catch(e){commThrowError(e);}};
BSONArray.prototype.size=function(){try{return tmpBSONArray.size.apply(this,arguments);}catch(e){commThrowError(e);}};
BSONArray.prototype.toArray=function(){try{return tmpBSONArray.toArray.apply(this,arguments);}catch(e){commThrowError(e);}};
BSONArray.prototype.toString=function(){try{return tmpBSONArray.toString.apply(this,arguments);}catch(e){commThrowError(e);}};
