...
Remote.prototype.getFile=function(){try{return tmpRemote.getFile.apply(this,arguments);}catch(e){commThrowError(e);}};
Remote.prototype.getInfo=function(){try{return tmpRemote.getInfo.apply(this,arguments);}catch(e){commThrowError(e);}};
Remote.prototype.getIniFile=function(){try{return tmpRemote.getIniFile.apply(this,arguments);}catch(e){commThrowError(e);}};
Remote.prototype.getSystem=function(){try{return tmpRemote.getSystem.apply(this,arguments);}catch(e){commThrowError(e);}};
Remote.prototype.help=function(){try{return tmpRemote.help.apply(this,arguments);}catch(e){commThrowError(e);}};
Remote.prototype.toString=function(){try{return tmpRemote.toString.apply(this,arguments);}catch(e){commThrowError(e);}};
Remote.prototype.__runCommand=function(){try{return tmpRemote.__runCommand.apply(this,arguments);}catch(e){commThrowError(e);}};
