/************************************
*@Description: match MainCL sharding,use et/gt/gte/lt/lte/in/all
...
function main ()
{
   ...
   mainCL_Name = "maincl_11545";
   subCL_Name1 = "subcl1_11545";
   subCL_Name2 = "subcl2_11545";
   subCL_Name3 = "subcl3_11545";
   ...
   try
   {
      dbcl.attachCL( COMMCSNAME + "." + subCL_Name1, { LowBound: { a: -1000 }, UpBound: { a: 100 } } );
