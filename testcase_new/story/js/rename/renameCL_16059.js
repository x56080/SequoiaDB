...
function main ( db )
{
   try
   {
      ...
      println( "---test a: rename maincl, maincl is no subcl" )
...
{
   println( "---test b: rename maincl, maincl and subcl in same cs" );
...
{
   println( "---test c: rename maincl, maincl and subcl in diff cs" );
