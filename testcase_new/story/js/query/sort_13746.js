...
try
{
	varCL.insert( { a: { "$timestamp": "2000-01-01-01.01.01.100000" }, b: 2, c: "abcd" } );
	varCL.insert( { a: { "$timestamp": "2000-01-01-01.01.01.000001" }, b: 1, c: "efghi" } );
	varCL.insert( { a: { "$timestamp": "2011-11-30-17.04.01.123456" }, b: 4, c: "xyz" } );
	varCL.insert( { a: { "$timestamp": "2010-12-31-17.04.01.123456" }, b: 3, c: "jklmn" } );
} catch( e )
{
