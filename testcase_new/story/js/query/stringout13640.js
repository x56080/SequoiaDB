...
function main ()
{
    ...
    var rc1 = cl.find( {}, { Key: { $include: 1 } } ).sort( { Key: 1 } ).flags( 1 );
    ...
    var rc2 = cl.find( {}, { Key: { $include: 1 } } ).sort( { Key: -1 } ).flags( 1 );
    ...
    var rc3 = cl.find( {}, { Key: { $include: 1 } } ).sort( { _id: 1 } ).flags( 1 );
    ...
    var rc4 = cl.find( {}, { Key: { $include: 1 } } ).sort( { _id: -1 } ).flags( 1 );
