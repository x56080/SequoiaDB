...
function test ()
{
   ...
   // 查看集合空间快照信息
   var cursor1_1 = db.snapshot( SDB_SNAP_COLLECTIONSPACES, { Name: csName } );
   ...
   // 查看集合空间快照信息
   var cursor1_2 = db.snapshot( SDB_SNAP_COLLECTIONSPACES, { Name: csName } );
   ...
   // 查看集合空间快照信息
   var cursor1_3 = db.snapshot( SDB_SNAP_COLLECTIONSPACES, { Name: csName } );
   ...
   // 查看集合空间快照信息
   var cursor1_4 = db.snapshot( SDB_SNAP_COLLECTIONSPACES, { Name: newCsName } );
   ...
   // 查看集合空间快照信息
   var cursor1_5 = db.snapshot( SDB_SNAP_COLLECTIONSPACES, { Name: newCsName } );
   ...
   // 查看集合空间快照信息
   var cursor1_6 = db.snapshot( SDB_SNAP_COLLECTIONSPACES, { Name: newCsName } );
