...
function test(testPara)
{
   ...
   var expRecs1 = [{ no: 0, a: 0, fieldb: -21470, testc:"test0"},
   { no: 1, a: 1, fieldb: {$numberLong: "9223372036854775800"}, testc:"test1"},
   { no: 2, a: -234, a1: 20, fieldb: { num1: 20, num2: 0 }, fieldb1:{ num: {a: 12.01}}, testc:"test4"},
   { no: 3, a: -10.23, a1: 1203333, fieldb: ["test0", 10.23 ,[0, -123]], testc:"test5"},
   { testa1: -21470 }];
   ...
   var expRecs2 = [{ no: 0, a: 0, fieldb: -21470, testc:"test0"},
   { no: 1, a: 1, fieldb: {$numberLong: "9223372036854775800"}, testc:"test1"},
   { no: 2, a: -234, a1: 20, fieldb: { num1: 20, num2: 0 }, fieldb1:{ num: {a: 12.01}}, testc:"test4"},
   { no: 3, a: -10.23, a1: 1203333, fieldb: ["test0", 10.23 ,[0, -123]], testc:"test5"},
   { testa1: -21470 },
   { testa2: 20, testb2:12.01 ,fieldb: { num1: 20, num2: {a: 12.01} }}];
   ...
   var expRecs3 = [{ no: 0, a: 0, fieldb: -21470, testc:"test0"},
   { no: 1, a: 1, fieldb: {$numberLong: "9223372036854775800"}, testc:"test1"},
   { no: 2, a: -234, a1: 20, fieldb: { num1: 20, num2: 0 }, fieldb1:{ num: {a: 12.01}}, testc:"test4"},
   { no: 3, a: -10.23, a1: 1203333, fieldb: ["test0", 10.23 ,[0, -123]], testc:"test5"},
   { testa1: -21470 },
   { testa2: 20, testb2:12.01 ,fieldb: { num1: 20, num2: {a: 12.01} }},
   { testa3: 10.23, testb3:-123 ,field: ["test0", 10.23 ,[0, -123]]}];
