...
function main()
{
   ...
   //create subcl
   var subClOption1 = {ShardingKey:{"d":1}, ShardingType:"range", ReplSize:0}; 
   commCreateCLByOption( db, COMMCSNAME, subCL_Name1, subClOption1, true, true ); 
   
   var subClOption2 = {ShardingKey:{"d":-1}, ShardingType:"range", ReplSize:0}; 
   ...
   //in
   var findConf8 = {$and:[{a:{$in:[-1000, -501, 100, 1000, 1501, 2000]}}, 
   ...
   //nin
   var findConf9 = {$and:[{a:{$nin:[-1000, 2000, 151]}}, 
   {b:{$nin:[100, 2000, 151]}}, 
   {c:{$nin:[2000, 1000, 151]}}]}; 
   var expRecs9 = [//subcl1
   {a:-501, b:-501, c:-501, d:0}, 
