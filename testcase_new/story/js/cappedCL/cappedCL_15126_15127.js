...
function test ()
{
   ...
   //only _id, or-or   
   var ororObj = { $or: [{ $or: [{ _id: 0 }, { _id: { $gt: 1000000000 } }] }, { _id: { $et: 80 } }] }
   ...
   //only _id, or-not
   var ornotObj = { $or: [{ $not: [{ _id: { $gt: 0 } }, { _id: { $lt: 1000000000 } }] }, { _id: { $et: 80 } }] }
   ...
   //only _id, and-and-or
   var andandorObj = { $and: [{ $and: [{ _id: { $gte: 0 } }, { _id: { $in: [0, 100000] } }] }, { $or: [{ _id: 0 }, { _id: 80 }] }] }
   ...
   //only _id, not-and-or   
   var notandorObj = { $not: [{ $and: [{ _id: { $gt: 0 } }, { _id: { $lt: 1000000000 } }] }, { $or: [{ _id: { $gte: 80 } }] }] }
   ...
   var ornotObj = { $or: [{ $not: [{ _id: { $gte: 8000 } }, { a: { $isnull: 0 } }] }, { a: { $et: 100000 } }] }
