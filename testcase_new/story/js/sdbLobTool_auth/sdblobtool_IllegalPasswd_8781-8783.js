   ...
   try
   {
      ...
      catch( e )
      {
         ...
         if( errNumber == errCode )
            println( ">success to test export with illegal passwd." );
         else
         {
            println( ">fail to test export with illegal passwd. rc = " + errNumber );
            throw errNumber;
         }
      }
      ...
      catch( e )
      {
         var errNumber = getErr( e );
         if( errNumber == errCode )
            println( ">success to test import with illegal passwd." );
         else
         {
            println( ">fail to test import with illegal passwd. rc = " + errNumber );
            throw errNumber;
         }
      }
      ...
      catch( e )
      {
         var errNumber = getErr( e );
         if( errNumber == errCode )
            println( ">success to test migrate with illegal passwd." );
         else
         {
            println( ">fail to test migrate with illegal passwd. rc = " + errNumber );
            throw errNumber;
         }
      }

      println( ">success to test sdblobtool with illegal passwd.\n\n" );
   }
   catch( e )
   {
      println( ">fail to test sdblobtool with illegal passwd. rc = " + e + "\n\n" );
      throw e;
   }
   finally
   {
...
catch( e )
{
   ...
   cmd.run( "mv sdblobtool.log /tmp/lobtool/illegalPasswd.log" );
   throw e;
}
finally
{
