/******************************************************************************
 * @Description   : seqDB-31579:创建全文索引指定映射为double类型，插入索引字段类型为不兼容转换类型
...
testConf.clName = COMMCLNAME + "31579";
...
function test ( testPara )
{
   ...
   var idxName = "idx_31579";
   dbcl.createIndex( idxName, {
      no: "text", tobj: "text", tarr: "text", tbool: "text", tdate: "text", ttime: "text"
   }, {
      "Mappings": {
         "Fields": {
            "no": { "Type": "double" }, "tobj": { "Type": "double" }, "tarr": { "Type": "double" },
            "tbool": { "Type": "double" }, "tdate": { "Type": "double" }, "ttime": { "Type": "double" }
         }
      }
   } );
