/******************************************************************************
 * @Description   : seqDB-31571 :: 创建全文索引指定映射为text类型，插入索引字段类型为不兼容转换类型
 * @Author        : wu yan 
...
testConf.clName = COMMCLNAME + "_es_31571";
...
function test ( testPara )
{
   ...
   var indexName = "index_31571";
   dbcl.createIndex( indexName, { tobj: "text", tarr: "text" }, { "Mappings": { "Fields": { "tobj": { "Type": "text" }, "tarr": { "Type": "text" } } } } );
