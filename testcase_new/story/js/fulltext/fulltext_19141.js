/************************************
*@Description: 单键全文索引，更新数组为数组元素部分为string的数组
*@author:      liuxiaoxuan
*@createdate:  2019.08.15
*@testlinkCase: seqDB-19141
**************************************/
function main ()
{
   if( commIsStandalone( db ) ) { return; }

   var clName = COMMCLNAME + "_ES_19141";
   ...
   var textIndexName = "textIndex_19141";
   dbcl.createIndex( textIndexName, { "a": "text" } );

   // 更新全文索引字段为多个数组元素(部分为string)的记录
   dbcl.update( { "$set": { a: ["updated 1", 1.11] } }, { a: { "$exists": 1 } } );
