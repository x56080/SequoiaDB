   ...
   try
   {
      ...
      for( var i = 0; i < recordsArr.length; i++ )
      {
         ...
         if( decimalStr.length > Number( indexStr ) )
         {
            ...
            //println( "newIntStr = " + newIntStr + ", newDecimalStr = " + newDecimalStr + "\nnumStr = " + numStr );
         }
...
function exceptInavalidZero ( numStr )
{
   try
   {
      ...
      //println( "tmpIntStr = " + tmpIntStr + ", tmpDecimalStr = " + tmpDecimalStr );
      ...
      //println( "symbol = " + symbol + ", tmpIntStr = " + tmpIntStr );
