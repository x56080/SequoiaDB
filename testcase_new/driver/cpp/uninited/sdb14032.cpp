/**************************************************************
 * @Description: use sdb without init
 *               seqDB-14032:sdb对象未创建时调用方法
...
class sdb14032 : public testBase
{
protected:
   void SetUp()
   {
...
TEST_F( sdb14032, opDb )
{
   // test all function of sdb expect connect disconnect getLastAliveTime
   ...
   EXPECT_EQ( FALSE, db.isValid() ) << "isValid should be FALSE" ;
