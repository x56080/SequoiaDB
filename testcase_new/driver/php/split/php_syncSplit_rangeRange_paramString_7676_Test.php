...
@input:        1 createCL 
               2 insert records
               3 syncSplit, range, cover all parameter, $condition/$endcondition: string
...
class SyncSplitOper04 extends BaseOperator 
{  
   ...
   {
      $rc = $clDB -> splitAsync( $groupNames[0], $groupNames[1], '{a:50}', '{a:100}' );
