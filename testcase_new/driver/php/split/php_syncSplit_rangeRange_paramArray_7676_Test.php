...
@input:        1 createCL 
               2 insert records
               3 syncSplit, range, cover all parameter, $condition/$endcondition: array
...
class SyncSplitOper02 extends BaseOperator 
{  
...
class TestSyncSplit02 extends PHPUnit_Framework_TestCase
{
