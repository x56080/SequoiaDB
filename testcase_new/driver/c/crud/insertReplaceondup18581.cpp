...
const char* csName = "insertReplaceOnDup18581Cs" ;
const char* clName = "insertReplaceOnDup18581Cl" ;
...
TEST( insertReplaceOnDup18581, uniqueIndex )
{
	   int rc = SDB_OK ;
    // setup
	   rc = setUp() ;
...
TEST( insertReplaceOnDup18581, noIndex )
{
    int rc = SDB_OK ;
    // setup
	   rc = setUp() ;
