...
class clParaVerify : public testing::Test
{
protected:
   const CHAR* csName ;
   const CHAR* clName ;
...
TEST_F( clParaVerify, getDataBlocks )
{
   ...
   // rc = sdbGetDataBlocks( NULL, NULL, NULL, NULL, NULL, 0, -1, &cursor ) ; // core dump
...
TEST_F( clParaVerify, getQueryMeta )
{
   ...
   sdbCursorHandle cursor ;
   // rc = sdbGetQueryMeta( NULL, NULL, NULL, NULL, 0, -1, &cursor ) ;  // core dump
   // ASSERT_EQ( SDB_INVALIDARG, rc ) ;
...
TEST_F( clParaVerify, updateUpsert )
{
   ...
   // no need to test
   // test sdbUpdate, no handle check in 2.8 ?
   /*
...
TEST_F( clParaVerify, attachDetach )
{
   ...
   // ASSERT_EQ( SDB_INVALIDARG, rc ) ;
   // rc = sdbAttachCollection( cs, clFullName, &option ) ;  // core dump
   // ASSERT_EQ( SDB_CLT_INVALID_HANDLE, rc ) ;
...
TEST_F( clParaVerify, lob )
{
   ...
   // test sdbTruncateLob
   // sdbTruncateLob not exist in 2.8
}
