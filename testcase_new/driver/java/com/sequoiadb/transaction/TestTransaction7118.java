...
public class TestTransaction7118 extends SdbConfTestBase{
    ...
    public void setUp() {
        ...
        try {
            ...
            System.out.println("Sequoiadb driver TestTransaction7118 setUp error, error description:" + e.getMessage());
            Assert.fail("Sequoiadb driver TestTransaction7118 setUp error, error description:" + e.getMessage());
        }
    }
    ...
    public void testTrans7118() {
        ...
        try {
            ...
            System.out.println("Sequoiadb driver TestTransaction7118 testTrans7118 error, error description:" + e.getMessage());
            Assert.fail("Sequoiadb driver TestTransaction7118 testTrans7118 error, error description:" + e.getMessage());
        }
    }
