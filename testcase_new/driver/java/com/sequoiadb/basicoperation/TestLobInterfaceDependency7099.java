...
/**
* FileName: TestLobInterfaceDependency7099.java
* test lob interfaces dependency:
* 1.read lob after create lob,the result is fail
* 2.write lob after open lob,the result is fail
* 3.write lob after seek lob,the result is fail
* @author wuyan
    * @Date    2016.9.23
* @version 1.00
*/
