...
/**
* FileName: TimestampParameterValidation10341.java* 
* test interface:
* BSONTimestamp (int time, int inc),getTime ()
* TestLink: seqDB-10341:time and inc parameters validation
* @author wuyan
    * @Date    2016.10.13
* @version 1.00
*/
public class TimestampParameterValidation10341 extends SdbTestBase{
	...
	public void insertDatas(int seconds,int inc) {
		try{
	        ...
	        tmpCursor.close();
	        Assert.assertEquals(actRecs.equals(obj),true,"check datas are unequal\n"+"actDatas: "
