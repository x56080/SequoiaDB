...
/**
 * Created by laojingtang on 17-4-7.
 * 覆盖的测试用例：11322
 * 测试点：Binary.equals() Binary.hashCode ()
 */
public class BinaryTest11322 extends SdbTestBase {
    ...
    public void setUp() {
        ...
        try {
            ...
            assertTrue(false, "connect %s failed," + SdbTestBase.coordUrl + e.getMessage());
        }
        createCL();
    }
    ...
    private void createCL() {
        ...
        try {
            ...
            assertTrue(false, "create cl fail " + e.getErrorType() + ":" + e.getMessage());
        }
    }
    ...
    public void testBinary() {
        ...
        BSONObject obj1 = cl.query(null, (BSONObject) JSON.parse("{binary1:\"\"}"), null, null).getNext();
        BSONObject obj2 = cl.query(null, (BSONObject) JSON.parse("{binary2:\"\"}"), null, null).getNext();
        BSONObject obj3 = cl.query(null, (BSONObject) JSON.parse("{binary3:\"\"}"), null, null).getNext();
