...
/**
* FileName: TimestampParameterCheck10342.java* 
* test interface:
* BSONTimestamp (int time, int inc),getTime ()
* TestLink: seqDB-10342:time and inc parameters check,verify the illegal value
* @author wuyan
    * @Date    2016.10.13
* @version 1.00
*/
public class TimestampParameterCheck10342 extends SdbTestBase{
	...
	/**
	*sequoiadb define time range:1902-01-01-00.00.00.000000~2037-12-31-23.59.59.999999,
	*convert seconds is:-2145945600~2145887999
	*/
	...
	/**
	*test beyond the timestamp of sequaoidb boundary value,number type not int type 
	*after the actual value is inserted into the sequaoidb
	*/
	...
	*/
	...
	/*public void testIllegalType() {
		try{
			BSONTimestamp timestamp = new BSONTimestamp((Integer) null,(Integer) null);
