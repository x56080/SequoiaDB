...
/**
* FileName: TestSSL11314
* test interface:setUseSSL(boolean useSSL)/getUseSSL()
* operating steps:
*    1.sequoaidb configuration must open SSL connect
*    2.call setUseSSL(boolean useSSL) to set SSL to true
*    3.create cs/cl，insert data
*    4.intercepted coord port message，view the message transfer to ciphertext（manual test）
*    5.test getUseSSL()
* @author wuyan
    * @Date    2017.4.7
* @version 1.00
