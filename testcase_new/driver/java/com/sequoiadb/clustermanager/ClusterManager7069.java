...
/**
* @TestLink: seqDB-7069
* @describe:detach and attach node use interfaces as follow:
* 			1.detachNode()
* 			2.attachNode()
* @author zhaoyu
* @Date   2016.10.8
...
public class ClusterManager7069 extends SdbTestBase{
	...
	public void test(){
		...
		try{
			...
			Assert.fail("attachNode "+ dataPortAdd1 + " failed" + e.getMessage());
		}
		Assert.assertNotNull(dataRGAdd2.getNode(coordIP + ":" + dataPortAdd1), "node " + dataPortAdd1 + 
				" not exists in " + dataRGName2 + " ,but expect result is attach!");
