...
/**
 * @FileName:TestProcedure7121,7122
 * crtJSProcedure (String code);rmProcedure (String name);
...
public class TestProcedure7121 extends SdbTestBase{
    ...
    public void testJSProcedure() {
        ...
        try {
            DBCursor dbCursor =  this.sdb.listProcedures((BSONObject) JSON.parse("{\"name\":\"sum_7121\"}"));
            ...
            cursor.close();
            this.sdb.rmProcedure("sum_7121");
            DBCursor cur =  this.sdb.listProcedures((BSONObject) JSON.parse("{\"name\":\"sum_7121\"}"));
            int count = 0;
            while (cur.hasNext()) {
                cur.getNext();
                count++;
    ...
    public void testEvalWithWrongName() {
        ...
        try {
            ...
            Assert.assertNull(cursor, "Sequoiadb driver TestProcedure7121 testEval no function sum_7121");
            Sequoiadb.SptReturnType retType = null;
            retType = evalResult2.getReturnType();
            Assert.assertNull(retType, "Sequoiadb driver TestProcedure7121 testEval no function sum_7121");
    ...
    public void testEvalJS() {
        ...
        testEvalWithReturnType(code, evalCode, Sequoiadb.SptReturnType.TYPE_STR);
