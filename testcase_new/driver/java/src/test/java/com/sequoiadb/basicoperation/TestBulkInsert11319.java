...
/**
 * FileName: TestBulkInsert11319.java test interface:insert (List< BSONObject >
 * insertor, int flag) and test flag values:FLG_INSERT_CONTONDUP,0
 * 
 * @author wuyan
 * @Date 2017.4.7
 * @version 1.00 modified by wangkexin 2019.4.18
 */
public class TestBulkInsert11319 extends SdbTestBase {
    private String clName = "cl_11319";
    ...
    /**
     * test insert (List< BSONObject > insertor, int flag) set
     * flag=FLG_INSERT_CONTONDUP,FLG_INSERT_REPLACEONDUP
     */
    private void bulkInsertContOnDup() {
        try {
            ...
            cl.insert( partialConflictList, DBCollection.FLG_INSERT_CONTONDUP );
            ...
            // insert again with flag FLG_INSERT_CONTONDUP
            cl.insert( totalConflictList, DBCollection.FLG_INSERT_CONTONDUP );
            checkResult( expRecordList );
            cl.delete( "" );

        } catch ( BaseException e ) {
            Assert.assertTrue( false,
                    "bulk insert with flag FLG_INSERT_CONTONDUP fail "
    ...
    /**
     * test insert (List< BSONObject > insertor, int flag) set flag=0
     */
    ...
    /**
     * test insert (List< BSONObject > insertor, int flag) set flag=1/-1,ignore
     * flag value
     */
