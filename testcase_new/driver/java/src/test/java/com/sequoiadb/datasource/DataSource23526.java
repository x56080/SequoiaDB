...
/**
 * @descreption seqDB-23526:recv buffer小于等于CacheLimit的连接回池
 * @author ZhangYanan
 * @date 2021/12/01
...
public class DataSource23526 extends DataSourceTestBase {
    private SequoiadbDatasource ds = null;
    private Sequoiadb sdb;
    private CollectionSpace cs;
    private DBCollection cl;
    private ObjectId lobID;
    private String clName = "cl_23526";
    ...
    // 问题单SEQUOIADBMAINSTREAM-6853未标记3.2版本情况，暂时屏蔽改用例，问题单处理完成后放开
    @Test(enabled = false)
