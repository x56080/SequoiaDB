...
class Snapshot_22899(testlib.SdbTestBase):
   ...
   def test_snapshot_22899(self):
       sel = {"mongroupmask":"", "transactionon":"", "transactiontimeout":"", "transisolation":"", "translockwait":"",
              "transautocommit":"", "transautorollback":"", "transuserbs":"", "transreplsize":"", "transrccount":""}
       ...
       if testlib.is_standalone():
           ...
           original_conf = self.get_snapshot_result( SDB_SNAP_CONFIGS, condition = {"NodeName": self.node_name}, selector = sel)[0]

       try:
           configuration = {"mongroupmask": "all:detail", "transautocommit": "false", "transisolation": 2, "transactiontimeout": 3, "translockwait": "true" }
   ...
   def verify_snapshot_queries(self):
       ...
       expectation = ["NodeID", "StartTimestamp", "EndTimestamp", "TID", "OpType", "Name", "QueryTimeSpent", "ReturnNum", "TotalMsgSent", "LastOpInfo", "MsgSentTime", "RemoteNodeWaitTime", "ClientInfo", "RelatedNode"]
       for i in filedType:
           if i not in expectation:
   ...
   def verify_snapshot_lockwaits(self):
       ...
       filedType = list(result[0].keys())
       expectation = ["NodeName", "WaiterTID", "RequiredMode", "CSID", "CLID", "ExtentID", "Offset", "StartTimestamp", "TransLockWaitTime", "LatestOwner", "LatestOwnerMode", "NumOwner"]
       for i in filedType:
           if i not in expectation:
