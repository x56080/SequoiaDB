...
namespace engine
{
   ...
   INT32 _dmsIndexStat::pushMCVSet ( const BSONObj &boValue, double fraction )
   {
      ...
      fraction = CLS_STAT_ROUND_SELECTIVITY( fraction ) *
                 CLS_STAT_FRACTION_SCALE ;
      // Round to integer
   ...
   INT32 _dmsIndexStat::evalRangeOperator ( clsStatKey &startKey,
                                            clsStatKey &stopKey,
   ...
   INT32 _dmsIndexStat::evalETOperator ( clsStatKey &key,
                                         double &predSelectivity,
                                         double &scanSelectivity ) const
   {
      INT32 rc = SDB_OK ;
   ...
   INT32 _dmsIndexStat::evalGTOperator ( clsStatKey &startKey,
                                         double &predSelectivity,
                                         double &scanSelectivity ) const
   {
      INT32 rc = SDB_OK ;
   ...
   INT32 _dmsIndexStat::evalLTOperator ( clsStatKey &stopKey,
                                         double &predSelectivity,
                                         double &scanSelectivity ) const
   {
      INT32 rc = SDB_OK ;
   ...
   INT32 _dmsIndexStat::_evalOperator ( clsStatKey *pStartKey,
                                        clsStatKey *pStopKey,
                                        double &predSelectivity,
                                        double &scanSelectivity ) const
   {
