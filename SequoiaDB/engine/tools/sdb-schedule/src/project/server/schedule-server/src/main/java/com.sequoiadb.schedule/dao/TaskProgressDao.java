/*******************************************************************************
   ...
   Source File Name = TaskProgressDao.java
...
public interface TaskProgressDao {
    ...
    MetaCursor listTaskProgress(String taskId) throws Exception;

    void updateTaskProgress(String taskId, String clName, long successRecordNum,
            long failedRecordNum, long transferRecordSize, long successLobNum, long failedLobNum,
            long transferLobSize) throws Exception;

    void saveTaskProgress(BSONObject taskProgress);
