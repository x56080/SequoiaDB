/*******************************************************************************
   ...
   Source File Name = QuartzCleanJob.java
...
public class QuartzCleanJob extends QuartzSdbScheduleJob{
    @Override
    protected TaskEntity createTaskEntity(ServerNodeEntity runTaskServer,
            ScheduleJobInfo info) throws ScheduleServerException {
        CleanJobInfo cInfo = (CleanJobInfo) info;
        Date d = new Date();
        String taskId = UUID.randomUUID().toString();
        return QuartzScheduleTools.createTask(ScheduleDefine.TaskType.CLEAN, taskId,
