/*******************************************************************************
   ...
   Source File Name = ScheduleNotLeaderAction.java
...
public class ScheduleNotLeaderAction implements NotLeaderAction {
    ...
    public void run() {
        ...
        TaskStatusMgr.getInstance().clear();
        logger.info("################not leader done#######################");
    }
}
