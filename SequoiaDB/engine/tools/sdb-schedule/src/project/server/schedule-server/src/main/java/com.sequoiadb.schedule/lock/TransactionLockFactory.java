/*******************************************************************************
   ...
   Source File Name = TransactionLockFactory.java
...
public class TransactionLockFactory {
    ...
    public TransactionLock create(String lockKey, String lockValue) {
        return new TransactionLock(transactionLockDao, transactionFactory, lockKey, lockValue);
    }
}
