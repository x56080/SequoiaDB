...
public interface Timer {
    void schedule(TimerTask task, long delayInMillionSecond, long periodInMillionSecond);

    void schedule(TimerTask task, long delayInMillionSecond);

    boolean cancelAndAwaitTermination(long timeout) throws InterruptedException;

    void schedule(TimerTask task, Date firstTime, long periodInMillionSecond);
