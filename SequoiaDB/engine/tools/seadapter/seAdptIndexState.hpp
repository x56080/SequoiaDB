...
namespace seadapter
{
   ...
   protected:
      ...
      INT32 _rebuildRecordEle( const BSONElement &ele, BSONObjBuilder& builder, BOOLEAN &found ) ;

      INT32 _rebuildRecordEle( const BSONElement &ele, BSONArrayBuilder& builder, BOOLEAN &found ) ;
