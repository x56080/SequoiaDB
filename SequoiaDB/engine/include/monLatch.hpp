...
{
   MON_LATCH_DMSCB_STATEMTX = 1,                      /// used
   MON_LATCH_DMSSB_PERSIST_LATCH,
   MON_LATCH_DMSSB_COMMIT_LATCH,
   MON_LATCH_DMSSDC_LATCHCONTEXT,                     /// used
   MON_LATCH_DPSTRANSCB_MAPMUTEX,                     /// used
   MON_LATCH_DPSTRANSCB_CBMAPMUTEX,                   /// used
   MON_LATCH_DPSTRANSCB_LSNMAPMUTEX,                  /// used
   MON_LATCH_DPSTRANSCB_HISMUTEX,                     /// used
   MON_LATCH_RTNCB_MUTEX,
   MON_LATCH_MBLOCK,                                  /// used
   ...
   MON_LATCH_DMSSTORAGELOB_DELAYOPENLATCH,            /// used
   MON_LATCH_DPSARCHIVEINFOMGR_MUTEX,
   MON_LATCH_DPSARCHIVEMGR_MUTEX,
   MON_LATCH_DPSREPLICALOGMGR_MTX,                    /// used
   MON_LATCH_DPSREPLICALOGMGR_WRITEMUTEX,             /// used
   ...
   MON_LATCH_OPTCACHEDPLANACTIVITY_LATCH,             /// used
   MON_LATCH_OPTACCESSPLANMANAGER_REINITLATCH,        /// used
   ...
   MON_LATCH_SCHEDTASKMGR_LATCH,                      /// used
   ...
   MON_LATCH_SDB_DMSCB_MUTEX,                         /// used
   MON_LATCH_DMSSTORAGEBASE_SEGMENTLATCH,
   MON_LATCH_DMSSTORAGEDATACOMMON_METADATALATCH,      /// used
   MON_LATCH_DMSSYSSUMGR_MUTEX,
   MON_LATCH_OLDVERSIONCB_OLDVERSIONCBLATCH,
   MON_LATCH_NETEHSEGMENT_MTX,                        /// used
   MON_LATCH_NETFRAME_SUITEMTX,                       /// used
   MON_LATCH_NETFRAME_MTX,                            /// used
   ...
   MON_LATCH_DPSLOGPAGE_MTX,                          /// used
   MON_LATCH_DPSTRANSLOCKMANAGER_RWMUTEX,
   MON_LATCH_NETEVENTSUIT_RWMUTEX,
   MON_LATCH_NETFRAME_SUITEEXITMUTEX,                 /// used
   MON_LATCH_OPTCACHEDPLANMONITOR_CLEARLOCK,          /// used
...
public:
   ...
   INT32  getNumOwner() { return numXOwner ; }
