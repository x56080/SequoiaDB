...
enum MSG_TYPE
{
   ...
   MSG_BS_LOB_PUT_REQ                  = 8011,
   MSG_BS_LOB_PUT_RES                  = MAKE_REPLY_TYPE( MSG_BS_LOB_PUT_REQ ),
   MSG_LOB_END                         = 8999,
...
typedef enum _MSG_ROUTE_SERVICE_TYPE
{
   ...
   MSG_ROUTE_REPL_SERVICE_CTRL,     /// Repl service, for repl control message
