...
enum MSG_TYPE
{
   ...
   MSG_CAT_QUERY_COLLECTIONS_REQ       = 3002,
   MSG_CAT_QUERY_COLLECTIONS_RSP       = MAKE_REPLY_TYPE(MSG_CAT_QUERY_COLLECTIONS_REQ),
   MSG_CAT_QUERY_COLLECTIONSPACES_REQ  = 3003,
   MSG_CAT_QUERY_COLLECTIONSPACES_RSP  = MAKE_REPLY_TYPE(MSG_CAT_QUERY_COLLECTIONSPACES_REQ),
