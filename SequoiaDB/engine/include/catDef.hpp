...
#define CAT_SCHEMA_COLLECTION             CAT_SYS_SPACE_NAME".SYSSCHEMAS"
...
#define CAT_SCHEMA_NAME_IDX               "{name:\"SYSIDX1\",key:{"\
                                          FIELD_NAME_NAME":1}, unique: true, enforced: true }"
#define CAT_SCHEMA_COLLECTION_IDX         "{name:\"SYSIDX2\",key:{"\
