...
namespace engine
{
   ...
   #define OPT_FIELD_SCANRATE             "ScanRate"
   #define OPT_FIELD_LIMITRATE            "LimitRate"
   #define OPT_FIELD_HITRATIO             "HitRatio"
   #define OPT_FIELD_STARTIOCOST_RATIO    "StartIOCostRatio"
   #define OPT_FIELD_STARTCPUCOST_RATIO   "StartCPUCostRatio"
   ...
   #define OPT_FIELD_IS_EVAL_START_COST   "IsEvalStartCost"
