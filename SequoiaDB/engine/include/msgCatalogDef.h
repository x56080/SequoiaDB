...
#define CAT_LOCATION_NAME                 FIELD_NAME_NODE_LOCATION
#define CAT_LOCATIONS_NAME                FIELD_NAME_NODE_LOCATIONS
#define CAT_LOCATIONID_NAME               FIELD_NAME_NODE_LOCATIONID
...
#define CAT_ENGINE_TYPE                   FIELD_NAME_ENGINE_TYPE
...
#define CAT_CATALOG_CONSISTENCYSTRATEGY   FIELD_NAME_CONSISTENCY_STRATEGY
...
#define CAT_NOTRANS                       FIELD_NAME_NOTRANS
#define CAT_REPAIRCHECK                   FIELD_NAME_REPARECHECK
...
#define CAT_GLOBAL_INDEX                  FIELD_NAME_GLOBAL_INDEX
#define CAT_GIDX_CL_UNIQUEID              FIELD_NAME_CL_UNIQUEID
#define CAT_GIDX_INDEXNAME                FIELD_NAME_NAME

#define CAT_ENSURE_CS_IS_EMPTY            FIELD_NAME_ENSURE_EMPTY
...
#define CAT_INVALID_LOCATIONID            MSG_INVALID_LOCATIONID
#define CAT_NODE_LOCATION_ID_BEGIN        MSG_LOCATION_ID_BEGIN
#define CAT_NODE_LOCATION_ID_END          MSG_LOCATION_ID_END
