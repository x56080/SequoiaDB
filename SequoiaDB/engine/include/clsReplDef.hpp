/*******************************************************************************
   ...
   Source File Name = clsReplDef.hpp
   ...
   ====== =========== === ==============================================
          ...
          09/01/2019  HGM Copied from clsDef.hpp

   Last Changed =

*******************************************************************************/
#ifndef CLS_REPL_DEF_HPP_
#define CLS_REPL_DEF_HPP_
...
namespace engine
{
   ...
   typedef class _clsGroupBeat clsGroupBeat ;
    ...
    */
   class _clsSharingStatus : public utilPooledObject
   {
   public:
      _clsGroupBeat beat ;
      UINT32 timeout ;
   ...
   typedef class _clsSharingStatus clsSharingStatus ;
   typedef map< UINT64, clsSharingStatus >   CLS_NODE_MAP ;
   typedef map< UINT64, clsSharingStatus * > CLS_ALIVE_MAP ;
   ...
   public:
      ...
      {
         CLS_NODE_MAP::iterator it = info.begin() ;
         while ( it != info.end() )
         {
      ...
      {
         CLS_NODE_MAP::iterator it = info.find( nodeID ) ;
   ...
   typedef class _clsGroupInfo clsGroupInfo ;

   /*
      _clsSyncSession define
    */
   ...
   /*
      _ICLReplAgent predefine
    */
   class _ICLSReplAgent ;
   typedef class _ICLSReplAgent ICLSReplAgent ;

}

#endif // CLS_REPL_DEF_HPP_
