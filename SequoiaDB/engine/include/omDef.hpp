...
//********************************** OLD **************************************
   ...
   */
   ...
   #define REST_VALUE_FLAG_UPDATE_ONE              "SDB_UPDATE_ONE"
   #define REST_VALUE_FLAG_DELETE_ONE              "SDB_DELETE_ONE"
   ...
   #define REST_VALUE_FLAG_INSERT_CONTONDUP        "SDB_INSERT_CONTONDUP"
   #define REST_VALUE_FLAG_INSERT_RETURNNUM        "SDB_INSERT_RETURNNUM"
   #define REST_VALUE_FLAG_INSERT_REPLACEONDUP     "SDB_INSERT_REPLACEONDUP"
   #define REST_VALUE_FLAG_INSERT_CONTONDUP_ID     "SDB_INSERT_CONTONDUP_ID"
   #define REST_VALUE_FLAG_INSERT_REPLACEONDUP_ID  "SDB_INSERT_REPLACEONDUP_ID"
