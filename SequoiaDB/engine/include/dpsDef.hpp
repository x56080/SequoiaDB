...
#define DPS_VESSEL_LOG_FLAG_OP_HEAD     (0x02)
#define DPS_VESSEL_LOG_FLAG_OP_TAIL     (0x04)
#define DPS_VESSEL_LOG_FLAG_LAST_LSN_IS_INVALID (0x08)
#define DPS_VESSEL_LOG_FLAG_DDL          (0x10)
...
enum DPS_LOG_TYPE
{
   ...
   ///vessel log types
   LOG_TYPE_VESSEL_SMP_ALLOCATE = 0x400,
   LOG_TYPE_VESSEL_REMAP_LPID = 0x401,
   LOG_TYPE_VESSEL_UPDATE_CS_META = 0x402,
   LOG_TYPE_VESSEL_UPDATE_CL_RECORD = 0x403,
   LOG_TYPE_VESSEL_UPDATE_ROUTE_PAGE = 0x404,
} ;
