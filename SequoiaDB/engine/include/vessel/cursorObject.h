/*******************************************************************************
   ...
   Source File Name = cursorObject.h
...
#ifndef VESSEL_CURSOR_OBJECT_H_
#define VESSEL_CURSOR_OBJECT_H_
...
namespace vessel
{
   ...
   class cursorObject : public SDBObject
   {
      public:
         cursorObject():
         _flags(0),
