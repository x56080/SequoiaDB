...
#define DMS_CHANGESTATE_WAIT_LOOP 100
   ...
   */
...
#endif
      typedef ossPoolMap< utilCSUniqueID, dmsStorageUnitID >::const_iterator CSCB_ID_MAP_CONST_ITER;
   ...
   private:
      ...
      INT32 _CSCBRename( const CHAR *pName, const CHAR *pNewName, _pmdEDUCB *cb, SDB_DPSCB *dpsCB );
   ...
   public:
      ...
      virtual INT32 getCLCount( IExecutor *executor, const CHAR *csName, UINT32 &count ) override;
   ...
   public:
      ...
      INT32 returnCollectionSpaceP1( dmsReturnOptions &options, _pmdEDUCB *cb, SDB_DPSCB *dpsCB );
      INT32 returnCollectionSpaceP1Cancel( dmsReturnOptions &options,
                                           _pmdEDUCB *cb,
                                           SDB_DPSCB *dpsCB );
      INT32 returnCollectionSpaceP2( dmsReturnOptions &options, _pmdEDUCB *cb, SDB_DPSCB *dpsCB );
