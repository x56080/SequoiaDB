...
namespace engine
{
   ...
   */
   ...
   #define DPS_TRANS_ALLOWLOCKESCALATION_DFT TRUE
   #define DPS_TRANS_MAXLOCKNUM_MIN       ( -1 )
   #define DPS_TRANS_MAXLOCKNUM_MAX       OSS_SINT32_MAX
   #define DPS_TRANS_MAXLOCKNUM_DFT       ( 10000 )
   ...
   */
   ...
   #define TRANS_CONF_MASK_ALLOWLOCKESCALATION 0x00000080
   #define TRANS_CONF_MASK_MAXLOCKNUM        0x00000100
   #define TRANS_CONF_MASK_MAXLOGSPACERATIO  0x00000200
