...
#define FIELD_NAME_TOTALTASKS                "TotalTasks"
#define FIELD_NAME_SUCCEEDTASKS              "SucceededTasks"
#define FIELD_NAME_FAILTASKS                 "FailedTasks"
...
#define FIELD_NAME_PROCESSED_SIZE            "ProcessedSize"
