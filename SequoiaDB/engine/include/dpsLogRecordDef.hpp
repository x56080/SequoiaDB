...
/// number in public can not be used in definition !
   ...
   enum DPS_LOG_CLCRT
   {
      ...
      /// DPS_LOG_CLCRT_COMPRESS_TYPE
      /// DPS_LOG_CLCRT_CLUNIQUEID
      DPS_LOG_CLCRT_VESSEL_CL_INFO = 5,
   ...
   enum DPS_LOG_VESSEL_IMP_REMAP
   {
      ...
      DPS_LOG_VESSEL_IMP_REMAP_OLD = 5,/// old slots when remap
   };//enum DPS_LOG_VESSEL_NEW_PAGE2

   enum DPS_LOG_VESSEL_CSGP_UPDATE
   {
      //DPS_LOG_PUBLIC_VESSEL_GPID
      DPS_LOG_VESSEL_CSGP_UPDATE_DDL_TYPE = 1,
      DPS_LOG_VESSEL_CSGP_UPDATE_MASK = 2,
      DPS_LOG_VESSEL_CSGP_UPDATE_OLD = 3,
      DPS_LOG_VESSEL_CSGP_UPDATE_NEW = 4,
      DPS_LOG_VESSEL_CSGP_UPDATE_ADJUNCTS = 5,
   };

   enum DPS_LOG_VESSEL_CL_RECORD_UPDATE
   {
      //DPS_LOG_PUBLIC_VESSEL_GPID
      DPS_LOG_VESSEL_CL_RECORD_UPDATE_DDL_TYPE = 1,
      DPS_LOG_VESSEL_CL_RECORD_UPDATE_MASK = 2,
      DPS_LOG_VESSEL_CL_RECORD_UPDATE_OLD = 3,
      DPS_LOG_VESSEL_CL_RECORD_UPDATE_NEW = 4,
      DPS_LOG_VESSEL_CL_RECORD_UPDATE_ADJUNCTS = 5,
   };

   enum DPS_LOG_VESSEL_UPDATE_ROUTE_PAGE
   {
      //DPS_LOG_PUBLIC_VESSEL_GPID.
      DPS_LOG_VESSEL_UPDATE_ROUTE_PAGE_LPID = 1,
      DPS_LOG_VESSEL_UPDATE_ROUTE_PAGE_OLD_HEAD = 2,
      DPS_LOG_VESSEL_UPDATE_ROUTE_PAGE_NEW_HEAD = 3,
      DPS_LOG_VESSEL_UPDATE_ROUTE_PAGE_NEW_VALUES = 4,
   };
   ...
   enum DPS_LOG_VESSEL_RDP_INSERT
   {
      ...
      DPS_LOG_VESSEL_RDP_INSERT_UNIQUEID = 7,
