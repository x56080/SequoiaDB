...
[^_^]:
     本文使用的所有引用及连接
[SDB_SNAP_TRANSDEADLOCK]:database_management/monitoring/snapshot/SDB_SNAP_TRANSDEADLOCK.md
[SDB_SNAP_TRANSWAITS]:database_management/monitoring/snapshot/SDB_SNAP_TRANSWAITS.md
[forceSession]:reference/Sequoiadb_command/Sdb/forceSession.md
[sscDeadlock0]:database_management/DeadlockDetector/sscDeadlock0.png
[sscDeadlock1]:database_management/DeadlockDetector/sscDeadlock1.png
[sscDeadlock2]:database_management/DeadlockDetector/sscDeadlock2.png
