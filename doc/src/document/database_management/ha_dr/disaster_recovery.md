...
SequoiaDB 提供的容灾方案有：[同城双中心](database_management/ha_dr/twodatacenter.md)、[同城三中心](database_management/ha_dr/threedatacenter.md)、[两地三中心](database_management/ha_dr/twocity_threedatacenter.md)和[三地五中心](database_management/ha_dr/threecity_fivedatacenter.md)。