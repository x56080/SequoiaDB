...
数据库实例模块则作为协议与语法的适配层，用户可根据需要创建包括 MySQL、PostgreSQL与 SparkSQL 在内的结构化数据实例；支持 JSON 语法的 MongoDB 实例；以及完全兼容 S3 与 Posix 文件系统的对象存储实例。
...
[logical_arch]:Manual/SequoiaDB_Intro/overall_arch_logical.png
[engine_arch]:Manual/SequoiaDB_Intro/overall_arch_engine.png
[all_arch]:Manual/SequoiaDB_Intro/overall_arch_all.png