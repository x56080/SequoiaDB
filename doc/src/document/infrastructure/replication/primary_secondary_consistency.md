...
![强一致性示意图](infrastructure/replication/consistency0.png)
...
![写活跃节点示意图](infrastructure/replication/consistency_alive.png)
...
![写主节点示意图](infrastructure/replication/consistency1.png)
...
为了尽量保证数据的安全性，又兼顾高可用性，用户可以将 ReplSize 设为多数派。对数据一致性要求较高的业务，如影像内容管理平台和在线交易服务平台等，推荐使用写多数派的最终一致性策略。

![写多数派示意图](infrastructure/replication/consistency2.png)
...
修改一致性策略
----
用户可以通过 [db.setAttributes()](reference/Sequoiadb_command/SdbCS/setAttributes.md) 修改 ReplSize 属性。
