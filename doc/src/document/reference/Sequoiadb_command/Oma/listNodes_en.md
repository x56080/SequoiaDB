...
- options ( *object, optional* )
    ...
    - showalone ( *boolean* )：Whether to display the sdbcm node information started in [standalone mode](reference/Sequoiadb_command/Oma/start.md), and the default is false.
...
- filter ( *object, optional* )
    ...
    Specify the conditions for filtering node information. It supports to retrieve the node information through [matching symbol](reference/operator/match_operator/overview.md) $and, $or, $not or exact match.
