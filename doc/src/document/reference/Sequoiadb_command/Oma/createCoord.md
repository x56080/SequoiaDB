...
* 通过该接口创建的 coord 节点并不会注册到 catalog 中，即该 coord 节点不能被集群管理。若希望 coord 节点能够被集群管理，需要使用[createNode()](reference/Sequoiadb_command/SdbReplicaGroup/createNode.md)接口来创建 coord 节点。
