...
- flags ( *object，选填* )
    ...
    指定标志位遍历结果集，具体用法可参考 [flags()](reference/Sequoiadb_command/SdbQuery/flags.md)。
...
- 使用[全文检索语法](basic_operation/text_search/text_search_grammer.md)查询集合 "bar" 中的 "about" 字段包含 "rock climbing" 的记录。
