...
When the exception happens，use [getLastErrMsg()](reference/Sequoiadb_command/Global/getLastError.md) to get the error message or use [getLastError()](reference/Sequoiadb_command/Global/getLastErrMsg.md) to get the error code. For more details, refer to [Troubleshooting](troubleshooting/general/general_guide.md).
