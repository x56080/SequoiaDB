...
|---------|--------|----------------|-----------------|
| listType | Enumerate | [List type](database_management/monitoring/list/list.md)| Required 	   |
| cond     | Json      | Match condictions and [position parameter](reference/Sequoiadb_command/location.md). | Not 	   |
...
>* For the value of the listType,refer to [ListType](database_management/monitoring/list/list.md).
