...
- name ( *string, required* )
    ...
    - Collection space name, users can refer to [limitation](reference/Sequoiadb_limitation.md) for naming restrictions.
...
- options ( *object, optional* )
    ...
    > - For specific usage scenarios of parameters DataSource and Mapping, refer to the [data source](infrastructure/datasource.md).
