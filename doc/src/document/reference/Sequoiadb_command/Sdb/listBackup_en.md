...
When the function executes successfully, it will return a detailed list of collections through the cursor.Users can refer to [$LIST_BACKUP](reference/SQL_grammar/monitoring/LIST_BACKUP.md) to get the returned field information.
