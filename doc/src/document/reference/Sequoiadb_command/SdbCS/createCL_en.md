...
- name ( *string, required* )
    ...
    - Refer to [Restrictions](reference/Sequoiadb_limitation.md#集合) for restrictions on collections and collection naming.
...
- options ( *object, optional* )
    ...
    - AutoIncrement ( *object* ): Self-increment field, function introduction can refer to [Auto-increment field](data_model/auto_increment.md).
    ...
    - Mapping ( *string* ): The name of the mapped collection.
        ...
        >**Note:**
        >
        > For the specific usage scenarios of the parameters "DataSource" and "Mapping", refer to [Data Source](infrastructure/datasource.md).
