...
> 2. 启用 SSL 连接之前需要先设置数据库配置项 --usessl=true ，请参考[配置项参数](database_management/database_configuration/configuration_parameters.md)。

##返回值##

函数执行成功：返回 [Sdb](reference/Sequoiadb_command/Sdb/Sdb.md) 对象。
