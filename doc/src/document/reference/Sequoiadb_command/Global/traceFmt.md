...
| -189   | SDB_PD_TRACE_FILE_INVALID | 输入的文件不是 trace 日志 | 检查输入的文件是否为 [traceOff()](reference/Sequoiadb_command/Sdb/traceOff.md) 导出的 trace 日志 |
...
>**Note:**
>
> 如果需要查看当前程序的跟踪状态，可参考 [traceStatus()](reference/Sequoiadb_command/Sdb/traceStatus.md)。
