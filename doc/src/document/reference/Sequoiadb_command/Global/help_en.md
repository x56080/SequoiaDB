...
1. Show the global help information.

	```lang-javascript
	> help()
 	```

2. Show the all the methods of a classs.
...
3. Show the all the methods of an object.
...
4. Show the manpage of the specified method.
...
5. Show the manpage of the specified method in a class or an object.

	```lang-javascript
	> var db = new Sdb()
	> db.foo.help("createCL") // or SdbCS.help("createCL")
