...
| -189   | SDB_PD_TRACE_FILE_INVALID | The input file is not a trace log | Check whether the input file is [traceOff()](reference/Sequoiadb_command/Sdb/traceOff.md) exported trace log. |
...
>**Note:**
>
> If users want to view the trace status of the current program, refer to [traceStatus()](reference/Sequoiadb_command/Sdb/traceStatus.md).
