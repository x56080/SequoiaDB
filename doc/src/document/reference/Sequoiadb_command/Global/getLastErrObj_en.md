...
1. Get the error object of last operation. When the error occurs on a data node, the error object returned contains the description of the ErrNodes field.
