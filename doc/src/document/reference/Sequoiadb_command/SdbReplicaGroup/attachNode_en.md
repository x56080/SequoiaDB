...
Add a node that has been created but does not belong to any group to the current group. Can be used with [rg.detachNode()](reference/Sequoiadb_command/SdbReplicaGroup/detachNode_en.md).
