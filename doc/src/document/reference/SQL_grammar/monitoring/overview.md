...
| [$SNAPSHOT_TRANSWAIT](reference/SQL_grammar/monitoring/SNAPSHOT_TRANSWAITS.md) | [SDB_SNAP_TRANSWAITS](database_management/monitoring/snapshot/SDB_SNAP_TRANSWAITS.md) | 事务等待快照 | 事务等待快照可以列出数据库中因锁等待而产生的事务等待信息 |
