...
该参数可以配置 MySQL 会话进行读操作时，优先选择的 SequoiaDB 节点，取值规则参考[PreferedInstance](reference/Sequoiadb_command/Sdb/setSessionAttr.md) 参数说明。
...
该参数可以配置多个节点符合 sequoiadb_preferred_instance 条件时，节点的选择模式，取值可参考[PreferedInstanceMode](reference/Sequoiadb_command/Sdb/setSessionAttr.md) 参数说明。
