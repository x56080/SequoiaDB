 ...
 * 创建实例
   ...
   ```lang-bash
   $ sdb_mysql_ctl addinst myinst -D /opt/sequoiasql/mysql/database/3306/ -l /opt/sequoiasql/mysql/database/3306/myinst.log --print -p 3306 -f /opt/sequoiasql/mysql/database/3306/myinst.pid -s /opt/sequoiasql/mysql/database/3306/myinst.sock -w 123456 
   ```
...
**修改实例的配置**
 ...
 用户可通过 sdb_mysql_ctl 修改指定实例的 SequoiaDB 引擎配置，各配置项说明可参考 SequoiaDB [引擎配置][config]。
