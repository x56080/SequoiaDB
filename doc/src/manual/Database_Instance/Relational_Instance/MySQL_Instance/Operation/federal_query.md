...
11. 在 MySQL 中指定关键词 /*+sql_pushdown=spark*/ 进行联邦

    ```lang-sql
    mysql> select /*+sql_pushdown=spark*/ count(*) as num from test.test_m9 a, test.test_i9 b, test.test_c9 c where a.customer_no = b.customer_no and b.customer_no = c.cust_no;
    ```
