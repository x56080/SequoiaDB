...
枚举列表，列表是一种轻量级得到当前系统状态的命令。查看更多有关[列表信息](manual/Manual/List/list.md)。

##参数描述##

| 参数名   | 参数类型    | 描述   													| 是否必填 |
|----------|-------------|----------------------------------------------------------|----------|
| listType | 枚举        | [列表类型](manual/Manual/List/list.md)。| 是 	   |
...
>* listType 字段的值请参考[列表类型](manual/Manual/List/list.md)。
