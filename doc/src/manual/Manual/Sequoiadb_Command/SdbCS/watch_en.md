...
watch - Subscribe the change stream of the collection space

##SYNOPSIS##

**SdbCS.watch( [token], [options] )**
...
This function is used to subscribe the change stream of the collection space.
...
var cursor = db.foo.watch(token, options);
