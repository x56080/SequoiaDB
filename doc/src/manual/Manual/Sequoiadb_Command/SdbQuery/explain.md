...
| Location       | BSON 对象        | 表示对访问计划的结果按照数据组进行过滤，使用命令位置参数项。<br>Location 选项仅支持 "GroupID" 和 "GroupName" 选项。<br>详细见 **[命令位置参数](manual/Manual/Sequoiadb_Command/location.md)**。<br>如果 Location 选项显式设置，Detail 选项自动设置为 true。 | 空 |
