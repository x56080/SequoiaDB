...
Set the keywords to search in search().

##PARAMETERS##

| Name      | Type     | Default | Description     | Required or not |
| -------- | -------- | ------ | --------------- | -------- |
| keyword  | string   | ---    | Keyword search in the log | yes       |
...
* Search logs containing the word 'failed', limiting the results to 10.

    ```lang-javascript
    > diaglog.search().keypattern( 'failed' ).limit( 10 )
