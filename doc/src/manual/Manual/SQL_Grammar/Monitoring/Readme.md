...
| [$SNAPSHOT_TRANSWAITS][SNAPSHOT_TRANSWAITS] | [SDB_SNAP_TRANSWAITS][SDB_SNAP_TRANSWAITS] | 事务等待快照 | 事务等待快照可以列出数据库中因锁等待而产生的事务等待信息 |
...
[SNAPSHOT_TRANSWAITS]:manual/Manual/SQL_Grammar/Monitoring/SNAPSHOT_TRANSWAITS.md
