...
- 核心交易型业务：为保证数据安全性，并且可以牺牲写入性能时，推荐使用强一致性策略
...
[repl_election]:manual/infrastructure/Replication/election.md
[primary_secondary_consistency]:manual/infrastructure/Replication/primary_secondary_consistency.md
