...
2. 创建一个新的数据节点
   ...
   > **Note:** 
   >
   > host、service、dbpath 和 config 的设置请参考[新增数据复制组][add_group]。
...
[snapshot]:manual/Maintainance/Monitoring/snapshot/SDB_SNAP_COLLECTIONS.md
[env_requirement]:manual/installation/system/system_requirement.md
[data_node]:manual/infrastructure/Node/data_node.md
[catalog_node]:manual/infrastructure/Node/catalog_node.md
...
[add_group]:manual/Maintainance/Expand/add_node.md
[sharding]:manual/infrastructure/Sharding/architecture.md#分区方式
