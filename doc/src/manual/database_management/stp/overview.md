...
> * 全局逻辑时钟服务可以提供全局事务的支持，请参考[事务操作](manual/Distributed_Engine/Architecture/Transactions/configurations.md)
...
> **Note:**
>
> * 详细请参考[STP的配置参数](database_management/stp/tools/stp.md#参数说明)
