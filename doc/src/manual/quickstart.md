...
- 安装 SequoiaSQL，询问安装 sequoiasql-mysql or [sequoiasql-postgresql](manual/Database_Instance/Relational_Instance/PostgreSQL_Instance/Operation/install_deploy.md)，分别用 1 和 2 表示，默认是 1，回车安装 sequoiasql-mysql
...
## SequoiaDB 巨杉数据库Demo体验



为方便用户快速上手，SequoiaDB 巨杉数据库提供一个互动体验 Demo，包括数据库快速安装和部署，使用已部署的数据库进行MySQL实例的创建及操作等，[点此快速体验](http://www.sequoiadb.com/cn/university-demo)。
