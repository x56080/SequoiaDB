...
2. 在【配置服务】页面，可以修改 MariaDB实例的配置，点击 **下一步** 按钮开始安装
...
2. 在弹窗填写参数后点击 **确定** 按钮
 ...
 ![关联服务][mariadb_sdb_3]
   ...
   >
   > - 关联名：创建关联完成后的名字，全局唯一   
   > - preferedinstance：指定 SequoiaSQL-mariadb 访问 SequoiaDB 数据节点时，优先连接哪种角色的数据节点，默认为’a’，可输入参数 m/s/a/1~7，分别表示 master/slave/anyone/node1~node7   
