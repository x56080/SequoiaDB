...
本章将向用户介绍以下内容：
- [权限资源和操作][privilege_resource_actions]：RBAC机制中的权限、资源和操作介绍
- [内建角色][builtin_roles]：内建角色介绍
- [用户自定义角色][user_defined_roles]：如何创建用户自定义角色
- [角色管理][manager_users_and_roles]：如何管理用户和角色
...
[manager_users_and_roles]:manual/Distributed_Engine/Maintainance/Security/Role_Based_Access_Control/manager_users_and_roles.md
