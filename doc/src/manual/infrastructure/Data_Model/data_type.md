...
[^_^]:
    本文使用到的所有内部链接及引用：
[data_mode_data_type_decimal]:manual/infrastructure/Data_Model/data_type.md#高精度数类型
[data_mode_data_type_oid]:manual/infrastructure/Data_Model/data_type.md#对象ID类型
[data_mode_data_type_date]:manual/infrastructure/Data_Model/data_type.md#日期类型
[data_mode_data_type_timestamp]:manual/infrastructure/Data_Model/data_type.md#时间戳类型
[data_mode_data_type_binary]:manual/infrastructure/Data_Model/data_type.md#二进制类型
[data_mode_data_type_regex]:manual/infrastructure/Data_Model/data_type.md#正则表达式类型
[data_mode_data_type_object]:manual/infrastructure/Data_Model/data_type.md#对象类型
[data_mode_data_type_array]:manual/infrastructure/Data_Model/data_type.md#数组类型
