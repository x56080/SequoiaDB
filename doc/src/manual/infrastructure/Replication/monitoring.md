...
[^_^]:
    本文使用到的所有链接及引用。
[health]:manual/Maintainance/Monitoring/snapshot/SDB_SNAP_HEALTH.md
[primary]:manual/infrastructure/Replication/architecture.md#主节点
[fullsync]:manual/infrastructure/Replication/architecture.md#全量同步
[backup_offline]:manual/Maintainance/Backup_Recovery/regular_bar.md
[replicalog]:manual/infrastructure/Replication/architecture.md#事务日志
[heartbeat]:manual/infrastructure/Replication/election.md#节点心跳
[slave]:manual/infrastructure/Replication/architecture.md#备节点
[syncstrategy]:manual/database_management/database_configuration/configuration_parameters.md
[replicalog]:manual/infrastructure/Replication/architecture.md#事务日志
[replicalog]:manual/infrastructure/Replication/architecture.md#事务日志
[resetSnapshot]:manual/reference/Sequoiadb_command/Sdb/resetSnapshot.md
