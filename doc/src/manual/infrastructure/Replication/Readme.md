...
[^_^]:
    本文使用到的所有链接及引用。
[node]:manual/infrastructure/Node/readme.md
[data]:manual/infrastructure/Node/data_node.md
[catalog]:manual/infrastructure/Node/catalog_node.md
[replica_set]:images/infrastructure/Replication/replica_set.png
[architecture]:manual/infrastructure/Replication/architecture.md
[election]:manual/infrastructure/Replication/election.md
[create]:manual/infrastructure/Replication/create.md
[consistency]:manual/infrastructure/Replication/primary_secondary_consistency.md
[monitor]:manual/infrastructure/Replication/monitoring.md
