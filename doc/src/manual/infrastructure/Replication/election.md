...
[^_^]:
    本文使用到的所有链接及引用。
[heartbeat]:images/infrastructure/Replication/heartbeat.png
[vote]:images/infrastructure/Replication/vote.png
[head_split]:images/infrastructure/Replication/head_split.png
