/*******************************************************************************
   ...
   Source File Name = SdbHiveOutputFormat.java
...
public class SdbHiveOutputFormat implements OutputFormat<NullWritable, BytesWritable>,
	...
	@Override
	public FSRecordWriter getHiveRecordWriter(JobConf jobConf, Path finalOutPath,
		...
		return (FSRecordWriter) new SdbWriter(ConfigurationUtil.getDBAddr(jobConf),
				spaceName,
				colName, 
