...
final class SdbConstants {
    ...
    final static String FIELD_NAME_TOKEN = "Token";
    final static String FIELD_NAME_COLLECTION_SPACES = "CollectionSpaces";
    final static String FIELD_NAME_COLLECTIONS = "Collections";
    final static String FIELD_NAME_CURRENT_LSN = "CurrentLSN";
    final static String FIELD_NAME_OFFSET = "Offset";

    // version of token
    final static int STREAM_TOKEN_VERSION_0 = 0;
    final static int STREAM_TOKEN_VERSION_CUR = STREAM_TOKEN_VERSION_0;

    // type of token
    // token generated by change record (LSN)
    final static int  STREAM_TOKEN_TYPE_CHANGE = 1;
}
