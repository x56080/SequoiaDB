...
public class ReplicaGroup {
	...
	public Node getMaster() throws BaseException {
        ...
        if (primaryData == null) {
            throw new BaseException("SDB_CLS_NODE_NOT_EXIST", "no information about the primary node");
        }
	...
	public Node getSlave() throws BaseException {
        ...
        if (slaves.size() != 0) {
            ...
            throw new BaseException("SDB_CLS_NODE_NOT_EXIST", "no information about the slave node");
        }
