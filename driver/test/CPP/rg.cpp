...
TEST_F( replicaGroupTest, detachNode )
{
   ...
   sdbNode node ;
   // detach node 
   rc = rg.detachNode( pNodeHostName2, pNodeSvcName2, BSON("KeepData" << false) ) ;
   ...
   // attach node
   rc = rg.attachNode( pNodeHostName2, pNodeSvcName2, BSON("KeepData" << false) ) ;
