/*******************************************************************************
   ...
   Source File Name = BaseExceptionTest.java
    ...
    public void TestFormalExceptionAPI() {
        try {
            try {
                ...
                throw new BaseException("SDB_SYS", "this is a test message", e);
            }
        } catch (BaseException e) {
            ...
            System.out.println("error stack: ");
            e.printStackTrace();
            Assert.assertEquals(Helper.getErrorCode("SDB_SYS"), e.getErrorCode());
