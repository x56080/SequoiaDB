/*******************************************************************************
   ...
   Source File Name = ConstantsInsert.java
...
public class ConstantsInsert {
	...
	public  static List<BSONObject> createRecordList(long listSize) {
	...
	public  static void insertVastRecord(String host, int port, String csName, String clName, int pageSize, long num) {
		try {
			Sequoiadb sdb;
			CollectionSpace cs;
			DBCollection cl;
...
//			obj.put("_id",id) ;
	...
	public  static void insertRecords(DBCollection cl, long num) throws BaseException {
		try {
			// check arg
            if ( null == cl || num <= 0 )
