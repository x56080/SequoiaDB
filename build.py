...
def package_db(opt_mgr, ver):
   ...
   dirs = ['bin', 'conf/samples', 'conf/local', 'conf/log', 'doc', 'include', 'java/jdk',
            ...
            'tools/sequoias3', 'tools/sequoias3/java', 'tools/sequoiafs', 'tools/diaglog', 'web','www', 'spark',
   ...
   if OS_ARCH != 'aarch64':
      copy_file(os.path.join(ROOT_DIR, 'driver/java7/target/sequoiadb*.jar'), os.path.join(install_dir, 'java'))
...
def main():
   ...
   compile_base_mgr.download_jdk('jdk7')
