...
def package_db(opt_mgr, ver):
   ...
   copy_file(os.path.join(ROOT_DIR, 'conf/samples/stp.conf'), os.path.join(install_dir, 'conf/stp'))
   os.rename(os.path.join(install_dir, 'conf/stp/stp.conf'), os.path.join(install_dir, 'conf/stp/stp.conf.samples'))
   ...
   setcap(os.path.join(install_dir, 'bin/stpstart'))
   setcap(os.path.join(install_dir, 'bin/stp'))
