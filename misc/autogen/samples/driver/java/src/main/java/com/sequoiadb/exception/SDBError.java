...
public enum SDBError {
    ...
    SDB_OUT_OF_BOUND(                        -259,    "Arguments are out of bound"    ),
    ...
    SDB_AUTOINCREMENT_FIELD_CONFLICT(        -332,    "Autoincrement field conflicts on collection"    ),
    ...
    SDB_DMS_CS_RENAMING(                     -337,    "Renaming the collection space is in progress"    ),
    SDB_CLS_DATA_NOT_SYNC(                   -338,    "Data not yet synchronized"    ),
    SDB_IXM_KEY_NOTNULL(                     -339,    "Any field of index key should exist and cannot be null"    );
    ...
    public static SDBError getSDBError(int errorCode) {
        ...
        case  -332: return SDB_AUTOINCREMENT_FIELD_CONFLICT;
        ...
        case  -337: return SDB_DMS_CS_RENAMING;
        case  -338: return SDB_CLS_DATA_NOT_SYNC;
        case  -339: return SDB_IXM_KEY_NOTNULL;
        default:    return null;
        }
    }
}
