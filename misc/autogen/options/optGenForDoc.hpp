...
#define OPT_SUPPLEMENT_FILE_PATH    DOCUMENT_PATH"Manual/Database_Configuration/configuration_parameters_supplement.md"
#define OPT_RUNTIME_CONFIG_PATH     DOCUMENT_PATH"Manual/Database_Configuration/configuration_parameters.md"
