/*******************************************************************************
   ...
   Source File Name = sdblicense.py
   ...
   ====== =========== === ==============================================
          11/05/2019  Xu Jianhui  Initial Draft
...
LICENSE = '''   Licensed under the Apache License, Version 2.0 (the "License");
   ...
   limitations under the License.
'''
COPYRIGHT = "   Copyright (C) 2011-Present SequoiaDB Ltd.\n"
BLANK_LINE = "\n"
...
def process_file(file_path):
    ...
    if suffix.lower() in CXX_FILE_SUFFIX:
        ...
        if license in [LICENSE_AGPL, LICENSE_UNKNOWN]:
