...
function showHelpInfo()
{
   ...
   echo "$0 --help"
   echo "$0 [-p path]|[-f file] [-t type] [-s stopFlag] [-n svcname] [-h hostname] [-eh eshost] [-en essvcname] [-dh dshost] [-dn dssvcname] [-sh stphostname] [-sn stpsvcname] [-s1] [-s2] [-sp] [-addpid] [-print]"
   echo ""
