...
<!-- tree menu -->
        <div class="emenu_nav">
            <ul id="list">
				...
				?>
				<li class="level1">
					<img src="../images/gooddb.png" width="15px"><a href="right_group.php?order=selectgroup&groupname=<?php echo $arr['GroupName'];?>" target="right" class="par"><?php echo $arr['GroupName'];?></a>
				</li>
				<?php
						}
						else
				...
				?>
                <li class="level1">
					<img src="../images/deldb.png" width="15px"><a href="right_group.php?order=selectgroup&groupname=<?php echo $arr['GroupName'];?>" target="right" class="par"><?php echo $arr['GroupName'];?></a>
				</li>
                <?php
						}
					}
