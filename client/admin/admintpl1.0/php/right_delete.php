/*******************************************************************************
   ...
   Source File Name = right_delete.php
...
<div class="topb">
	<div class="path">
		...
		?>
         ...
         --> <a href="#" class="pathlink"><img src="../images/db.png" width="15px">&nbsp;删除数据</a>
	</div>
	<div class="clear"></div>
...
if ( $arr_1  != "" )
{
	...
	else
	{
		...
		echo '<img src="../images/icons/exclamation.png" width="15px" border="0"> 数据删除失败 错误码: '.$arr_1['errno'] ;
		php_div_e_3();
	}
}
if ( $str != "" )
...
<div style="width:<?php echo $width-206;?>px;margin-top:20px;">
    <div>
        <form action="right_delete.php" method="get" class="send">
		...
		if ( $csname != "" && $clname != "" )
		{
			$temp_str = $temp_str."<b>".$csname.".".$clname."</b> 中删除数据" ;
		}
        php_div_s_1($width-250,150,$temp_str,"margin-top:15px;margin-left:15px;");
        ?>
        <div style="padding:12px;">
            <table width="500" border="0" cellpadding="0" cellspacing="7">
              ...
              <tr>
                <td></td>
                <td><div align="right"><input name="" type="submit" value=" 删 除 " /></div></td>
              </tr>
            </table>
        </div>
        <?php
